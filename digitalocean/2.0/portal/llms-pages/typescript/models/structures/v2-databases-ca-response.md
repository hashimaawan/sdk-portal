...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRlYyJTI1MjBEYXRhYmFzZXMlMjUyMENhJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- |
| `ca` | [`Ca`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/ca.md) | Required | - |
...
```ts
import { V2DatabasesCaResponse } from 'digitalocean-apilib';

const v2DatabasesCaResponse: V2DatabasesCaResponse = {
  ca: {
