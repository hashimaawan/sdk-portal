...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBSZXNlcnZlZCUyNTIwSXBzJTI1MjBBY3Rpb25zJTI1MjBSZXNwb25zZQ
...
```php
use DigitalOceanApiLib\Models\Builders\V2ReservedIpsActionsResponseBuilder;
...
$v2ReservedIpsActionsResponse = V2ReservedIpsActionsResponseBuilder::init(
    MetaBuilder::init(
        1
    )
