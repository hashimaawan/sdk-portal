...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGVfb25saW5lTWlncmF0aW9u
...
```ts
async databasesDeleteOnlineMigration(
...
const migrationId = '77b28fc8-19ff-11eb-8c9c-c68e24557488';

try {
  const response = await databasesApi.databasesDeleteOnlineMigration(
    databaseClusterUuid,
    migrationId
  );
