...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9hbGVydF91cGRhdGU

To update the settings of an Uptime alert, send a PUT request to `/v2/uptime/checks/$CHECK_ID/alerts/$ALERT_ID`.

```php
function uptimeAlertUpdate(string $checkId, string $alertId, V2UptimeChecksAlertsRequest $body): ApiResponse
```
...
| `body` | [`V2UptimeChecksAlertsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-uptime-checks-alerts-request.md) | Body, Required | - |
...
$body = V2UptimeChecksAlertsRequestBuilder::init()
...
$apiResponse = $uptimeApi->uptimeAlertUpdate(
    $checkId,
    $alertId,
    $body
);
