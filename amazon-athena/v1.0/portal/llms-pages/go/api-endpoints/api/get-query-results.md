...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/#/go/x-redirect/JTI0ZSUyRiUyRkdldFF1ZXJ5UmVzdWx0cw
...
GetQueryResults(
    ...
    maxResults *string,
    nextToken *string) (
    models.ApiResponse[models.GetQueryResultsOutput],
    error)
```
