...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/java/x-redirect/JTI0bSUyRlBhZ2luZ1NpbXBsaWZpZWRBbGJ1bU9iamVjdA
...
| `Items` | [`List<SimplifiedAlbumObject>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/java/models/structures/simplified-album-object.md) | Required | - | List<SimplifiedAlbumObject> getItems() | setItems(List<SimplifiedAlbumObject> items) |
