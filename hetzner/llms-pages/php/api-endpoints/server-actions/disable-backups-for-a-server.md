...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/php/x-redirect/JTI0ZSUyRlNlcnZlciUyNTIwQWN0aW9ucyUyRkRpc2FibGUlMjUyMEJhY2t1cHMlMjUyMGZvciUyNTIwYSUyNTIwU2VydmVy
...
```php
function disableBackupsForAServer(int $id): ActionResponse
```
...
try {
    $result = $serverActionsController->disableBackupsForAServer($id);
    echo 'ActionResponse:';
    var_dump($result);
