...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRlYyJTI1MjBEb21haW5zJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- |
| `Domains` | [`List<Domain1>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/domain-1.md) | Required | Array of volumes. |
...
V2DomainsResponse v2DomainsResponse = new V2DomainsResponse
{
    Domains = new List<Domain1>
    {
        new Domain1
        {
