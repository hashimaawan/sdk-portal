...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9jaGVja3NfbGlzdA

To list all of the Uptime checks on your account, send a GET request to `/v2/uptime/checks`.

```ruby
def uptime_checks_list(per_page: 20,
                       page: 1)
```
