...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkZsb2F0aW5nJTI1MjBJUHMlMkZmbG9hdGluZ0lQc19kZWxldGU
...
```ruby
def floating_i_ps_delete(floating_ip)
```
...
result = floating_i_ps_api.floating_i_ps_delete(floating_ip)
