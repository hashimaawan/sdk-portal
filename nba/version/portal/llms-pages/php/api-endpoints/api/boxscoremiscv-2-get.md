...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JlbWlzY3YyX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```php
function boxscoremiscv2Get(
    string $gameId,
    string $startPeriod,
    string $endPeriod,
    string $startRange,
...
$api = $client->getAPI();
$apiResponse = $api->boxscoremiscv2Get(
    $gameId,
    $startPeriod,
    $endPeriod,
    $startRange,
