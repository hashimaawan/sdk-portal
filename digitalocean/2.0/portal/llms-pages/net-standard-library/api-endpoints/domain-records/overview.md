...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkRvbWFpbiUyNTIwUmVjb3JkcyUyRk92ZXJ2aWV3
...
An instance of the `DomainRecordsApi` class can be accessed from the API Client.

```
DomainRecordsApi domainRecordsApi = client.DomainRecordsApi;
```
