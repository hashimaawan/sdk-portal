...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRkxvYWRCYWxhbmNlclNlcnZpY2VIZWFsdGhDaGVjaw
...
|  --- | --- | --- | --- | --- | --- |
| `Http` | [`Http`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/http.md) | Optional | Additional configuration for protocol http | Http getHttp() | setHttp(Http http) |
...
| `Protocol` | [`Protocol6Enum`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/enumerations/protocol-6.md) | Required | Type of the health check | Protocol6Enum getProtocol() | setProtocol(Protocol6Enum protocol) |
