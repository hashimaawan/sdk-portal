...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0ZSUyRkZpcmV3YWxsJTI1MjBBY3Rpb25zJTJGR2V0JTI1MjBhbGwlMjUyMEFjdGlvbnMlMjUyMGZvciUyNTIwYSUyNTIwRmlyZXdhbGw
...
```php
function getAllActionsForAFirewall(int $id, ?string $sort = null, ?string $status = null): ActionsResponse
```
...
try {
    $result = $firewallActionsController->getAllActionsForAFirewall($id);
