...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTI1MjBBY3Rpb25zJTJGdm9sdW1lQWN0aW9uc19wb3N0
...
```ts
async volumeActionsPost(
  body: VolumeActionsPostBody,
  perPage?: number,
  page?: number,
...
|  --- | --- | --- | --- |
| `body` | [`VolumeActionsPostBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/oneof-anyof-definitions/volume-actions-post-body.md) | Body, Required | This is a container for any-of cases. |
...
```ts
const body: VolumeActionsPostBody = {
  type: Type21.Attach,
  dropletId: 11612190,
  region: Region2.Nyc1,
  tags: [
...
try {
  const response = await blockStorageActionsApi.volumeActionsPost(body);
