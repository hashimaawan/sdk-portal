...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0bSUyRlNlcnZlcnMlMjUyMEFjdGlvbnMlMjUyMEVuYWJsZSUyNTIwUmVzY3VlJTI1MjBSZXNwb25zZQ
...
```php
use HetznerCloudAPILib\Models\Builders\ServersActionsEnableRescueResponseBuilder;
...
$serversActionsEnableRescueResponse = ServersActionsEnableRescueResponseBuilder::init()
    ->action(
        ActionBuilder::init(
            'command6',
            238,
