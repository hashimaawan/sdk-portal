...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2dldF9kZXBsb3ltZW50

Retrieve information about an app deployment.

```ts
async appsGetDeployment(
  appId: string,
  deploymentId: string,
...
try {
  const response = await appsApi.appsGetDeployment(
    appId,
    deploymentId
  );
