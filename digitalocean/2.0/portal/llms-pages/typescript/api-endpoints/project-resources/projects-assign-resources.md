...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRlByb2plY3QlMjUyMFJlc291cmNlcyUyRnByb2plY3RzX2Fzc2lnbl9yZXNvdXJjZXM

To assign resources to a project, send a POST request to `/v2/projects/$PROJECT_ID/resources`.

```ts
async projectsAssignResources(
  projectId: string,
...
try {
  const response = await projectResourcesApi.projectsAssignResources(
    projectId,
    body
  );
