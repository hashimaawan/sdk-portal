...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRlYyJTI1MjBMb2FkJTI1MjBCYWxhbmNlcnMlMjUyMFJlc3BvbnNl
...
|  --- | --- | --- | --- |
| `LoadBalancers` | [`List<LoadBalancer1>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/load-balancer-1.md) | Optional | - |
...
V2LoadBalancersResponse v2LoadBalancersResponse = new V2LoadBalancersResponse
{
    Meta = new Meta
    {
        Total = 1,
    ...
    LoadBalancers = new List<LoadBalancer1>
    {
        new LoadBalancer1
        {
