...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2dldF9jbHVzdGVy

To show information about an existing Kubernetes cluster, send a GET request
to `/v2/kubernetes/clusters/$K8S_CLUSTER_ID`.

```csharp
KubernetesGetClusterAsync(
    Guid clusterId)
```
...
try
{
    ApiResponse<V2KubernetesClustersResponse1> result = await kubernetesApi.KubernetesGetClusterAsync(clusterId);
}
