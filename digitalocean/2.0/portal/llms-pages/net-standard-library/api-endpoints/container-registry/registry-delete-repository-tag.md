...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9kZWxldGVfcmVwb3NpdG9yeVRhZw
...
```csharp
RegistryDeleteRepositoryTagAsync(
    string registryName,
...
try
{
    await containerRegistryApi.RegistryDeleteRepositoryTagAsync(
        registryName,
        repositoryName,
        repositoryTag
    );
