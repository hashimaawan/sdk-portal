...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRlRyYWNrcyUyRmdldC10cmFjaw
...
GetTrack(
    ...
    id string,
    market *string) (
    models.ApiResponse[models.TrackObject],
    error)
```
...
apiResponse, err := tracksApi.GetTrack(ctx, id, &market)
if err != nil {
