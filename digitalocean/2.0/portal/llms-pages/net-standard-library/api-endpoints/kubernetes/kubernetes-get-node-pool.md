...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2dldF9ub2RlUG9vbA
...
try
{
    ApiResponse<V2KubernetesClustersNodePoolsResponse1> result = await kubernetesApi.KubernetesGetNodePoolAsync(
        clusterId,
        nodePoolId
    );
}
