...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wcm9tb3RlX3JlcGxpY2E
...
```python
def databases_promote_replica(self,
...
result = databases_api.databases_promote_replica(
    database_cluster_uuid,
    replica_name
)
