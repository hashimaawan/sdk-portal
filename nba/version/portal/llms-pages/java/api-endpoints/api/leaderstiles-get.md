...
```java
CompletableFuture<ApiResponse<Void>> leaderstilesGetAsync(
    final String stat,
...
api.leaderstilesGetAsync(stat, leagueId, season, seasonType, playerOrTeam, playerScope, gameScope, null, null).thenAccept(result -> {
