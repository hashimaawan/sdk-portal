...
Source: https://github.com/hashimaawan/sdk-portal/tree/main/spotify/#/java/x-redirect/JTI0bSUyRlBhZ2luZ1NhdmVkVHJhY2tPYmplY3Q
...
| `Items` | [`List<SavedTrackObject>`](https://github.com/hashimaawan/sdk-portal/tree/main/spotify/llms-pages/java/models/structures/saved-track-object.md) | Required | - | List<SavedTrackObject> getItems() | setItems(List<SavedTrackObject> items) |
