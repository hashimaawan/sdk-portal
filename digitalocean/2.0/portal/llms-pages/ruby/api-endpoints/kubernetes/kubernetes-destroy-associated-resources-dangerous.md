...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2Rlc3Ryb3lfYXNzb2NpYXRlZFJlc291cmNlc0Rhbmdlcm91cw
...
```ruby
def kubernetes_destroy_associated_resources_dangerous(cluster_id)
```
...
result = kubernetes_api.kubernetes_destroy_associated_resources_dangerous(cluster_id)
