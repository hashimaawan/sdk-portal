...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRlZQQ3MlMkZ2cGNzX3BhdGNo
...
| `body` | [`V2VpcsRequest1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-vpcs-request-1.md) | Body, Required | - |
...
try {
  const response = await vpCsApi.vpcsPatch(
    vpcId,
    body
  );
