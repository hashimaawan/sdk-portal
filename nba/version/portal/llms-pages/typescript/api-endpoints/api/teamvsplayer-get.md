...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW12c3BsYXllcl9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async teamvsplayerGET(
  teamID: string,
  vsPlayerID: string,
  seasonType: string,
  measureType: string,
...
try {
  const response = await apiController.teamvsplayerGET(
    teamID,
    vsPlayerID,
    seasonType,
    measureType,
