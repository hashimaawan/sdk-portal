...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXQ
...
try
{
    ApiResponse<V2DatabasesDbsResponse1> result = await databasesApi.DatabasesGetAsync(
        databaseClusterUuid,
        databaseName
    );
}
