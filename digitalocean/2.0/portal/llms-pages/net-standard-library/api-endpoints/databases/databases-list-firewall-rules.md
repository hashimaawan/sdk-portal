...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19saXN0X2ZpcmV3YWxsX3J1bGVz
...
```csharp
DatabasesListFirewallRulesAsync(
...
try
{
    ApiResponse<V2DatabasesFirewallResponse> result = await databasesApi.DatabasesListFirewallRulesAsync(databaseClusterUuid);
}
