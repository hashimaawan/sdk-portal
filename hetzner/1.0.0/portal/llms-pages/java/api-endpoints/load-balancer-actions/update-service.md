...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VyJTI1MjBBY3Rpb25zJTJGVXBkYXRlJTI1MjBTZXJ2aWNl
...
```java
CompletableFuture<ApiResponse<ActionResponse>> updateServiceAsync(
    final int id,
...
loadBalancerActionsApi.updateServiceAsync(id, body).thenAccept(result -> {
