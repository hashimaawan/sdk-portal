...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2dldF9kZXBsb3ltZW50

Retrieve information about an app deployment.

```php
function appsGetDeployment(string $appId, string $deploymentId): ApiResponse
```
...
$apiResponse = $appsApi->appsGetDeployment(
    $appId,
    $deploymentId
);
