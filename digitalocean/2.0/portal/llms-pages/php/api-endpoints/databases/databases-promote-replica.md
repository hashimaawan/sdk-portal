...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wcm9tb3RlX3JlcGxpY2E
...
```php
function databasesPromoteReplica(string $databaseClusterUuid, string $replicaName): ApiResponse
```
...
$apiResponse = $databasesApi->databasesPromoteReplica(
    $databaseClusterUuid,
    $replicaName
);
