...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRlYyRGF0YWJhc2VzQ29uZmlnUmVxdWVzdENvbmZpZw
...
```ts
const value: V2DatabasesConfigRequestConfig = {
  backupHour: 3,
  backupMinute: 30,
