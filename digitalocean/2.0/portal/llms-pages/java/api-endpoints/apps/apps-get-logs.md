...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2dldF9sb2dz
...
```java
CompletableFuture<ApiResponse<V2AppsComponentsLogsResponse>> appsGetLogsAsync(
    final String appId,
...
appsApi.appsGetLogsAsync(appId, deploymentId, componentName, type, follow, podConnectionTimeout).thenAccept(result -> {
