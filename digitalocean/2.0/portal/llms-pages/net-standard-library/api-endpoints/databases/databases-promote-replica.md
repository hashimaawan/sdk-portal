...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wcm9tb3RlX3JlcGxpY2E
...
try
{
    await databasesApi.DatabasesPromoteReplicaAsync(
        databaseClusterUuid,
        replicaName
    );
}
