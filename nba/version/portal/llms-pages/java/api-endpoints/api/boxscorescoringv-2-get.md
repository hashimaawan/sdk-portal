...
```java
CompletableFuture<Void> boxscorescoringv2GETAsync(
    final String gameID,
...
aPIController.boxscorescoringv2GETAsync(gameID, startPeriod, endPeriod, startRange, endRange, rangeType).thenAccept(result -> {
