...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/java/x-redirect/JTI0bSUyRlBhZ2luZ1NhdmVkVHJhY2tPYmplY3Q
...
| `Items` | [`List<SavedTrackObject>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/java/models/structures/saved-track-object.md) | Required | - | List<SavedTrackObject> getItems() | setItems(List<SavedTrackObject> items) |
