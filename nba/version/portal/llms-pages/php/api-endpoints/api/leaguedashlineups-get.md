...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRkxlYWd1ZWRhc2hsaW5ldXBzX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```php
function leaguedashlineupsGet(
...
$api = $client->getAPI();
$apiResponse = $api->leaguedashlineupsGet(
    $groupQuantity,
    $seasonType,
    $measureType,
    $perMode,
