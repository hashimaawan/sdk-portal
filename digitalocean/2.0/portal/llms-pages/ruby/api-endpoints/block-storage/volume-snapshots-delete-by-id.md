...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTJGdm9sdW1lU25hcHNob3RzX2RlbGV0ZV9ieUlk
...
```ruby
def volume_snapshots_delete_by_id(snapshot_id)
```
...
result = block_storage_api.volume_snapshots_delete_by_id(snapshot_id)
