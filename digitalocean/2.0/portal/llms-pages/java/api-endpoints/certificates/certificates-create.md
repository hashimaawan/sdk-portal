...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkNlcnRpZmljYXRlcyUyRmNlcnRpZmljYXRlc19jcmVhdGU
...
```java
CompletableFuture<ApiResponse<V2CertificatesResponse1>> certificatesCreateAsync(
    final CertificatesCreateBody body)
```
...
|  --- | --- | --- | --- |
| `body` | [`CertificatesCreateBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/oneof-anyof-definitions/certificates-create-body.md) | Body, Required | This is a container for one-of cases. |
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/sdk-infrastructure/utilities/apiresponse.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`V2CertificatesResponse1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/v2-certificates-response-1.md).
...
CertificatesCreateBody body = CertificatesCreateBody.fromLetSEncryptCertificateRequest(
    new LetSEncryptCertificateRequest.Builder(
        "web-cert-01",
        Arrays.asList(
            "www.example.com",
            "example.com"
...
certificatesApi.certificatesCreateAsync(body).thenAccept(result -> {
