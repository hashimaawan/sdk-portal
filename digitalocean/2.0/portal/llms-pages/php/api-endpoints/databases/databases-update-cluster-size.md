...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfY2x1c3RlclNpemU
...
```php
function databasesUpdateClusterSize(string $databaseClusterUuid, V2DatabasesResizeRequest $body): ApiResponse
```
...
| `body` | [`V2DatabasesResizeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-databases-resize-request.md) | Body, Required | - |
...
$body = V2DatabasesResizeRequestBuilder::init(
    3,
    'db-s-4vcpu-8gb'
)->build();

$databasesApi = $client->getDatabasesApi();
$apiResponse = $databasesApi->databasesUpdateClusterSize(
    $databaseClusterUuid,
    $body
);
