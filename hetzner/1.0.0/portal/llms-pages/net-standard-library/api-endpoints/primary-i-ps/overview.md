...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/net-standard-library/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRlByaW1hcnklMjUyMElQcyUyRk92ZXJ2aWV3
...
An instance of the `PrimaryIPsController` class can be accessed from the API Client.

```
PrimaryIPsController primaryIPsController = client.PrimaryIPsController;
```
