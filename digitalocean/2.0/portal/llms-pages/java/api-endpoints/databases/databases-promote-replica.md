...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wcm9tb3RlX3JlcGxpY2E
...
```java
CompletableFuture<ApiResponse<Void>> databasesPromoteReplicaAsync(
...
databasesApi.databasesPromoteReplicaAsync(databaseClusterUuid, replicaName).thenAccept(result -> {
