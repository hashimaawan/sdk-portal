...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkZsb2F0aW5nJTI1MjBJUCUyNTIwQWN0aW9ucyUyRk92ZXJ2aWV3
...
The instance of the `FloatingIpActionsApi` class can be accessed from the API Client.

```
floatingIpActionsApi := client.FloatingIpActionsApi()
```
