...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfbWlncmF0aW9uU3RhdHVz
...
```java
CompletableFuture<ApiResponse<V2DatabasesOnlineMigrationResponse>> databasesGetMigrationStatusAsync(
...
databasesApi.databasesGetMigrationStatusAsync(databaseClusterUuid).thenAccept(result -> {
