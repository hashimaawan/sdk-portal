...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkZsb2F0aW5nJTI1MjBJUHMlMkZmbG9hdGluZ0lQc19kZWxldGU
...
```php
function floatingIPsDelete(string $floatingIp): ApiResponse
```
...
$apiResponse = $floatingIPsApi->floatingIPsDelete($floatingIp);
