...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNoYm9hcmRieWxhc3RuZ2FtZXNfR0VU

:information_source: **Note** This endpoint does not require authentication.

```ts
async teamdashboardbylastngamesGET(
  teamID: string,
  measureType: string,
  perMode: string,
  plusMinus: string,
...
try {
  const response = await apiController.teamdashboardbylastngamesGET(
    teamID,
    measureType,
    perMode,
    plusMinus,
