...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JlZm91cmZhY3RvcnN2Ml9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```php
function boxscorefourfactorsv2Get(
    string $gameId,
    string $startPeriod,
    string $endPeriod,
    string $startRange,
...
$api = $client->getAPI();
$apiResponse = $api->boxscorefourfactorsv2Get(
    $gameId,
    $startPeriod,
    $endPeriod,
    $startRange,
