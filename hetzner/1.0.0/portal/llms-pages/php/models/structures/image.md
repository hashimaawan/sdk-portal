...
| `osFlavor` | [`string(OsFlavorEnum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/os-flavor.md) | Required | Flavor of operating system contained in the Image | getOsFlavor(): string | setOsFlavor(string osFlavor): void |
...
| `status` | [`string(Status24Enum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/status-24.md) | Required | Whether the Image can be used or if it's still being created or unavailable | getStatus(): string | setStatus(string status): void |
| `type` | [`string(Type22Enum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/type-22.md) | Required | Type of the Image | getType(): string | setType(string type): void |
