...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXlieXBsYXl2Ml9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async playbyplayv2GET(
  gameID: string,
  startPeriod: string,
  endPeriod: string,
...
try {
  const response = await apiController.playbyplayv2GET(
    gameID,
    startPeriod,
    endPeriod
  );
