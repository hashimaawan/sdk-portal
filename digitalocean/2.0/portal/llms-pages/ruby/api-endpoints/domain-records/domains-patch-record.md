...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRvbWFpbiUyNTIwUmVjb3JkcyUyRmRvbWFpbnNfcGF0Y2hfcmVjb3Jk
...
```ruby
def domains_patch_record(domain_name,
                         domain_record_id,
                         body: nil)
```
...
| `domain_record_id` | `Integer` | Template, Required | The unique identifier of the domain record. |
| `body` | [`DomainRecord`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/domain-record.md) | Body, Optional | - |
...
body = DomainRecord.new(
  type: 'A',
  name: 'blog'
)

result = domain_records_api.domains_patch_record(
  domain_name,
  domain_record_id,
  body: body
)
