...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0ZSUyRlNlcnZlciUyNTIwQWN0aW9ucyUyRkdldCUyNTIwYWxsJTI1MjBBY3Rpb25zJTI1MjBmb3IlMjUyMGElMjUyMFNlcnZlcg
...
```php
function getAllActionsForAServer(int $id, ?string $sort = null, ?string $status = null): ApiResponse
```
...
$apiResponse = $serverActionsApi->getAllActionsForAServer($id);
