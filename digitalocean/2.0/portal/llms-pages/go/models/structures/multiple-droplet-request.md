...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRk11bHRpcGxlJTI1MjBEcm9wbGV0JTI1MjBSZXF1ZXN0
...
| `Image` | [`models.MultipleDropletRequestImage`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/oneof-anyof-definitions/multiple-droplet-request-image.md) | Required | This is a container for one-of cases. |
...
| `SshKeys` | [`[]models.MultipleDropletRequestSshKeys`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/oneof-anyof-definitions/multiple-droplet-request-ssh-keys.md) | Optional | This is Array of a container for any-of cases. |
...
func main() {
    multipleDropletRequest := models.MultipleDropletRequest{
        Names:                 []string{
            "sub-01.example.com",
            "sub-02.example.com",
        },
