...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlByb2plY3RzJTJGcHJvamVjdHNfZGVsZXRl
...
```php
function projectsDelete(string $projectId): ApiResponse
```
...
$apiResponse = $projectsApi->projectsDelete($projectId);
...
| 412 | Only an empty project can be deleted. | [`V21Clicks401ErrorException`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/exceptions/v2-1-clicks-401-error.md) |
