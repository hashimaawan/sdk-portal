...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2dldF9kcm9wbGV0RmlsZXN5c3RlbUZyZWVNZXRyaWNz
...
```ruby
def monitoring_get_droplet_filesystem_free_metrics(host_id,
                                                   start,
                                                   mend)
```
...
result = monitoring_api.monitoring_get_droplet_filesystem_free_metrics(
  host_id,
  start,
  mend
)
