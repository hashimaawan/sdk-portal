...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTJGT3ZlcnZpZXc
...
An instance of the `BlockStorageApi` class can be accessed from the API Client.

```
BlockStorageApi blockStorageApi = client.BlockStorageApi;
```
