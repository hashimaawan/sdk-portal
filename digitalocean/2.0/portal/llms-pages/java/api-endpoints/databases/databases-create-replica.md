...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19jcmVhdGVfcmVwbGljYQ
...
```java
CompletableFuture<ApiResponse<V2DatabasesReplicasResponse1>> databasesCreateReplicaAsync(
...
| `body` | [`Replica`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/replica.md) | Body, Optional | - |
...
Replica body = new Replica.Builder(
    "read-nyc3-01"
)
.region("nyc3")
.size("db-s-2vcpu-4gb")
...
databasesApi.databasesCreateReplicaAsync(databaseClusterUuid, body).thenAccept(result -> {
