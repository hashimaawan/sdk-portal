...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkxlYWd1ZWRhc2hwdGRlZmVuZF9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async leaguedashptdefendGET(
  leagueID: string,
  perMode: string,
  season: string,
  seasonType: string,
...
try {
  const response = await apiController.leaguedashptdefendGET(
    leagueID,
    perMode,
    season,
    seasonType,
