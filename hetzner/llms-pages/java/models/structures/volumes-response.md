...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRlZvbHVtZXMlMjUyMFJlc3BvbnNl
...
| `Volumes` | [`List<Volume1>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/volume-1.md) | Required | - | List<Volume1> getVolumes() | setVolumes(List<Volume1> volumes) |
