...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/php/x-redirect/JTI0ZSUyRkZsb2F0aW5nJTI1MjBJUCUyNTIwQWN0aW9ucyUyRkNoYW5nZSUyNTIwcmV2ZXJzZSUyNTIwRE5TJTI1MjBlbnRyeSUyNTIwZm9yJTI1MjBhJTI1MjBGbG9hdGluZyUyNTIwSVA
...
```php
function changeReverseDNSEntryForAFloatingIP(int $id, ?ChangeDNSPTRRequest $body = null): ActionResponse
```
...
try {
    $result = $floatingIPActionsController->changeReverseDNSEntryForAFloatingIP(
        $id,
        $body
    );
    echo 'ActionResponse:';
