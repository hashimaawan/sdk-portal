...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRlByb2plY3RzJTJGcHJvamVjdHNfdXBkYXRlX2RlZmF1bHQ

To update you default project, send a PUT request to `/v2/projects/default`. All of the following attributes must be sent.

```ruby
def projects_update_default(body)
```
