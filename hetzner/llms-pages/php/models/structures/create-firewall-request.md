...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/php/x-redirect/JTI0bSUyRkNyZWF0ZUZpcmV3YWxsUmVxdWVzdA
...
|  --- | --- | --- | --- | --- | --- |
| `applyTo` | [`?(ApplyTo[])`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/php/models/structures/apply-to.md) | Optional | Resources the Firewall should be applied to after creation | getApplyTo(): ?array | setApplyTo(?array applyTo): void |
...
| `rules` | [`?(Rule[])`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/php/models/structures/rule.md) | Optional | Array of rules | getRules(): ?array | setRules(?array rules): void |
