...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRkF1dGhQbHVnaW4
...
```ts
import { AuthPlugin } from 'digitalocean-apilib';

const authPlugin = AuthPlugin.MysqlNativePassword;
```
