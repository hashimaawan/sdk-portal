...
| `protocol` | [`string(ProtocolEnum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/protocol.md) | Required | Type of traffic to allow | getProtocol(): string | setProtocol(string protocol): void |
