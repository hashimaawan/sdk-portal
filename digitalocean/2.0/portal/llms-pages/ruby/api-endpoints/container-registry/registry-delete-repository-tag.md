...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9kZWxldGVfcmVwb3NpdG9yeVRhZw
...
```ruby
def registry_delete_repository_tag(registry_name,
                                   repository_name,
                                   repository_tag)
```
...
| `repository_tag` | `String` | Template, Required | The name of a container registry repository tag. |
