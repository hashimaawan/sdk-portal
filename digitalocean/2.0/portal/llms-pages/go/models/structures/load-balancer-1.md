...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRkxvYWRCYWxhbmNlcjE
...
| `DropletIds` | `[]int` | Optional | An array containing the IDs of the Droplets assigned to the load balancer. |
| `Tag` | `*string` | Optional | The name of a Droplet tag corresponding to Droplets assigned to the load balancer. |
...
func main() {
    ...
    loadBalancer1 := models.LoadBalancer1{
