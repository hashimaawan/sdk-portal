...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRlByb2plY3RzJTJGcHJvamVjdHNfdXBkYXRlX2RlZmF1bHQ

To update you default project, send a PUT request to `/v2/projects/default`. All of the following attributes must be sent.

```python
def projects_update_default(self,
                           body)
```
...
result = projects_api.projects_update_default(body)
