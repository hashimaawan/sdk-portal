...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2dldF9kcm9wbGV0QmFuZHdpZHRoTWV0cmljcw
...
```php
function monitoringGetDropletBandwidthMetrics(
    string $hostId,
    string $mInterface,
    string $direction,
    string $start,
...
| `mInterface` | [`string(MInterface)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/enumerations/interface.md) | Query, Required | The network interface. |
| `direction` | [`string(Direction)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/enumerations/direction.md) | Query, Required | The traffic direction. |
...
$apiResponse = $monitoringApi->monitoringGetDropletBandwidthMetrics(
    $hostId,
    $interface,
    $direction,
    $start,
