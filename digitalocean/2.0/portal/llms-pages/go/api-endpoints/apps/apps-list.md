...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2xpc3Q
...
AppsList(
    ...
    perPage *int,
    withProjects *bool) (
    models.ApiResponse[models.V2AppsResponse],
    error)
```
...
| `withProjects` | `*bool` | Query, Optional | Whether the project_id of listed apps should be fetched and included. |
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type [models.V2AppsResponse](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-apps-response.md).
...
apiResponse, err := appsApi.AppsList(ctx, &page, &perPage, &withProjects)
if err != nil {
