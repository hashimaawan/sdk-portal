...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRlBsYXlsaXN0cyUyRmdldC1hLWNhdGVnb3JpZXMtcGxheWxpc3Rz
...
GetACategoriesPlaylists(
    ...
    limit *int,
    offset *int) (
    models.ApiResponse[models.PagingFeaturedPlaylistObject],
    error)
```
...
apiResponse, err := playlistsApi.GetACategoriesPlaylists(ctx, categoryId, &limit, &offset)
if err != nil {
