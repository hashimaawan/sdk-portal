...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfdXNlcg
...
```java
CompletableFuture<ApiResponse<V2DatabasesUsersResponse1>> databasesGetUserAsync(
...
databasesApi.databasesGetUserAsync(databaseClusterUuid, username).thenAccept(result -> {
