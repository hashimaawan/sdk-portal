...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19kZWxldGVfZHJvcGxldHM
...
```ruby
def firewalls_delete_droplets(firewall_id,
                              body: nil)
```
...
| `body` | [`V2FirewallsDropletsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-firewalls-droplets-request.md) | Body, Optional | - |
...
body = V2FirewallsDropletsRequest.new(
  droplet_ids: [
    49696269
  ]
)

result = firewalls_api.firewalls_delete_droplets(
  firewall_id,
  body: body
)
