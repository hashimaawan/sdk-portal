...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRkNh
...
|  --- | --- | --- | --- |
| `Certificate` | `string` | Required, Read-only | base64 encoding of the certificate used to secure database connections |
