...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/python/x-redirect/JTI0ZSUyRk5ldHdvcmslMjUyMEFjdGlvbnMlMkZHZXQlMjUyMGFsbCUyNTIwQWN0aW9ucyUyNTIwZm9yJTI1MjBhJTI1MjBOZXR3b3Jr
...
```python
def get_all_actions_for_a_network(self,
                                 id,
                                 sort=None,
                                 status=None)
```
...
result = network_actions_api.get_all_actions_for_a_network(id)
