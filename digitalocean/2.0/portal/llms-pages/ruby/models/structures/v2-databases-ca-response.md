...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRlYyJTI1MjBEYXRhYmFzZXMlMjUyMENhJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- |
| `ca` | [`Ca`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/ca.md) | Required | - |
...
```ruby
v2_databases_ca_response = V2DatabasesCaResponse.new(
  ca: Ca.new(
