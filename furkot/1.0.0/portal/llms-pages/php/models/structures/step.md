...
| `coordinates` | [`?Coordinates`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/furkot/1.0.0/portal/llms-pages/php/models/structures/coordinates.md) | Optional | geographical coordinates of the stop | getCoordinates(): ?Coordinates | setCoordinates(?Coordinates coordinates): void |
