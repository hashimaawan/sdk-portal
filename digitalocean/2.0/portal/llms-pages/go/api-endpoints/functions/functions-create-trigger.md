...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkZ1bmN0aW9ucyUyRmZ1bmN0aW9uc19jcmVhdGVfdHJpZ2dlcg
...
FunctionsCreateTrigger(
    ctx context.Context,
    namespaceId string,
    body models.V2FunctionsNamespacesTriggersRequest) (
...
| `body` | [`models.V2FunctionsNamespacesTriggersRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-functions-namespaces-triggers-request.md) | Body, Required | - |
...
apiResponse, err := functionsApi.FunctionsCreateTrigger(ctx, namespaceId, body)
if err != nil {
