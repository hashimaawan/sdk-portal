...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkZ1bmN0aW9ucyUyRmZ1bmN0aW9uc19saXN0X3RyaWdnZXJz
...
FunctionsListTriggers(
    ctx context.Context,
    namespaceId string) (
    models.ApiResponse[models.V2FunctionsNamespacesTriggersResponse],
    error)
```
...
apiResponse, err := functionsApi.FunctionsListTriggers(ctx, namespaceId)
if err != nil {
