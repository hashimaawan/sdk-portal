...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNoYm9hcmRieWNsdXRjaF9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async teamdashboardbyclutchGET(
  teamID: string,
  measureType: string,
  perMode: string,
  plusMinus: string,
...
try {
  const response = await apiController.teamdashboardbyclutchGET(
    teamID,
    measureType,
    perMode,
    plusMinus,
