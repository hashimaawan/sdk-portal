...
```java
CompletableFuture<Void> boxscoremiscv2GETAsync(
    final String gameID,
...
aPIController.boxscoremiscv2GETAsync(gameID, startPeriod, endPeriod, startRange, endRange, rangeType).thenAccept(result -> {
