...
Source: https://github.com/hashimaawan/sdk-portal/tree/main/spotify/#/java/x-redirect/JTI0bSUyRlBhZ2luZ1RyYWNrT2JqZWN0
...
| `Items` | [`List<TrackObject>`](https://github.com/hashimaawan/sdk-portal/tree/main/spotify/llms-pages/java/models/structures/track-object.md) | Required | - | List<TrackObject> getItems() | setItems(List<TrackObject> items) |
