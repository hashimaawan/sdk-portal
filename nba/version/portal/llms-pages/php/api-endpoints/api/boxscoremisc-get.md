...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JlbWlzY19HRVQ
...
```php
$api = $client->getAPI();
$apiResponse = $api->boxscoremiscGet();
