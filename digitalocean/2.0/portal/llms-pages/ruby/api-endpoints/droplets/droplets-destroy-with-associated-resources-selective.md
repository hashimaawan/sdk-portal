...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveV93aXRoQXNzb2NpYXRlZFJlc291cmNlc1NlbGVjdGl2ZQ
...
```ruby
def droplets_destroy_with_associated_resources_selective(droplet_id,
                                                         body: nil)
```
...
| `body` | [`V2DropletsDestroyWithAssociatedResourcesSelectiveRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-droplets-destroy-with-associated-resources-selective-request.md) | Body, Optional | - |
...
body = V2DropletsDestroyWithAssociatedResourcesSelectiveRequest.new(
  floating_ips: [
    '6186916'
  ],
  reserved_ips: [
...
result = droplets_api.droplets_destroy_with_associated_resources_selective(
  droplet_id,
  body: body
)
