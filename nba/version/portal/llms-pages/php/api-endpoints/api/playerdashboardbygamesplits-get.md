...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hib2FyZGJ5Z2FtZXNwbGl0c19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```php
function playerdashboardbygamesplitsGet(
    string $measureType,
    string $perMode,
    string $plusMinus,
    string $paceAdjust,
...
$api = $client->getAPI();
$apiResponse = $api->playerdashboardbygamesplitsGet(
    $measureType,
    $perMode,
    $plusMinus,
    $paceAdjust,
