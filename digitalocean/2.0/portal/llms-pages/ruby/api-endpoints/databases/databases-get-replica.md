...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfcmVwbGljYQ
...
```ruby
def databases_get_replica(database_cluster_uuid,
                          replica_name)
```
