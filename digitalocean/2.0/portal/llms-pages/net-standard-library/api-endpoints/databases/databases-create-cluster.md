...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19jcmVhdGVfY2x1c3Rlcg
...
```csharp
DatabasesCreateClusterAsync(
    Models.V2DatabasesRequest body)
```
...
|  --- | --- | --- | --- |
| `body` | [`V2DatabasesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-databases-request.md) | Body, Required | - |
...
try
{
    ApiResponse<V2DatabasesResponse1> result = await databasesApi.DatabasesCreateClusterAsync(body);
}
