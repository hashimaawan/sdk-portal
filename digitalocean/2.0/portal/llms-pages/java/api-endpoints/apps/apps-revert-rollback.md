...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX3JldmVydF9yb2xsYmFjaw
...
```java
CompletableFuture<ApiResponse<V2AppsDeploymentsResponse1>> appsRevertRollbackAsync(
    final String appId)
```
...
appsApi.appsRevertRollbackAsync(appId).thenAccept(result -> {
