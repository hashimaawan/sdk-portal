...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRlBsYXlsaXN0cyUyRnJlbW92ZS10cmFja3MtcGxheWxpc3Q
...
RemoveTracksPlaylist(
    ctx context.Context,
    playlistId string,
    body *models.PlaylistsTracksRequest2) (
...
| `body` | [`*models.PlaylistsTracksRequest2`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/llms-pages/go/models/structures/playlists-tracks-request-2.md) | Body, Optional | - |
...
apiResponse, err := playlistsApi.RemoveTracksPlaylist(ctx, playlistId, &body)
if err != nil {
