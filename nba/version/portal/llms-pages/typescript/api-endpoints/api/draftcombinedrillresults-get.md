...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkRyYWZ0Y29tYmluZWRyaWxscmVzdWx0c19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async draftcombinedrillresultsGET(
  leagueID: string,
  seasonYear: string,
...
try {
  const response = await apiController.draftcombinedrillresultsGET(
    leagueID,
    seasonYear
  );
