...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/ruby/x-redirect/JTI0bSUyRk1hbnlBdWRpb2Jvb2tz
...
|  --- | --- | --- | --- |
| `audiobooks` | [`Array[AudiobookObject]`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/ruby/models/structures/audiobook-object.md) | Required | - |
...
```ruby
many_audiobooks = ManyAudiobooks.new(
  audiobooks: [
    AudiobookObject.new(
      authors: [
        AuthorObject.new(
