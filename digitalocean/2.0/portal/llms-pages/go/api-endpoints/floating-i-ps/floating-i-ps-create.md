...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkZsb2F0aW5nJTI1MjBJUHMlMkZmbG9hdGluZ0lQc19jcmVhdGU
...
FloatingIPsCreate(
    ctx context.Context,
    body models.FloatingIPsCreateBody) (
    models.ApiResponse[models.V2FloatingIpsResponse1],
    error)
```
...
|  --- | --- | --- | --- |
| `body` | [`models.FloatingIPsCreateBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/oneof-anyof-definitions/floating-i-ps-create-body.md) | Body, Required | This is a container for one-of cases. |
...
body := models.FloatingIPsCreateBodyContainer.FromAssignToDroplet(models.AssignToDroplet{
    DropletId:             2457247,
})

apiResponse, err := floatingIPsApi.FloatingIPsCreate(ctx, body)
if err != nil {
