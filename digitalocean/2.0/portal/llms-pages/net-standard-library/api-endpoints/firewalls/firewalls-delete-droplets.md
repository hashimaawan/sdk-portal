...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19kZWxldGVfZHJvcGxldHM
...
```csharp
FirewallsDeleteDropletsAsync(
    Guid firewallId,
    Models.V2FirewallsDropletsRequest body = null)
```
...
| `body` | [`V2FirewallsDropletsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-firewalls-droplets-request.md) | Body, Optional | - |
...
V2FirewallsDropletsRequest body = new V2FirewallsDropletsRequest
{
...
try
{
    await firewallsApi.FirewallsDeleteDropletsAsync(
        firewallId,
        body
    );
}
