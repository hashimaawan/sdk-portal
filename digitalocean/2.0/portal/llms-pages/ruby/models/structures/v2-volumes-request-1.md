...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRlYyJTI1MjBWb2x1bWVzJTI1MjBSZXF1ZXN0MQ
...
| `filesystem_label` | `String` | Optional | **Constraints**: *Maximum Length*: `12` |
...
```ruby
v2_volumes_request1 = V2VolumesRequest1.new(
  name: 'example',
  size_gigabytes: 10,
  region: Region2::NYC3,
