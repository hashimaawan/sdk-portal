...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/1password/#/php/x-redirect/JTI0ZSUyRkl0ZW1zJTJGVXBkYXRlVmF1bHRJdGVt

```php
function updateVaultItem(string $vaultUuid, string $itemUuid, ?FullItem $body = null): ApiResponse
```
...
$apiResponse = $itemsApi->updateVaultItem(
    $vaultUuid,
    $itemUuid,
    $body
);
