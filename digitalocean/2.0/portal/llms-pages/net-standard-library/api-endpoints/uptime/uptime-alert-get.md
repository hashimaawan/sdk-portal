...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9hbGVydF9nZXQ
...
try
{
    ApiResponse<V2UptimeChecksAlertsResponse1> result = await uptimeApi.UptimeAlertGetAsync(
        checkId,
        alertId
    );
}
