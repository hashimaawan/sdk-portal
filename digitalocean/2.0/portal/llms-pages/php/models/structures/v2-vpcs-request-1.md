...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBWcGNzJTI1MjBSZXF1ZXN0MQ
...
```php
use DigitalOceanApiLib\Models\Builders\V2VpcsRequest1Builder;
use DigitalOceanApiLib\ApiHelper;

$v2VpcsRequest1 = V2VpcsRequest1Builder::init()
