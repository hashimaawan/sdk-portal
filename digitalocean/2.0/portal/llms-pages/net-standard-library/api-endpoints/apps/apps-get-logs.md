...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2dldF9sb2dz
...
try
{
    ApiResponse<V2AppsComponentsLogsResponse> result = await appsApi.AppsGetLogsAsync(
        appId,
        deploymentId,
        componentName,
        type,
