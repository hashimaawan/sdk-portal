...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRlYyJTI1MjBBcHBzJTI1MjBQcm9wb3NlJTI1MjBSZXF1ZXN0
...
|  --- | --- | --- | --- |
| `app_id` | `String` | Optional | An optional ID of an existing app. If set, the spec will be treated as a proposed update to the specified app. The existing app is not modified using this method. |
...
```ruby
v2_apps_propose_request = V2AppsProposeRequest.new(
  spec: AppSpec.new(
    name: 'web-app-01',
    databases: [
      Database.new(
