...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveV93aXRoQXNzb2NpYXRlZFJlc291cmNlc0Rhbmdlcm91cw
...
```csharp
DropletsDestroyWithAssociatedResourcesDangerousAsync(
    int dropletId,
    bool xDangerous)
```
...
bool xDangerous = true;
try
{
    await dropletsApi.DropletsDestroyWithAssociatedResourcesDangerousAsync(
        dropletId,
        xDangerous
    );
}
