...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9jaGVja19kZWxldGU
...
```ruby
def uptime_check_delete(check_id)
```
