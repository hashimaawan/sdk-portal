...
|  --- | --- | --- | --- |
| `xAmzTarget` | [`XAmzTarget19Enum`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/llms-pages/typescript/models/enumerations/x-amz-target-19.md) | Header, Required | - |
...
```ts
const xAmzTarget = XAmzTarget19Enum.EnumAmazonAthenaGetDatabase;
...
try {
  const response = await apiController.getDatabase(
    xAmzTarget,
    body
  );
