...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0ZSUyRk5ldHdvcmtzJTJGVXBkYXRlJTI1MjBhJTI1MjBOZXR3b3Jr
...
| `body` | [`UpdateNetworkRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/java/models/structures/update-network-request.md) | Body, Optional | - |
...
```java
int id = 112;
UpdateNetworkRequest body = new UpdateNetworkRequest.Builder()
    .name("new-name")
    .build();
