...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRk92ZXJhZ2Vz
...
Overages overages = new Overages.Builder()
    .amount("3.45")
    .name("Overages")
