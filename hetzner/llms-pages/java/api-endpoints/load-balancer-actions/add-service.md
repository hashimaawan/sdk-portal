...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VyJTI1MjBBY3Rpb25zJTJGQWRkJTI1MjBTZXJ2aWNl
...
```java
CompletableFuture<ActionResponse> addServiceAsync(
    final int id,
...
loadBalancerActionsController.addServiceAsync(id, body).thenAccept(result -> {
