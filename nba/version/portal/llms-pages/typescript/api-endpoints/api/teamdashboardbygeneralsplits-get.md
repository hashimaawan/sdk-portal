...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNoYm9hcmRieWdlbmVyYWxzcGxpdHNfR0VU

:information_source: **Note** This endpoint does not require authentication.

```ts
async teamdashboardbygeneralsplitsGET(
  seasonType: string,
  teamID: string,
  measureType: string,
  perMode: string,
...
try {
  const response = await apiController.teamdashboardbygeneralsplitsGET(
    seasonType,
    teamID,
    measureType,
    perMode,
