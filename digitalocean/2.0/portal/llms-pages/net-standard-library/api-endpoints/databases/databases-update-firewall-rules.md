...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfZmlyZXdhbGxfcnVsZXM
...
```csharp
DatabasesUpdateFirewallRulesAsync(
    Guid databaseClusterUuid,
    Models.V2DatabasesFirewallRequest body)
```
...
| `body` | [`V2DatabasesFirewallRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-databases-firewall-request.md) | Body, Required | - |
...
V2DatabasesFirewallRequest body = new V2DatabasesFirewallRequest
{
...
try
{
    await databasesApi.DatabasesUpdateFirewallRulesAsync(
        databaseClusterUuid,
        body
    );
}
