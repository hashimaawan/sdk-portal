...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfbWlncmF0aW9uU3RhdHVz
...
```csharp
DatabasesGetMigrationStatusAsync(
...
try
{
    ApiResponse<V2DatabasesOnlineMigrationResponse> result = await databasesApi.DatabasesGetMigrationStatusAsync(databaseClusterUuid);
}
