...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRlJlc2VydmVkJTI1MjBJUHMlMkZyZXNlcnZlZElQc19jcmVhdGU
...
ReservedIPsCreate(
    ctx context.Context,
    body models.ReservedIPsCreateBody) (
    models.ApiResponse[models.V2ReservedIpsResponse1],
    error)
```
...
|  --- | --- | --- | --- |
| `body` | [`models.ReservedIPsCreateBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/oneof-anyof-definitions/reserved-i-ps-create-body.md) | Body, Required | This is a container for one-of cases. |
...
body := models.ReservedIPsCreateBodyContainer.FromAssignToDroplet1(models.AssignToDroplet1{
    DropletId:             2457247,
})

apiResponse, err := reservedIPsApi.ReservedIPsCreate(ctx, body)
if err != nil {
