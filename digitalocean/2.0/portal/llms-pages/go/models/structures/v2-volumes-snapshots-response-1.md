...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRlYyJTI1MjBWb2x1bWVzJTI1MjBTbmFwc2hvdHMlMjUyMFJlc3BvbnNlMQ
...
func main() {
    ...
    v2VolumesSnapshotsResponse1 := models.V2VolumesSnapshotsResponse1{
        Snapshots:             []models.Snapshot{
            models.Snapshot{
                Id:                    "8eb4d51a-873f-11e6-96bf-000f53315a41",
                CreatedAt:             parseTime(time.RFC3339, "2020-09-30T18:56:12Z", func(err error) { log.Fatalln(err) }),
                MinDiskSize:           10,
                Name:                  "big-data-snapshot1475261752",
                Regions:               []string{
                    "nyc1",
                },
                SizeGigabytes:         float64(0),
