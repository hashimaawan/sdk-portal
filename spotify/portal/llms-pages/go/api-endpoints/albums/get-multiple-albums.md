...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRkFsYnVtcyUyRmdldC1tdWx0aXBsZS1hbGJ1bXM
...
GetMultipleAlbums(
    ...
    ids string,
    market *string) (
    models.ApiResponse[models.ManyAlbums],
    error)
```
...
apiResponse, err := albumsApi.GetMultipleAlbums(ctx, ids, &market)
if err != nil {
