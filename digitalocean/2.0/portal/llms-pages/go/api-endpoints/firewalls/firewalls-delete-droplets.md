...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19kZWxldGVfZHJvcGxldHM
...
FirewallsDeleteDroplets(
    ...
    body *models.V2FirewallsDropletsRequest) (
    http.Response,
    error)
```
...
| `body` | [`*models.V2FirewallsDropletsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-firewalls-droplets-request.md) | Body, Optional | - |
...
resp, err := firewallsApi.FirewallsDeleteDroplets(ctx, firewallId, &body)
if err != nil {
