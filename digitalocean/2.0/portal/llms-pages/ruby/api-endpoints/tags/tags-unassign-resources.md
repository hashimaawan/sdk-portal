...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRlRhZ3MlMkZ0YWdzX3VuYXNzaWduX3Jlc291cmNlcw
...
```ruby
def tags_unassign_resources(tag_id,
                            body)
```
