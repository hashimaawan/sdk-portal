...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRkVwaXNvZGVzJTJGZ2V0LW11bHRpcGxlLWVwaXNvZGVz
...
GetMultipleEpisodes(
    ...
    ids string,
    market *string) (
    models.ApiResponse[models.ManyEpisodes],
    error)
```
...
apiResponse, err := episodesApi.GetMultipleEpisodes(ctx, ids, &market)
if err != nil {
