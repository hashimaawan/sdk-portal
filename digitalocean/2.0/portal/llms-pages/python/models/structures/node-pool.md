...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRk5vZGVQb29s
...
|  --- | --- | --- | --- |
| `size` | `str` | Required | The slug identifier for the type of Droplet used as workers in the node pool. |
...
| `name` | `str` | Required | A human-readable name for the node pool. |
