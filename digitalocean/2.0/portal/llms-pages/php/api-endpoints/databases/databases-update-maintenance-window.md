...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfbWFpbnRlbmFuY2VXaW5kb3c
...
```php
function databasesUpdateMaintenanceWindow(
    string $databaseClusterUuid,
    ?V2DatabasesMaintenanceRequest $body
): ApiResponse
```
...
| `body` | [`?V2DatabasesMaintenanceRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-databases-maintenance-request.md) | Body, Required | - |
...
$body = V2DatabasesMaintenanceRequestBuilder::init(
    'tuesday',
    '14:00'
)->build();

$databasesApi = $client->getDatabasesApi();
$apiResponse = $databasesApi->databasesUpdateMaintenanceWindow(
    $databaseClusterUuid,
    $body
);
