...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/1.0/portal/#/php/x-redirect/JTI0bSUyRkdpZnMlMjUyMFRyZW5kaW5nJTI1MjBSZXNwb25zZQ
...
```php
use GiphyApiLib\Models\Builders\GifsTrendingResponseBuilder;
...
$gifsTrendingResponse = GifsTrendingResponseBuilder::init()
    ->data(
        [
            GifBuilder::init()
                ->bitlyUrl('bitly_url0')
