...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/1.0/portal/#/php/x-redirect/JTI0bSUyRkdpZnMlMjUyMFJhbmRvbSUyNTIwUmVzcG9uc2U
...
```php
use GiphyApiLib\Models\Builders\GifsRandomResponseBuilder;
...
$gifsRandomResponse = GifsRandomResponseBuilder::init()
    ->data(
        GifBuilder::init()
            ->bitlyUrl('bitly_url0')
