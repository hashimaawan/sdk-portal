...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRlYyJTI1MjBBcHBzJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- |
| `Apps` | [`[]models.AListOfApp`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/a-list-of-app.md) | Optional | - |
...
func main() {
    ...
    v2AppsResponse := models.V2AppsResponse{
        Apps:                  []models.AListOfApp{
            models.AListOfApp{
                ...
                CreatedAt:               models.ToPointer(parseTime(time.RFC3339, "2016-03-13T12:52:32.123Z", func(err error) { log.Fatalln(err) })),
                DefaultIngress:          models.ToPointer("default_ingress2"),
