...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/ruby/x-redirect/JTI0ZSUyRlNlcnZlciUyNTIwQWN0aW9ucyUyRkF0dGFjaCUyNTIwYSUyNTIwU2VydmVyJTI1MjB0byUyNTIwYSUyNTIwTmV0d29yaw
...
```ruby
def attach_a_server_to_a_network(id,
                                 body: nil)
```
...
| `body` | [`AttachToNetworkRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/ruby/models/structures/attach-to-network-request.md) | Body, Optional | - |
...
body = AttachToNetworkRequest.new(
  4711,
  [
    '10.0.1.2'
  ],
...
result = server_actions_controller.attach_a_server_to_a_network(
  id,
  body: body
)
puts result
