...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGU
...
try
{
    await databasesApi.DatabasesDeleteAsync(
        databaseClusterUuid,
        databaseName
    );
}
