...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2dldA
...
try
{
    ApiResponse<V2AppsResponse1> result = await appsApi.AppsGetAsync(
        id,
        name
    );
}
