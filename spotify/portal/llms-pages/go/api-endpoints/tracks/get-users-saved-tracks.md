...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRlRyYWNrcyUyRmdldC11c2Vycy1zYXZlZC10cmFja3M
...
GetUsersSavedTracks(
    ...
    limit *int,
    offset *int) (
    models.ApiResponse[models.PagingSavedTrackObject],
    error)
```
...
apiResponse, err := tracksApi.GetUsersSavedTracks(ctx, &market, &limit, &offset)
if err != nil {
