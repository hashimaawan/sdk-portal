...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRlYyJTI1MjBEYXRhYmFzZXMlMjUyMEZpcmV3YWxsJTI1MjBSZXF1ZXN0
...
import com.digitalocean.api.models.V2DatabasesFirewallRequest;
import java.io.IOException;
import java.util.Arrays;

V2DatabasesFirewallRequest v2DatabasesFirewallRequest = new V2DatabasesFirewallRequest.Builder()
    .rules(Arrays.asList(
        new Rule1.Builder(
            Type7.IP_ADDR,
            "value0"
