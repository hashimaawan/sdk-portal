...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRk11bHRpcGxlJTI1MjBEcm9wbGV0JTI1MjBSZXF1ZXN0
...
|  --- | --- | --- | --- | --- | --- |
| `names` | `string[]` | Required | An array of human human-readable strings you wish to use when displaying the Droplet name. Each name, if set to a domain name managed in the DigitalOcean DNS management system, will configure a PTR record for the Droplet. Each name set during creation will also determine the hostname for the Droplet in its internal configuration. | getNames(): array | setNames(array names): void |
...
```php
use DigitalOceanApiLib\Models\Builders\MultipleDropletRequestBuilder;
use DigitalOceanApiLib\ApiHelper;

$multipleDropletRequest = MultipleDropletRequestBuilder::init(
    [
        'sub-01.example.com',
        'sub-02.example.com'
    ],
