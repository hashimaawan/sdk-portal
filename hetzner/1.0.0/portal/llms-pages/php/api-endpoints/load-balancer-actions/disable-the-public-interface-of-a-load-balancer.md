...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VyJTI1MjBBY3Rpb25zJTJGRGlzYWJsZSUyNTIwdGhlJTI1MjBwdWJsaWMlMjUyMGludGVyZmFjZSUyNTIwb2YlMjUyMGElMjUyMExvYWQlMjUyMEJhbGFuY2Vy
...
```php
function disableThePublicInterfaceOfALoadBalancer(int $id): ActionResponse
```
...
try {
    $result = $loadBalancerActionsController->disableThePublicInterfaceOfALoadBalancer($id);
    echo 'ActionResponse:';
    var_dump($result);
