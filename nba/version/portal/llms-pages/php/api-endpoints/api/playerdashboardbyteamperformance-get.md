...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hib2FyZGJ5dGVhbXBlcmZvcm1hbmNlX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```php
function playerdashboardbyteamperformanceGet(
    string $measureType,
    string $perMode,
    string $plusMinus,
    string $paceAdjust,
...
$api = $client->getAPI();
$apiResponse = $api->playerdashboardbyteamperformanceGet(
    $measureType,
    $perMode,
    $plusMinus,
    $paceAdjust,
