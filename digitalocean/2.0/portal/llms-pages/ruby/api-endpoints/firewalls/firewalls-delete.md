...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19kZWxldGU
...
```ruby
def firewalls_delete(firewall_id)
```
...
result = firewalls_api.firewalls_delete(firewall_id)
