...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfcmVnaW9u
...
```ruby
def databases_update_region(database_cluster_uuid,
                            body)
```
...
| `body` | [`V2DatabasesMigrateRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-databases-migrate-request.md) | Body, Required | - |
...
body = V2DatabasesMigrateRequest.new(
  region: 'lon1'
)
