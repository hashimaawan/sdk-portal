...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveV9ieVRhZw
...
```csharp
string tagName = "env:test";
try
{
    await dropletsApi.DropletsDestroyByTagAsync(tagName);
}
