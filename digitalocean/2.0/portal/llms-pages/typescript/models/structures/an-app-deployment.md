...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRkFuJTI1MjBhcHAlMjUyMGRlcGxveW1lbnQ
...
```ts
import { AnAppDeployment, Phase } from 'digitalocean-apilib';

const anAppDeployment: AnAppDeployment = {
