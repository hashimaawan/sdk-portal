...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/php/x-redirect/JTI0bSUyRk1lJTI1MjBGb2xsb3dpbmclMjUyMFJlcXVlc3Q
...
```php
use SpotifyWebApiWithFixesAndImprovementsFromSonalluxLib\Models\Builders\MeFollowingRequestBuilder;
use SpotifyWebApiWithFixesAndImprovementsFromSonalluxLib\ApiHelper;

$meFollowingRequest = MeFollowingRequestBuilder::init(
    [
        'ids3'
    ]
)
