...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/ruby/x-redirect/JTI0ZSUyRk5ldHdvcmslMjUyMEFjdGlvbnMlMkZBZGQlMjUyMGElMjUyMHN1Ym5ldCUyNTIwdG8lMjUyMGElMjUyME5ldHdvcms
...
```ruby
def add_a_subnet_to_a_network(id,
                              body: nil)
```
...
| `body` | [`AddSubnetRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/ruby/models/structures/add-subnet-request.md) | Body, Optional | - |
...
result = network_actions_controller.add_a_subnet_to_a_network(
  id,
  body: body
)
puts result
