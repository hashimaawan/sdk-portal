...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRkN1c3RvbSUyNTIwQ2VydGlmaWNhdGUlMjUyMFJlcXVlc3Q
...
| `CertificateChain` | `*string` | Optional | The full PEM-formatted trust chain between the certificate authority's certificate and your domain's SSL certificate. |
| `LeafCertificate` | `string` | Required | The contents of a PEM-formatted public SSL certificate. |
| `PrivateKey` | `string` | Required | The contents of a PEM-formatted private-key corresponding to the SSL certificate. |
