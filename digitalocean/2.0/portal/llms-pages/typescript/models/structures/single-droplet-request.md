...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRlNpbmdsZSUyNTIwRHJvcGxldCUyNTIwUmVxdWVzdA
...
| `image` | [`SingleDropletRequestImage`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/oneof-anyof-definitions/single-droplet-request-image.md) | Required | This is a container for one-of cases. |
...
| `sshKeys` | [`SingleDropletRequestSshKeys[] \| undefined`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/oneof-anyof-definitions/single-droplet-request-ssh-keys.md) | Optional | This is Array of a container for any-of cases. |
...
```ts
import { SingleDropletRequest } from 'digitalocean-apilib';

const singleDropletRequest: SingleDropletRequest = {
  name: 'example.com',
