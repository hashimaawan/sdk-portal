...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkRyb3BsZXQlMjUyMEFjdGlvbnMlMkZPdmVydmlldw
...
An instance of the `DropletActionsApi` class can be accessed from the API Client.

```
DropletActionsApi dropletActionsApi = client.DropletActionsApi;
```
