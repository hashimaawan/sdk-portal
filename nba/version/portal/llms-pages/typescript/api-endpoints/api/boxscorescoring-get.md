...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkJveHNjb3Jlc2NvcmluZ19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async boxscorescoringGET(
  gameID?: string,
  startPeriod?: string,
  endPeriod?: string,
  startRange?: string,
...
```ts
try {
  const response = await apiController.boxscorescoringGET();
