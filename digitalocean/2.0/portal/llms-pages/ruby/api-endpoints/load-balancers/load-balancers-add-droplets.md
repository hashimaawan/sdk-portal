...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfYWRkX2Ryb3BsZXRz
...
```ruby
def load_balancers_add_droplets(lb_id,
                                body)
```
...
result = load_balancers_api.load_balancers_add_droplets(
  lb_id,
  body
)
