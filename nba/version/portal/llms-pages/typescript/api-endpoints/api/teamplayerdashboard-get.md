...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW1wbGF5ZXJkYXNoYm9hcmRfR0VU

:information_source: **Note** This endpoint does not require authentication.

```ts
async teamplayerdashboardGET(
  seasonType: string,
  teamID: string,
  measureType: string,
  perMode: string,
...
try {
  const response = await apiController.teamplayerdashboardGET(
    seasonType,
    teamID,
    measureType,
    perMode,
