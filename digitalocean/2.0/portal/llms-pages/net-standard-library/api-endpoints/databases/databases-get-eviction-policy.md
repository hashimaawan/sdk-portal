...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfZXZpY3Rpb25Qb2xpY3k
...
```csharp
DatabasesGetEvictionPolicyAsync(
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type [Models.V2DatabasesEvictionPolicyResponse](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-databases-eviction-policy-response.md).
...
try
{
    ApiResponse<V2DatabasesEvictionPolicyResponse> result = await databasesApi.DatabasesGetEvictionPolicyAsync(databaseClusterUuid);
}
