...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9kZWxldGVfcmVwb3NpdG9yeU1hbmlmZXN0
...
```python
def registry_delete_repository_manifest(self,
                                       registry_name,
                                       repository_name,
                                       manifest_digest)
```
...
| `manifest_digest` | `str` | Template, Required | The manifest digest of a container registry repository tag. |
