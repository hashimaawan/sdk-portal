...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRlYyJTI1MjBSZWdpc3RyeSUyNTIwRGlnZXN0cyUyNTIwUmVzcG9uc2U
...
|  --- | --- | --- | --- |
| `manifests` | [`List[LatestManifest]`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/latest-manifest.md) | Optional | - |
...
from digitaloceanapi.models.v_2_registry_digests_response import V2RegistryDigestsResponse

v_2_registry_digests_response = V2RegistryDigestsResponse(
    meta=Meta(
        total=3,
    ...
    links=Links(
        pages=Pages(
            ...
            additional_properties={
                'first': jsonpickle.decode('"https://api.digitalocean.com/v2/registry/example/repositories/repo-1/digests?page=1&per_page=1"'),
                'prev': jsonpickle.decode('"https://api.digitalocean.com/v2/registry/example/repositories/repo-1/digests?page=1&per_page=1"')
            }
        ),
        additional_properties={
            'exampleAdditionalProperty': jsonpickle.decode('{"key1":"val1","key2":"val2"}')
