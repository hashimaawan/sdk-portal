...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/typescript/x-redirect/JTI0aCUyRl9fZ2V0dGluZ19zdGFydGVk
...
![Version Check](https://apidocs.io/illustration/typescript?workspaceFolder=HetznerCloudApi&step=versionCheck)
...
![Resolve Dependencies](https://apidocs.io/illustration/typescript?workspaceFolder=HetznerCloudApi&workspaceName=hetzner-cloud-apilib&step=resolveDependency)
...
- The created project manages its dependencies using its `package.json` file. In order to add a dependency on the *Hetzner Cloud APILib* client library, double click on the `package.json` file in the bar on the left and add the dependency to the package in it.

![Add HetznerCloudApilib Dependency](https://apidocs.io/illustration/typescript?workspaceFolder=HetznerCloudApi&workspaceName=hetzner-cloud-apilib&step=importDependency)
...
![Install HetznerCloudApilib Dependency](https://apidocs.io/illustration/typescript?step=installDependency)
...
| httpClientOptions | [`Partial<HttpClientOptions>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/typescript/sdk-infrastructure/configuration/httpclientoptions.md) | Stable configurable http client options. |
| unstableHttpClientOptions | `any` | Unstable configurable http client options. |
| logging | [`PartialLoggingOptions`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/typescript/sdk-infrastructure/configuration/partialloggingoptions.md) | Logging Configuration to enable logging |
...
```ts
import { Client, LogLevel } from 'hetzner-cloud-apilib';
...
import { Client } from 'hetzner-cloud-apilib';
...
See the [Configuration-Based Client Initialization](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/typescript/sdk-infrastructure/configuration/configuration-based-client-initialization.md) section for details.
...
See the [Environment-Based Client Initialization](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/typescript/sdk-infrastructure/configuration/environment-based-client-initialization.md) section for details.
