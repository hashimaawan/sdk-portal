...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRvbWFpbiUyNTIwUmVjb3JkcyUyRmRvbWFpbnNfZ2V0X3JlY29yZA

To retrieve a specific domain record, send a GET request to `/v2/domains/$DOMAIN_NAME/records/$RECORD_ID`.

```java
CompletableFuture<ApiResponse<V2DomainsRecordsResponse1>> domainsGetRecordAsync(
...
domainRecordsApi.domainsGetRecordAsync(domainName, domainRecordId).thenAccept(result -> {
