...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveV9yZXRyeVdpdGhBc3NvY2lhdGVkUmVzb3VyY2Vz
...
```python
def droplets_destroy_retry_with_associated_resources(self,
                                                    droplet_id)
```
