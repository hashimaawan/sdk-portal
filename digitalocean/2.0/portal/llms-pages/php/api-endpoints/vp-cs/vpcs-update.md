...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlZQQ3MlMkZ2cGNzX3VwZGF0ZQ

To update information about a VPC, send a PUT request to `/v2/vpcs/$VPC_ID`.

```php
function vpcsUpdate(string $vpcId, V2VpcsRequest2 $body): ApiResponse
```
...
| `body` | [`V2VpcsRequest2`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-vpcs-request-2.md) | Body, Required | - |
...
$body = V2VpcsRequest2Builder::init(
    'env.prod-vpc'
)
...
$apiResponse = $vpCsApi->vpcsUpdate(
    $vpcId,
    $body
);
