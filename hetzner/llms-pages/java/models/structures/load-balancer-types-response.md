...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRkxvYWQlMjUyMEJhbGFuY2VyJTI1MjBUeXBlcyUyNTIwUmVzcG9uc2U
...
|  --- | --- | --- | --- | --- | --- |
| `LoadBalancerTypes` | [`List<LoadBalancerType>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/load-balancer-type.md) | Required | - | List<LoadBalancerType> getLoadBalancerTypes() | setLoadBalancerTypes(List<LoadBalancerType> loadBalancerTypes) |
