...
|  --- | --- | --- | --- | --- | --- |
| `Error` | [`OauthProviderError`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/furkot/1.0.0/portal/llms-pages/java/models/enumerations/oauth-provider-error.md) | Required | Gets or sets error code. | OauthProviderError getError() | setError(OauthProviderError error) |
