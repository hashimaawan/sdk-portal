...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlZQQ3MlMkZ2cGNzX2NyZWF0ZQ
...
```php
function vpcsCreate(V2VpcsRequest $body): ApiResponse
```
...
|  --- | --- | --- | --- |
| `body` | [`V2VpcsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-vpcs-request.md) | Body, Required | - |
...
```php
$body = V2VpcsRequestBuilder::init(
    'env.prod-vpc',
    'nyc1'
)
...
$apiResponse = $vpCsApi->vpcsCreate($body);
