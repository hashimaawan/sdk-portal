...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRlYyJTI1MjBSZWdpc3RyeSUyNTIwUmVwb3NpdG9yaWVzVjIlMjUyMFJlc3BvbnNl
...
|  --- | --- | --- | --- |
| `Repositories` | [`List<Repository1>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/repository-1.md) | Optional | - |
...
V2RegistryRepositoriesV2Response v2RegistryRepositoriesV2Response = new V2RegistryRepositoriesV2Response
{
    Meta = new Meta
    {
        Total = 5,
    ...
    Repositories = new List<Repository1>
    {
        new Repository1
        {
