...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTJGdm9sdW1lc19saXN0
...
VolumesList(
    ctx context.Context,
    name *string,
    region *models.Region2,
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2VolumesResponse],
    error)
```
...
| `region` | [`*models.Region2`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/enumerations/region-2.md) | Query, Optional | The slug identifier for the region where the resource is available. |
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type [models.V2VolumesResponse](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-volumes-response.md).
...
apiResponse, err := blockStorageApi.VolumesList(ctx, &name, &region, &perPage, &page)
if err != nil {
