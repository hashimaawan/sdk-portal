...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2RlbGV0ZV9ub2RlUG9vbA
...
```python
def kubernetes_delete_node_pool(self,
                               cluster_id,
                               node_pool_id)
```
