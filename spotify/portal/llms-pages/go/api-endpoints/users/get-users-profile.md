...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRlVzZXJzJTJGZ2V0LXVzZXJzLXByb2ZpbGU
...
GetUsersProfile(
    ctx context.Context,
    userId string) (
    models.ApiResponse[models.PublicUserObject],
    error)
```
...
apiResponse, err := usersApi.GetUsersProfile(ctx, userId)
if err != nil {
