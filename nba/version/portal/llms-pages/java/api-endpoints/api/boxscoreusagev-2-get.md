...
```java
CompletableFuture<Void> boxscoreusagev2GETAsync(
    final String gameID,
...
aPIController.boxscoreusagev2GETAsync(gameID, startPeriod, endPeriod, startRange, endRange, rangeType).thenAccept(result -> {
