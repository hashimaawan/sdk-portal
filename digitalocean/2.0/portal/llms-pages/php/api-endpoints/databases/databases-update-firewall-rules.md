...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfZmlyZXdhbGxfcnVsZXM
...
```php
function databasesUpdateFirewallRules(
    string $databaseClusterUuid,
    V2DatabasesFirewallRequest $body
): ApiResponse
```
...
| `body` | [`V2DatabasesFirewallRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-databases-firewall-request.md) | Body, Required | - |
...
$body = V2DatabasesFirewallRequestBuilder::init()
    ->rules(
        [
            Rule1Builder::init(
                Type7::IP_ADDR,
...
$apiResponse = $databasesApi->databasesUpdateFirewallRules(
    $databaseClusterUuid,
    $body
);
