...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19jcmVhdGVfcmVwbGljYQ
...
DatabasesCreateReplica(
    ...
    body *models.Replica) (
    models.ApiResponse[models.V2DatabasesReplicasResponse1],
    error)
```
...
| `body` | [`*models.Replica`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/replica.md) | Body, Optional | - |
...
apiResponse, err := databasesApi.DatabasesCreateReplica(ctx, databaseClusterUuid, &body)
if err != nil {
