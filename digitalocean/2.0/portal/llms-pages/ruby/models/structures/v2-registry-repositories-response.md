...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRlYyJTI1MjBSZWdpc3RyeSUyNTIwUmVwb3NpdG9yaWVzJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- |
| `repositories` | [`Array[Repository]`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/repository.md) | Optional | - |
...
```ruby
v2_registry_repositories_response = V2RegistryRepositoriesResponse.new(
  meta: Meta.new(
    total: 1,
