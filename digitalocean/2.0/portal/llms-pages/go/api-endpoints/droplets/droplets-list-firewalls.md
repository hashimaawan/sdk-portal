...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfbGlzdF9maXJld2FsbHM
...
DropletsListFirewalls(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2DropletsFirewallsResponse],
    error)
```
...
apiResponse, err := dropletsApi.DropletsListFirewalls(ctx, dropletId, &perPage, &page)
if err != nil {
