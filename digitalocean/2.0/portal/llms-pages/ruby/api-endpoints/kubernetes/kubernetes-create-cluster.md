...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2NyZWF0ZV9jbHVzdGVy
...
```ruby
def kubernetes_create_cluster(body)
```
...
|  --- | --- | --- | --- |
| `body` | [`KubernetesCluster`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/kubernetes-cluster.md) | Body, Required | - |
...
result = kubernetes_api.kubernetes_create_cluster(body)
