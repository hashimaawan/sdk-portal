...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkNETiUyNTIwRW5kcG9pbnRzJTJGY2RuX2xpc3RfZW5kcG9pbnRz
...
CdnListEndpoints(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2CdnEndpointsResponse],
    error)
```
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type [models.V2CdnEndpointsResponse](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-cdn-endpoints-response.md).
...
apiResponse, err := cdnEndpointsApi.CdnListEndpoints(ctx, &perPage, &page)
if err != nil {
