...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2dldF9ub2RlUG9vbA
...
```php
function kubernetesGetNodePool(string $clusterId, string $nodePoolId): ApiResponse
```
...
$apiResponse = $kubernetesApi->kubernetesGetNodePool(
    $clusterId,
    $nodePoolId
);
