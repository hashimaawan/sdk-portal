...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlRlYW1wbGF5ZXJkYXNoYm9hcmRfR0VU

:information_source: **Note** This endpoint does not require authentication.

```php
function teamplayerdashboardGet(
    string $seasonType,
    string $teamId,
    string $measureType,
    string $perMode,
...
$api = $client->getAPI();
$apiResponse = $api->teamplayerdashboardGet(
    $seasonType,
    $teamId,
    $measureType,
    $perMode,
