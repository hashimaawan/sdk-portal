...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2dldF9hdmFpbGFibGVVcGdyYWRlcw
...
```csharp
KubernetesGetAvailableUpgradesAsync(
    Guid clusterId)
```
...
try
{
    ApiResponse<V2KubernetesClustersUpgradesResponse> result = await kubernetesApi.KubernetesGetAvailableUpgradesAsync(clusterId);
}
