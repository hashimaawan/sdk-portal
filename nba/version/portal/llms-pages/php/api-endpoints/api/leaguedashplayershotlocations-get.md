...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRkxlYWd1ZWRhc2hwbGF5ZXJzaG90bG9jYXRpb25zX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```php
function leaguedashplayershotlocationsGet(
    string $measureType,
    string $perMode,
    string $plusMinus,
    string $paceAdjust,
...
$api = $client->getAPI();
$apiResponse = $api->leaguedashplayershotlocationsGet(
    $measureType,
    $perMode,
    $plusMinus,
    $paceAdjust,
