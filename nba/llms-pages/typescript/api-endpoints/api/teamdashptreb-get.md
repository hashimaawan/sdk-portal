...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNocHRyZWJfR0VU
...
try {
  const response = await apiController.teamdashptrebGET(
    perMode,
    season,
    seasonType,
    teamID,
