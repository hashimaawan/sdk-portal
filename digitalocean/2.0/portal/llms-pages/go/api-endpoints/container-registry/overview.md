...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZPdmVydmlldw
...
The instance of the `ContainerRegistryApi` class can be accessed from the API Client.

```
containerRegistryApi := client.ContainerRegistryApi()
```
