...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2xpc3Rfbm9kZVBvb2xz
...
KubernetesListNodePools(
    ctx context.Context,
    clusterId uuid.UUID) (
    models.ApiResponse[models.V2KubernetesClustersNodePoolsResponse],
    error)
```
...
apiResponse, err := kubernetesApi.KubernetesListNodePools(ctx, clusterId)
if err != nil {
