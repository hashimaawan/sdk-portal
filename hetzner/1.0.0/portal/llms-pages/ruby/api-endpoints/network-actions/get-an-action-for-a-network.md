...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/ruby/x-redirect/JTI0ZSUyRk5ldHdvcmslMjUyMEFjdGlvbnMlMkZHZXQlMjUyMGFuJTI1MjBBY3Rpb24lMjUyMGZvciUyNTIwYSUyNTIwTmV0d29yaw
...
```ruby
def get_an_action_for_a_network(id,
                                action_id)
```
...
result = network_actions_api.get_an_action_for_a_network(
  id,
  action_id
)
