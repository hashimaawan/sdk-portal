...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRlRhZ3MlMkZPdmVydmlldw
...
The instance of the `TagsApi` class can be accessed from the API Client.

```
tagsApi := client.TagsApi()
```
