...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkZsb2F0aW5nJTI1MjBJUHMlMkZmbG9hdGluZ0lQc19saXN0
...
FloatingIPsList(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2FloatingIpsResponse],
    error)
```
...
apiResponse, err := floatingIPsApi.FloatingIPsList(ctx, &perPage, &page)
if err != nil {
