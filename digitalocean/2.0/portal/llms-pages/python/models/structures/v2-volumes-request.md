...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRlYyJTI1MjBWb2x1bWVzJTI1MjBSZXF1ZXN0
...
| `filesystem_label` | `str` | Optional | **Constraints**: *Maximum Length*: `16` |
...
from digitaloceanapi.models.v_2_volumes_request import V2VolumesRequest

v_2_volumes_request = V2VolumesRequest(
    name='example',
    size_gigabytes=10,
    region=Region2.NYC3,
