...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9nZXQ

To get information about your container registry, send a GET request to `/v2/registry`.

```php
function registryGet(): ApiResponse
```
...
$apiResponse = $containerRegistryApi->registryGet();
