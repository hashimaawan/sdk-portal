...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/#/python/x-redirect/JTI0bSUyRlRhZw
...
|  --- | --- | --- | --- |
| `key` | `str` | Optional | **Constraints**: *Minimum Length*: `1`, *Maximum Length*: `128` |
| `value` | `str` | Optional | **Constraints**: *Minimum Length*: `0`, *Maximum Length*: `256` |
