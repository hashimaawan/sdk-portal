...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRlNTSCUyNTIwS2V5cyUyRnNzaEtleXNfY3JlYXRl
...
|  --- | --- | --- | --- |
| `body` | [`models.SshKey`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/ssh-key.md) | Body, Required | - |
...
apiResponse, err := sshKeysApi.SshKeysCreate(ctx, body)
if err != nil {
