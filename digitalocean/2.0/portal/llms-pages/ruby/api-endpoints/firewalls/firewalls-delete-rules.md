...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19kZWxldGVfcnVsZXM
...
```ruby
def firewalls_delete_rules(firewall_id,
                           body: nil)
```
...
| `body` | [`V2FirewallsRulesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-firewalls-rules-request.md) | Body, Optional | - |
...
body = V2FirewallsRulesRequest.new(
  inbound_rules: [
    InboundRule.new(
      ports: '3306',
...
result = firewalls_api.firewalls_delete_rules(
  firewall_id,
  body: body
)
