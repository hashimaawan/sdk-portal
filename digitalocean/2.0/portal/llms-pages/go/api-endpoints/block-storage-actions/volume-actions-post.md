...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTI1MjBBY3Rpb25zJTJGdm9sdW1lQWN0aW9uc19wb3N0
...
VolumeActionsPost(
    ctx context.Context,
    body models.VolumeActionsPostBody,
    perPage *int,
    page *int) (
...
|  --- | --- | --- | --- |
| `body` | [`models.VolumeActionsPostBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/oneof-anyof-definitions/volume-actions-post-body.md) | Body, Required | This is a container for any-of cases. |
...
body := models.VolumeActionsPostBodyContainer.FromV2VolumesActionsRequest(models.V2VolumesActionsRequest{
    ...
    AdditionalProperties:  map[string]interface{}{
        "volume_name": interface{}("example"),
    },
})

apiResponse, err := blockStorageActionsApi.VolumeActionsPost(ctx, body, nil, nil)
if err != nil {
