...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfYWRkX2ZvcndhcmRpbmdSdWxlcw
...
```ts
async loadBalancersAddForwardingRules(
  lbId: string,
...
try {
  const response = await loadBalancersApi.loadBalancersAddForwardingRules(
    lbId,
    body
  );
