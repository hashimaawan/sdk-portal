...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlZQQ3MlMkZ2cGNzX2RlbGV0ZQ
...
```php
function vpcsDelete(string $vpcId): ApiResponse
```
...
$apiResponse = $vpCsApi->vpcsDelete($vpcId);
