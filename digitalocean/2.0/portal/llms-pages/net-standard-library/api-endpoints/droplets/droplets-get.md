...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZ2V0
...
try
{
    ApiResponse<V2DropletsResponse1> result = await dropletsApi.DropletsGetAsync(dropletId);
}
