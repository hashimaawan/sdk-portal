...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JlbWlzY3YyX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```ts
async boxscoremiscv2GET(
  gameID: string,
  startPeriod: string,
  endPeriod: string,
  startRange: string,
...
try {
  const response = await apiController.boxscoremiscv2GET(
    gameID,
    startPeriod,
    endPeriod,
    startRange,
