...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/1.0/portal/#/go/x-redirect/JTI0ZSUyRmdpZnMlMkZ0cmVuZGluZ0dpZnM
...
TrendingGifs(
    ...
    offset *int,
    rating *string) (
    models.ApiResponse[models.GifsTrendingResponse],
    error)
```
...
apiResponse, err := gifsController.TrendingGifs(ctx, &limit, &offset, nil)
if err != nil {
    log.Fatalln(err)
} else {
