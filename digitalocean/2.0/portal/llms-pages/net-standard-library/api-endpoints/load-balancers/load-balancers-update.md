...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfdXBkYXRl
...
```csharp
LoadBalancersUpdateAsync(
    string lbId,
    LoadBalancersUpdateBody body)
```
...
| `body` | [`LoadBalancersUpdateBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/oneof-anyof-definitions/load-balancers-update-body.md) | Body, Required | This is a container for one-of cases. |
...
LoadBalancersUpdateBody body = LoadBalancersUpdateBody.FromAssignDropletsByID(
    new AssignDropletsById
    {
        ...
        StickySessions = new StickySessions
        {
            Type = Type16.None,
        },
...
try
{
    ApiResponse<V2LoadBalancersResponse1> result = await loadBalancersApi.LoadBalancersUpdateAsync(
        lbId,
        body
    );
}
