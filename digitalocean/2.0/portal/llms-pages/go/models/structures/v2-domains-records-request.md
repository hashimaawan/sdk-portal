...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRlYyJTI1MjBEb21haW5zJTI1MjBSZWNvcmRzJTI1MjBSZXF1ZXN0
...
func main() {
    v2DomainsRecordsRequest := models.V2DomainsRecordsRequest{
        Data:                  "ns1.digitalocean.com",
        Flags:                 models.NewOptional(models.ToPointer(82)),
        Id:                    models.ToPointer(28448429),
        Name:                  "@",
        Port:                  models.NewOptional(models.ToPointer(214)),
        Priority:              models.NewOptional(models.ToPointer(216)),
