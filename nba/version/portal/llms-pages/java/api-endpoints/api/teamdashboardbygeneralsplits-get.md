...
```java
CompletableFuture<Void> teamdashboardbygeneralsplitsGETAsync(
...
aPIController.teamdashboardbygeneralsplitsGETAsync(seasonType, teamID, measureType, perMode, plusMinus, paceAdjust, rank, season, outcome, location, month, seasonSegment, dateFrom, dateTo, opponentTeamID, vsConference, vsDivision, gameSegment, period, lastNGames).thenAccept(result -> {
