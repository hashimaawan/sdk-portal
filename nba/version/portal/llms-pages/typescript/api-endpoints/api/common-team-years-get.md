...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkNvbW1vblRlYW1ZZWFyc19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async commonTeamYearsGET(
  leagueID: string,
...
try {
  const response = await apiController.commonTeamYearsGET(leagueID);
