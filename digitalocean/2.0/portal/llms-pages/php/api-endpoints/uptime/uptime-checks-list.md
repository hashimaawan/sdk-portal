...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9jaGVja3NfbGlzdA

To list all of the Uptime checks on your account, send a GET request to `/v2/uptime/checks`.

```php
function uptimeChecksList(?int $perPage = 20, ?int $page = 1): ApiResponse
```
...
$apiResponse = $uptimeApi->uptimeChecksList(
    $perPage,
    $page
);
