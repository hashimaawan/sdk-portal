...
[`Task<Models.CreateServerResponse>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/net-standard-library/models/structures/create-server-response.md)
...
try
{
    CreateServerResponse result = await serversController.CreateAServerAsync(body);
}
