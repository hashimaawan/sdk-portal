...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRlYyJTI1MjBSZWdpb25zJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- | --- | --- |
| `Regions` | [`List<Region>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/region.md) | Required | - | List<Region> getRegions() | setRegions(List<Region> regions) |
...
import com.digitalocean.api.models.V2RegionsResponse;
import com.digitalocean.api.models.containers.LinksPages;
import java.io.IOException;
import java.util.Arrays;

V2RegionsResponse v2RegionsResponse = new V2RegionsResponse.Builder(
    Arrays.asList(
        new Region.Builder(
            true,
            Arrays.asList(
