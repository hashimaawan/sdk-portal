...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRkZpcmV3YWxs
...
|  --- | --- | --- | --- | --- | --- |
| `AppliedTo` | [`List<AppliedTo>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/applied-to.md) | Required | - | List<AppliedTo> getAppliedTo() | setAppliedTo(List<AppliedTo> appliedTo) |
...
| `Rules` | [`List<Rule>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/rule.md) | Required | - | List<Rule> getRules() | setRules(List<Rule> rules) |
