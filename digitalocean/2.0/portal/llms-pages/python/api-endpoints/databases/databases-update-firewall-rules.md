...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfZmlyZXdhbGxfcnVsZXM
...
```python
def databases_update_firewall_rules(self,
...
| `body` | [`V2DatabasesFirewallRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/v2-databases-firewall-request.md) | Body, Required | - |
...
body = V2DatabasesFirewallRequest(
    rules=[
        Rule1(
            mtype=Type7.IP_ADDR,
            value='192.168.1.1'
...
result = databases_api.databases_update_firewall_rules(
    database_cluster_uuid,
    body
)
