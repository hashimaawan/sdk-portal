...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRvbWFpbnMlMkZkb21haW5zX2RlbGV0ZQ

To delete a domain, send a DELETE request to `/v2/domains/$DOMAIN_NAME`.

```php
function domainsDelete(string $domainName): ApiResponse
```
...
$apiResponse = $domainsApi->domainsDelete($domainName);
