...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9nZXRfc3Vic2NyaXB0aW9u
...
```php
function registryGetSubscription(): ApiResponse
```
...
$apiResponse = $containerRegistryApi->registryGetSubscription();
