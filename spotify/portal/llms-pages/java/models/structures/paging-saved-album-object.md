...
Source: https://github.com/hashimaawan/sdk-portal/tree/main/spotify/#/java/x-redirect/JTI0bSUyRlBhZ2luZ1NhdmVkQWxidW1PYmplY3Q
...
| `Items` | [`List<SavedAlbumObject>`](https://github.com/hashimaawan/sdk-portal/tree/main/spotify/llms-pages/java/models/structures/saved-album-object.md) | Required | - | List<SavedAlbumObject> getItems() | setItems(List<SavedAlbumObject> items) |
