...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/typescript/x-redirect/JTI0ZSUyRlRyYWNrcyUyRmNoZWNrLXVzZXJzLXNhdmVkLXRyYWNrcw
...
try {
  const response = await tracksApi.checkUsersSavedTracks(ids);
