...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9nZXQ

To get information about your container registry, send a GET request to `/v2/registry`.

```java
CompletableFuture<ApiResponse<V2RegistryResponse>> registryGetAsync()
```
...
```java
containerRegistryApi.registryGetAsync().thenAccept(result -> {
