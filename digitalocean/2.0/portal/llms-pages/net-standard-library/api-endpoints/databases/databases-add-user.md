...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19hZGRfdXNlcg
...
| `body` | [`User`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/user.md) | Body, Required | - |
...
try
{
    ApiResponse<V2DatabasesUsersResponse1> result = await databasesApi.DatabasesAddUserAsync(
        databaseClusterUuid,
        body
    );
}
