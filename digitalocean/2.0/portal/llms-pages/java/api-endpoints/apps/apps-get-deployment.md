...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2dldF9kZXBsb3ltZW50

Retrieve information about an app deployment.

```java
CompletableFuture<ApiResponse<V2AppsDeploymentsResponse1>> appsGetDeploymentAsync(
    final String appId,
...
appsApi.appsGetDeploymentAsync(appId, deploymentId).thenAccept(result -> {
