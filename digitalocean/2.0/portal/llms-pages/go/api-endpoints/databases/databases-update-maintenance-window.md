...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfbWFpbnRlbmFuY2VXaW5kb3c
...
DatabasesUpdateMaintenanceWindow(
    ...
    body *models.V2DatabasesMaintenanceRequest) (
    http.Response,
    error)
```
...
| `body` | [`*models.V2DatabasesMaintenanceRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-databases-maintenance-request.md) | Body, Required | - |
...
resp, err := databasesApi.DatabasesUpdateMaintenanceWindow(ctx, databaseClusterUuid, &body)
if err != nil {
