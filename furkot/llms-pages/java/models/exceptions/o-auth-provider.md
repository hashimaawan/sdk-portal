...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/furkot/#/java/x-redirect/JTI0bSUyRk9BdXRoUHJvdmlkZXI
...
|  --- | --- | --- | --- | --- | --- |
| `Error` | [`OAuthProviderErrorEnum`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/furkot/llms-pages/java/models/enumerations/o-auth-provider-error.md) | Required | Gets or sets error code. | OAuthProviderErrorEnum getError() | setError(OAuthProviderErrorEnum error) |
