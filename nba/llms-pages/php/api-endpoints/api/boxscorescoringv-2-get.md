...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/#/php/x-redirect/JTI0ZSUyRiUyRkJveHNjb3Jlc2NvcmluZ3YyX0dFVA
...
try {
    $aPIController->boxscorescoringv2GET(
        $gameID,
        $startPeriod,
        $endPeriod,
        $startRange,
