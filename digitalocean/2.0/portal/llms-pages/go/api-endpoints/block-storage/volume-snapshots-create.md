...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTJGdm9sdW1lU25hcHNob3RzX2NyZWF0ZQ
...
VolumeSnapshotsCreate(
    ctx context.Context,
    volumeId uuid.UUID,
    body models.V2VolumesSnapshotsRequest) (
...
| `body` | [`models.V2VolumesSnapshotsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-volumes-snapshots-request.md) | Body, Required | - |
...
apiResponse, err := blockStorageApi.VolumeSnapshotsCreate(ctx, volumeId, body)
if err != nil {
