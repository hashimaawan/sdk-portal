...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkNETiUyNTIwRW5kcG9pbnRzJTJGY2RuX3VwZGF0ZV9lbmRwb2ludHM
...
```ts
async cdnUpdateEndpoints(
  cdnId: string,
  body: V2CdnEndpointsRequest,
...
| `body` | [`V2CdnEndpointsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-cdn-endpoints-request.md) | Body, Required | - |
...
const body: V2CdnEndpointsRequest = {
...
try {
  const response = await cdnEndpointsApi.cdnUpdateEndpoints(
    cdnId,
    body
  );
