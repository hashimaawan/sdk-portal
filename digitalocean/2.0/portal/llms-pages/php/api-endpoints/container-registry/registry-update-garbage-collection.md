...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV91cGRhdGVfZ2FyYmFnZUNvbGxlY3Rpb24
...
```php
function registryUpdateGarbageCollection(
    string $registryName,
    string $garbageCollectionUuid,
    V2RegistryGarbageCollectionRequest $body
): ApiResponse
```
...
| `body` | [`V2RegistryGarbageCollectionRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-registry-garbage-collection-request.md) | Body, Required | - |
...
$body = V2RegistryGarbageCollectionRequestBuilder::init()
    ->cancel(true)
    ->build();

$containerRegistryApi = $client->getContainerRegistryApi();
$apiResponse = $containerRegistryApi->registryUpdateGarbageCollection(
    $registryName,
