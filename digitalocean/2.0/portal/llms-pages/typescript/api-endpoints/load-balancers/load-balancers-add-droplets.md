...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfYWRkX2Ryb3BsZXRz
...
```ts
async loadBalancersAddDroplets(
  lbId: string,
...
try {
  const response = await loadBalancersApi.loadBalancersAddDroplets(
    lbId,
    body
  );
