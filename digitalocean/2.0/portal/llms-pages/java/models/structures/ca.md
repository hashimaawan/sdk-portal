...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRkNh
...
|  --- | --- | --- | --- | --- | --- |
| `Certificate` | `String` | Required, Read-only | base64 encoding of the certificate used to secure database connections | String getCertificate() | setCertificate(String certificate) |
