...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRlNTSCUyNTIwS2V5cyUyRnNzaEtleXNfY3JlYXRl
...
```java
CompletableFuture<ApiResponse<V2AccountKeysResponse1>> sshKeysCreateAsync(
    final SshKey body)
```
...
|  --- | --- | --- | --- |
| `body` | [`SshKey`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/ssh-key.md) | Body, Required | - |
...
```java
SshKey body = new SshKey.Builder(
    "My SSH Public Key",
...
sshKeysApi.sshKeysCreateAsync(body).thenAccept(result -> {
