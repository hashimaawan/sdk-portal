...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfcmVwbGljYQ
...
```python
def databases_get_replica(self,
...
| `replica_name` | `str` | Template, Required | The name of the database replica. |
...
result = databases_api.databases_get_replica(
    database_cluster_uuid,
    replica_name
)
