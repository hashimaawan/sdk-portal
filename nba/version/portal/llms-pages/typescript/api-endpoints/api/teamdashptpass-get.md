...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNocHRwYXNzX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```ts
async teamdashptpassGET(
  perMode: string,
  season: string,
  seasonType: string,
  teamID: string,
...
try {
  const response = await apiController.teamdashptpassGET(
    perMode,
    season,
    seasonType,
    teamID,
