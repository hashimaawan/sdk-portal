...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRlYyJTI1MjBBcHBzJTI1MjBSZXNwb25zZTE
...
|  --- | --- | --- | --- |
| `app` | [`AListOfApp`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/a-list-of-app.md) | Optional | An application's configuration and status. |
...
from digitaloceanapi.models.v_2_apps_response_1 import V2AppsResponse1
from digitaloceanapi.models.window import Window

v_2_apps_response_1 = V2AppsResponse1(
    app=AListOfApp(
        spec=AppSpec(
            name='name2',
            databases=[
        ...
        created_at=dateutil.parser.parse('2016-03-13T12:52:32.123Z'),
        default_ingress='default_ingress8',
        domains=[
