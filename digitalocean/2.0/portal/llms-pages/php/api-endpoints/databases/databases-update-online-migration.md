...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfb25saW5lTWlncmF0aW9u
...
```php
function databasesUpdateOnlineMigration(
    string $databaseClusterUuid,
    V2DatabasesOnlineMigrationRequest $body
): ApiResponse
```
...
| `body` | [`V2DatabasesOnlineMigrationRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-databases-online-migration-request.md) | Body, Required | - |
...
$body = V2DatabasesOnlineMigrationRequestBuilder::init()
    ->disableSsl(false)
    ->source(
        SourceBuilder::init()
...
$apiResponse = $databasesApi->databasesUpdateOnlineMigration(
    $databaseClusterUuid,
    $body
);
