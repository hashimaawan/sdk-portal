...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/typescript/x-redirect/JTI0ZSUyRlNob3dzJTJGc2F2ZS1zaG93cy11c2Vy
...
| `body` | [`MeShowsRequest \| undefined`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/typescript/models/structures/me-shows-request.md) | Body, Optional | - |
...
try {
  const response = await showsApi.saveShowsUser(ids);
