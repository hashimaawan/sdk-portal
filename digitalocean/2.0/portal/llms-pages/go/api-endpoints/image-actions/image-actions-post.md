...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkltYWdlJTI1MjBBY3Rpb25zJTJGaW1hZ2VBY3Rpb25zX3Bvc3Q
...
ImageActionsPost(
    ctx context.Context,
    imageId int,
    body *models.ImageActionsPostBody) (
    models.ApiResponse[models.Action],
    error)
```
...
| `body` | [`*models.ImageActionsPostBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/oneof-anyof-definitions/image-actions-post-body.md) | Body, Optional | This is a container for any-of cases. |
...
body := models.ImageActionsPostBodyContainer.FromV2ImagesActionsRequest(models.V2ImagesActionsRequest{
    Type:                  models.Type15_Convert,
})

apiResponse, err := imageActionsApi.ImageActionsPost(ctx, imageId, &body)
if err != nil {
