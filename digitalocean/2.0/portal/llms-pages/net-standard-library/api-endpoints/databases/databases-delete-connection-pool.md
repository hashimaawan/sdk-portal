...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGVfY29ubmVjdGlvblBvb2w
...
```csharp
DatabasesDeleteConnectionPoolAsync(
...
try
{
    await databasesApi.DatabasesDeleteConnectionPoolAsync(
        databaseClusterUuid,
        poolName
    );
}
