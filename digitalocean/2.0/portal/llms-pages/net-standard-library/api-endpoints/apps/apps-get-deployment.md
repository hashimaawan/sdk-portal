...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2dldF9kZXBsb3ltZW50

Retrieve information about an app deployment.

```csharp
AppsGetDeploymentAsync(
    string appId,
    string deploymentId)
```
...
try
{
    ApiResponse<V2AppsDeploymentsResponse1> result = await appsApi.AppsGetDeploymentAsync(
        appId,
        deploymentId
    );
}
