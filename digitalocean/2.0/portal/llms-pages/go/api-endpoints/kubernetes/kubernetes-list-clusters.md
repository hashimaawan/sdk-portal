...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2xpc3RfY2x1c3RlcnM
...
KubernetesListClusters(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2KubernetesClustersResponse],
    error)
```
...
apiResponse, err := kubernetesApi.KubernetesListClusters(ctx, &perPage, &page)
if err != nil {
