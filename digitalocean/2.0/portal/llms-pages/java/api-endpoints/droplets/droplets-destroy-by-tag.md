...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveV9ieVRhZw
...
```java
CompletableFuture<ApiResponse<Void>> dropletsDestroyByTagAsync(
...
dropletsApi.dropletsDestroyByTagAsync(tagName).thenAccept(result -> {
