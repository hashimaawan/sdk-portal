...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRlJlc2VydmVkJTI1MjBJUHMlMkZyZXNlcnZlZElQc19saXN0
...
ReservedIPsList(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2ReservedIpsResponse],
    error)
```
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type [models.V2ReservedIpsResponse](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-reserved-ips-response.md).
...
apiResponse, err := reservedIPsApi.ReservedIPsList(ctx, &perPage, &page)
if err != nil {
