...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0ZSUyRk5ldHdvcmslMjUyMEFjdGlvbnMlMkZDaGFuZ2UlMjUyMElQJTI1MjByYW5nZSUyNTIwb2YlMjUyMGElMjUyME5ldHdvcms
...
```php
function changeIPRangeOfANetwork(int $id, ?ChangeIPRangeRequest $body = null): ActionResponse
```
...
| `body` | [`?ChangeIPRangeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/structures/change-ip-range-request.md) | Body, Optional | - |
...
$body = ChangeIPRangeRequestBuilder::init(
    '10.0.0.0/12'
)->build();
...
try {
    $result = $networkActionsController->changeIPRangeOfANetwork(
        $id,
        $body
    );
    echo 'ActionResponse:';
