...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRlByb2plY3Q
...
| `IsDefault` | `Boolean` | Optional | If true, all resources will be added to this project if no project is specified. | Boolean getIsDefault() | setIsDefault(Boolean isDefault) |
