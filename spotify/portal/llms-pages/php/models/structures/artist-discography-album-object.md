...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/php/x-redirect/JTI0bSUyRkFydGlzdERpc2NvZ3JhcGh5QWxidW1PYmplY3Q
...
| `albumGroup` | [`string(AlbumGroup)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/php/models/enumerations/album-group.md) | Required | This field describes the relationship between the artist and the album. | getAlbumGroup(): string | setAlbumGroup(string albumGroup): void |
