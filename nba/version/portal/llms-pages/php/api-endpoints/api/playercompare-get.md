...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlBsYXllcmNvbXBhcmVfR0VU

:information_source: **Note** This endpoint does not require authentication.

```php
function playercompareGet(
    string $playerIdList,
...
$api = $client->getAPI();
$apiResponse = $api->playercompareGet(
    $playerIdList,
    $vsPlayerIdList,
    $seasonType,
    $measureType,
