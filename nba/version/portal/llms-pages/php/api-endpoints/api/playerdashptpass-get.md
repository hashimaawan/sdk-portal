...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hwdHBhc3NfR0VU

:information_source: **Note** This endpoint does not require authentication.

```php
function playerdashptpassGet(
    string $perMode,
    string $season,
    string $seasonType,
    string $playerId,
...
$api = $client->getAPI();
$apiResponse = $api->playerdashptpassGet(
    $perMode,
    $season,
    $seasonType,
    $playerId,
