...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkltYWdlcyUyRmltYWdlc19nZXQ
...
|  --- | --- | --- | --- |
| `imageId` | [`ImagesGetImageId`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/oneof-anyof-definitions/images-get-image-id.md) | Template, Required | This is a container for any-of cases. |
...
```csharp
ImagesGetImageId imageId = ImagesGetImageId.FromNumber(62137902);

try
{
    ApiResponse<V2ImagesResponse2> result = await imagesApi.ImagesGetAsync(imageId);
}
