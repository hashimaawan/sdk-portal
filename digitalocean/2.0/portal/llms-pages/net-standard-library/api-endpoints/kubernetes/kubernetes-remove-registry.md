...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX3JlbW92ZV9yZWdpc3RyeQ

To remove the container registry from Kubernetes clusters, send a DELETE request to `/v2/kubernetes/registry`.

```csharp
KubernetesRemoveRegistryAsync(
...
try
{
    await kubernetesApi.KubernetesRemoveRegistryAsync(body);
}
