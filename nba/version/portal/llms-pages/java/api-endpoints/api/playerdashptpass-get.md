...
```java
CompletableFuture<Void> playerdashptpassGETAsync(
...
aPIController.playerdashptpassGETAsync(perMode, season, seasonType, playerID, teamID, outcome, location, month, seasonSegment, dateFrom, dateTo, opponentTeamID, vsConference, vsDivision, lastNGames).thenAccept(result -> {
