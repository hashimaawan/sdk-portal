...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRlVzZXJzJTJGZm9sbG93LXBsYXlsaXN0
...
FollowPlaylist(
    ctx context.Context,
    playlistId string,
    body *models.PlaylistsFollowersRequest) (
    http.Response,
    error)
```
...
| `body` | [`*models.PlaylistsFollowersRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/llms-pages/go/models/structures/playlists-followers-request.md) | Body, Optional | - |
...
resp, err := usersApi.FollowPlaylist(ctx, playlistId, &body)
if err != nil {
