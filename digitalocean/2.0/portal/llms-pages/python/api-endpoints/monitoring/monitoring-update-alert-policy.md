...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX3VwZGF0ZV9hbGVydFBvbGljeQ

To update en existing policy, send a PUT request to `v2/monitoring/alerts/{alert_uuid}`.

```python
def monitoring_update_alert_policy(self,
                                  alert_uuid,
                                  body)
```
...
result = monitoring_api.monitoring_update_alert_policy(
    alert_uuid,
    body
)
