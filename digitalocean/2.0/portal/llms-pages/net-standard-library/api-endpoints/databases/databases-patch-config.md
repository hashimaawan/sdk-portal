...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wYXRjaF9jb25maWc

To update the configuration for an existing database cluster, send a PATCH request to
`/v2/databases/$DATABASE_ID/config`.

```csharp
DatabasesPatchConfigAsync(
    Guid databaseClusterUuid,
    Models.V2DatabasesConfigRequest body)
```
...
| `body` | [`V2DatabasesConfigRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-databases-config-request.md) | Body, Required | - |
...
V2DatabasesConfigRequest body = new V2DatabasesConfigRequest
{
...
try
{
    await databasesApi.DatabasesPatchConfigAsync(
        databaseClusterUuid,
        body
    );
}
