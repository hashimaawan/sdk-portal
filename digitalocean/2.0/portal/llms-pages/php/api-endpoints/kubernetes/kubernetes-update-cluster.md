...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX3VwZGF0ZV9jbHVzdGVy
...
```php
function kubernetesUpdateCluster(string $clusterId, V2KubernetesClustersRequest $body): ApiResponse
```
...
| `body` | [`V2KubernetesClustersRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-kubernetes-clusters-request.md) | Body, Required | - |
...
$body = V2KubernetesClustersRequestBuilder::init(
    'prod-cluster-01'
)
    ->autoUpgrade(true)
    ->ha(true)
...
$apiResponse = $kubernetesApi->kubernetesUpdateCluster(
    $clusterId,
    $body
);
