...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlBsYXllciUyRmdldC1xdWV1ZQ
...
try
{
    ApiResponse<QueueObject> result = await playerApi.GetQueueAsync();
}
