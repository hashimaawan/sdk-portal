...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/python/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VyJTI1MjBBY3Rpb25zJTJGR2V0JTI1MjBhbGwlMjUyMEFjdGlvbnMlMjUyMGZvciUyNTIwYSUyNTIwTG9hZCUyNTIwQmFsYW5jZXI
...
```python
def get_all_actions_for_a_load_balancer(self,
                                       id,
                                       sort=None,
                                       status=None)
```
...
result = load_balancer_actions_controller.get_all_actions_for_a_load_balancer(id)
print(result)
```
