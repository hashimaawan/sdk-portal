...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRkNvZGU
...
```ts
import { Code } from 'digitalocean-apilib';

const code = Code.ExceededRevisionLimit;
```
