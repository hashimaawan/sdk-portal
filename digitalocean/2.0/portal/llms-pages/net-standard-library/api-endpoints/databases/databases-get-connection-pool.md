...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfY29ubmVjdGlvblBvb2w
...
```csharp
DatabasesGetConnectionPoolAsync(
...
try
{
    ApiResponse<V2DatabasesPoolsResponse1> result = await databasesApi.DatabasesGetConnectionPoolAsync(
        databaseClusterUuid,
        poolName
    );
}
