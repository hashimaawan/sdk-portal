...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfYWRkX2ZvcndhcmRpbmdSdWxlcw
...
```ruby
def load_balancers_add_forwarding_rules(lb_id,
                                        body)
```
...
| `body` | [`V2LoadBalancersForwardingRulesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-load-balancers-forwarding-rules-request.md) | Body, Required | - |
...
body = V2LoadBalancersForwardingRulesRequest.new(
  forwarding_rules: [
    ForwardingRule.new(
      entry_port: 443,
...
result = load_balancers_api.load_balancers_add_forwarding_rules(
  lb_id,
  body
)
