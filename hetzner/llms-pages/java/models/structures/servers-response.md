...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRlNlcnZlcnMlMjUyMFJlc3BvbnNl
...
| `Servers` | [`List<Server18>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/server-18.md) | Required | - | List<Server18> getServers() | setServers(List<Server18> servers) |
