...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9saXN0X3JlcG9zaXRvcmllc1Yy
...
RegistryListRepositoriesV2(
    ...
    page *int,
    pageToken *string) (
    models.ApiResponse[models.V2RegistryRepositoriesV2Response],
    error)
```
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type [models.V2RegistryRepositoriesV2Response](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-registry-repositories-v2-response.md).
...
apiResponse, err := containerRegistryApi.RegistryListRepositoriesV2(ctx, registryName, &perPage, &page, &pageToken)
if err != nil {
