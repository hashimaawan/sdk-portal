...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0aCUyRl9fYWRkaXRpb25hbF9kb2N1bWVudGF0aW9uJTJGQ29uZmlndXJhdGlvbiUyRlJldHJ5Q29uZmlndXJhdGlvbg
...
func main() {
    retryConfiguration := digitalOceanApi.CreateRetryConfiguration(
        digitalOceanApi.WithMaxRetryAttempts(0),
        digitalOceanApi.WithRetryOnTimeout(true),
        digitalOceanApi.WithRetryInterval(1),
        digitalOceanApi.WithMaximumRetryWaitTime(0),
        digitalOceanApi.WithBackoffFactor(2),
        digitalOceanApi.WithHttpStatusCodesToRetry([]int64{408, 413, 429, 500, 502, 503, 504, 521, 522, 524, 408, 413, 429, 500, 502, 503, 504, 521, 522, 524}),
        digitalOceanApi.WithHttpMethodsToRetry([]string{"GET", "PUT", "GET", "PUT"}),
    )
}
```
