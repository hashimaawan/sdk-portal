...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRkFzc2lnbiUyNTIwRHJvcGxldHMlMjUyMGJ5JTI1MjBJRA
...
|  --- | --- | --- | --- | --- | --- |
| `DropletIds` | `List<Integer>` | Required | An array containing the IDs of the Droplets assigned to the load balancer. | List<Integer> getDropletIds() | setDropletIds(List<Integer> dropletIds) |
...
AssignDropletsById assignDropletsById = new AssignDropletsById.Builder(
    Arrays.asList(
        3164444,
        3164445
    ),
