...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19yZXNldF9hdXRo
...
```java
CompletableFuture<ApiResponse<V2DatabasesUsersResponse1>> databasesResetAuthAsync(
    final UUID databaseClusterUuid,
    final String username,
    final V2DatabasesUsersResetAuthRequest body)
```
...
| `body` | [`V2DatabasesUsersResetAuthRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/v2-databases-users-reset-auth-request.md) | Body, Required | - |
...
V2DatabasesUsersResetAuthRequest body = new V2DatabasesUsersResetAuthRequest.Builder()
...
databasesApi.databasesResetAuthAsync(databaseClusterUuid, username, body).thenAccept(result -> {
