...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkJpbGxpbmclMkZpbnZvaWNlc19nZXRfc3VtbWFyeUJ5VVVJRA

To retrieve a summary for an invoice, send a GET request to `/v2/customers/my/invoices/$INVOICE_UUID/summary`.

```java
CompletableFuture<ApiResponse<V2CustomersMyInvoicesSummaryResponse>> invoicesGetSummaryByUuidAsync(
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/sdk-infrastructure/utilities/apiresponse.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`V2CustomersMyInvoicesSummaryResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/v2-customers-my-invoices-summary-response.md).
...
billingApi.invoicesGetSummaryByUuidAsync(invoiceUuid).thenAccept(result -> {
