...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRlRhZ3MlMkZ0YWdzX2Fzc2lnbl9yZXNvdXJjZXM
...
```java
CompletableFuture<ApiResponse<Void>> tagsAssignResourcesAsync(
    final String tagId,
...
tagsApi.tagsAssignResourcesAsync(tagId, body).thenAccept(result -> {
