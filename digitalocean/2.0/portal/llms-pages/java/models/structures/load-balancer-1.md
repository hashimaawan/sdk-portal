...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRkxvYWRCYWxhbmNlcjE
...
| `Tag` | `String` | Optional | The name of a Droplet tag corresponding to Droplets assigned to the load balancer. | String getTag() | setTag(String tag) |
...
LoadBalancer1 loadBalancer1 = new LoadBalancer1.Builder(
    Arrays.asList(
