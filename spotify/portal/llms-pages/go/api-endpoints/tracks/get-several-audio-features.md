...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRlRyYWNrcyUyRmdldC1zZXZlcmFsLWF1ZGlvLWZlYXR1cmVz
...
GetSeveralAudioFeatures(
    ctx context.Context,
    ids string) (
    models.ApiResponse[models.ManyAudioFeatures],
    error)
```
...
apiResponse, err := tracksApi.GetSeveralAudioFeatures(ctx, ids)
if err != nil {
