...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2NhbmNlbF9kZXBsb3ltZW50

Immediately cancel an in-progress deployment.

```csharp
AppsCancelDeploymentAsync(
    string appId,
    string deploymentId)
```
...
try
{
    ApiResponse<V2AppsDeploymentsResponse1> result = await appsApi.AppsCancelDeploymentAsync(
        appId,
        deploymentId
    );
}
