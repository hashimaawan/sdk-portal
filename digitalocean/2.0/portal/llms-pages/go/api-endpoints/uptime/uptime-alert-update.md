...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9hbGVydF91cGRhdGU
...
UptimeAlertUpdate(
    ...
    checkId uuid.UUID,
    alertId uuid.UUID,
    body models.V2UptimeChecksAlertsRequest) (
...
| `body` | [`models.V2UptimeChecksAlertsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-uptime-checks-alerts-request.md) | Body, Required | - |
...
apiResponse, err := uptimeApi.UptimeAlertUpdate(ctx, checkId, alertId, body)
if err != nil {
