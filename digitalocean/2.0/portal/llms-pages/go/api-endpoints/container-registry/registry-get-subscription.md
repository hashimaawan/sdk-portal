...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9nZXRfc3Vic2NyaXB0aW9u
...
RegistryGetSubscription(
    ctx context.Context) (
    models.ApiResponse[models.V2RegistrySubscriptionResponse],
    error)
```
...
apiResponse, err := containerRegistryApi.RegistryGetSubscription(ctx)
if err != nil {
