...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRlNlcnZlciUyNTIwVHlwZXMlMjUyMFJlc3BvbnNl
...
|  --- | --- | --- | --- | --- | --- |
| `ServerTypes` | [`List<ServerTypes7>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/server-types-7.md) | Required | - | List<ServerTypes7> getServerTypes() | setServerTypes(List<ServerTypes7> serverTypes) |
