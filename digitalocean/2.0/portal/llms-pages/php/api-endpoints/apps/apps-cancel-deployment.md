...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2NhbmNlbF9kZXBsb3ltZW50

Immediately cancel an in-progress deployment.

```php
function appsCancelDeployment(string $appId, string $deploymentId): ApiResponse
```
...
$apiResponse = $appsApi->appsCancelDeployment(
    $appId,
    $deploymentId
);
