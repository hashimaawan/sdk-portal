...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRkNh
...
|  --- | --- | --- | --- | --- | --- |
| `certificate` | `string` | Required, Read-only | base64 encoding of the certificate used to secure database connections | getCertificate(): string | setCertificate(string certificate): void |
