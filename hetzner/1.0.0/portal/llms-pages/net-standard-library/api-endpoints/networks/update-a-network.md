...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRk5ldHdvcmtzJTJGVXBkYXRlJTI1MjBhJTI1MjBOZXR3b3Jr
...
UpdateANetworkAsync(
    int id,
    Models.UpdateNetworkRequest body = null)
```
...
| `body` | [`UpdateNetworkRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/net-standard-library/models/structures/update-network-request.md) | Body, Optional | - |
...
```csharp
int id = 112;
UpdateNetworkRequest body = new UpdateNetworkRequest
{
    Name = "new-name",
};
...
try
{
    ApiResponse<NetworksResponse1> result = await networksApi.UpdateANetworkAsync(
        id,
        body
    );
}
