...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2NyZWF0ZV9yb2xsYmFjaw
...
```java
CompletableFuture<ApiResponse<V2AppsDeploymentsResponse1>> appsCreateRollbackAsync(
    final String appId,
...
appsApi.appsCreateRollbackAsync(appId, body).thenAccept(result -> {
