...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRlNTSCUyNTIwS2V5cyUyRnNzaEtleXNfZ2V0
...
```ts
async sshKeysGet(
  sshKeyIdentifier: SshKeysGetSshKeyIdentifier,
...
|  --- | --- | --- | --- |
| `sshKeyIdentifier` | [`SshKeysGetSshKeyIdentifier`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/oneof-anyof-definitions/ssh-keys-get-ssh-key-identifier.md) | Template, Required | This is a container for any-of cases. |
...
```ts
const sshKeyIdentifier: SshKeysGetSshKeyIdentifier = 512189;

try {
  const response = await sshKeysApi.sshKeysGet(sshKeyIdentifier);
