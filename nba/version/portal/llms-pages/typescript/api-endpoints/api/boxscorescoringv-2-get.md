...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkJveHNjb3Jlc2NvcmluZ3YyX0dFVA
...
try {
  const response = await api.boxscorescoringv2Get(
    gameId,
    startPeriod,
    endPeriod,
    startRange,
