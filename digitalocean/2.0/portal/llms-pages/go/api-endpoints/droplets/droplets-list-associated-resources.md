...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfbGlzdF9hc3NvY2lhdGVkUmVzb3VyY2Vz
...
DropletsListAssociatedResources(
    ctx context.Context,
    dropletId int) (
    models.ApiResponse[models.V2DropletsDestroyWithAssociatedResourcesResponse],
    error)
```
...
apiResponse, err := dropletsApi.DropletsListAssociatedResources(ctx, dropletId)
if err != nil {
