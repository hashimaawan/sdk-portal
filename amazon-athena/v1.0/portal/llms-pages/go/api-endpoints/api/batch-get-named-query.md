...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/#/go/x-redirect/JTI0ZSUyRiUyRkJhdGNoR2V0TmFtZWRRdWVyeQ
...
BatchGetNamedQuery(
    ...
    models.ApiResponse[models.BatchGetNamedQueryOutput],
    error)
```
