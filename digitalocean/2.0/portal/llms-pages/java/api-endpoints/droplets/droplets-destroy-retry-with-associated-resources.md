...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveV9yZXRyeVdpdGhBc3NvY2lhdGVkUmVzb3VyY2Vz
...
```java
CompletableFuture<ApiResponse<Void>> dropletsDestroyRetryWithAssociatedResourcesAsync(
    final int dropletId)
```
...
dropletsApi.dropletsDestroyRetryWithAssociatedResourcesAsync(dropletId).thenAccept(result -> {
