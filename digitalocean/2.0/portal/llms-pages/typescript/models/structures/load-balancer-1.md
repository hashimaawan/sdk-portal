...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRkxvYWRCYWxhbmNlcjE
...
| `tag` | `string \| undefined` | Optional | The name of a Droplet tag corresponding to Droplets assigned to the load balancer. |
...
const loadBalancer1: LoadBalancer1 = {
  forwardingRules: [
    {
      entryPort: 443,
