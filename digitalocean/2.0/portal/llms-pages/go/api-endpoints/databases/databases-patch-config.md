...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wYXRjaF9jb25maWc
...
DatabasesPatchConfig(
    ...
    body models.V2DatabasesConfigRequest) (
    http.Response,
    error)
```
...
| `body` | [`models.V2DatabasesConfigRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-databases-config-request.md) | Body, Required | - |
...
body := models.V2DatabasesConfigRequest{
    Config:                models.ToPointer(models.V2DatabasesConfigRequestConfigContainer.FromConfig(models.Config{
        SqlMode:                      models.ToPointer("ANSI,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION,NO_ZERO_DATE,NO_ZERO_IN_DATE,STRICT_ALL_TABLES"),
        SqlRequirePrimaryKey:         models.ToPointer(true),
    })),
}

resp, err := databasesApi.DatabasesPatchConfig(ctx, databaseClusterUuid, body)
if err != nil {
