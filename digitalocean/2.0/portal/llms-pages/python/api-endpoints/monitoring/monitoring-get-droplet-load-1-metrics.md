...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2dldF9kcm9wbGV0TG9hZDFNZXRyaWNz

To retrieve 1 minute load average metrics for a given droplet, send a GET request to `/v2/monitoring/metrics/droplet/load_1`.

```python
def monitoring_get_droplet_load_1_metrics(self,
                                         host_id,
                                         start,
                                         end)
```
...
result = monitoring_api.monitoring_get_droplet_load_1_metrics(
    host_id,
    start,
    end
)
