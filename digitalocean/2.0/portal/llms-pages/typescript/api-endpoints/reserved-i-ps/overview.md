...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRlJlc2VydmVkJTI1MjBJUHMlMkZPdmVydmlldw
...
The instance of the `ReservedIPsApi` class can be created using the API Client.

```
const reservedIPsApi = new ReservedIPsApi(client);
```
