...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JlbWlzY19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async boxscoremiscGET(
  gameID?: string,
  startPeriod?: string,
  endPeriod?: string,
  startRange?: string,
...
```ts
try {
  const response = await apiController.boxscoremiscGET();
