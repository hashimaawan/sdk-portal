...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRvbWFpbnMlMkZkb21haW5zX2dldA
...
try {
  const response = await domainsApi.domainsGet(domainName);
