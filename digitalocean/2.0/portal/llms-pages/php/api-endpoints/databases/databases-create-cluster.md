...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19jcmVhdGVfY2x1c3Rlcg
...
```php
function databasesCreateCluster(V2DatabasesRequest $body): ApiResponse
```
...
|  --- | --- | --- | --- |
| `body` | [`V2DatabasesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-databases-request.md) | Body, Required | - |
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/sdk-infrastructure/utilities/apiresponse.md) instance. The `getResult()` method on this instance returns the response data which is of type [`V2DatabasesResponse1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-databases-response-1.md).


# Example Usage

```php
$body = V2DatabasesRequestBuilder::init(
    Engine1::PG,
    'backend',
    2,
    'nyc3',
...
$apiResponse = $databasesApi->databasesCreateCluster($body);
