...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkxlYWd1ZWRhc2h0ZWFtc3RhdHNfR0VU

:information_source: **Note** This endpoint does not require authentication.

```ts
async leaguedashteamstatsGET(
  measureType: string,
  perMode: string,
  plusMinus: string,
  paceAdjust: string,
...
try {
  const response = await apiController.leaguedashteamstatsGET(
    measureType,
    perMode,
    plusMinus,
    paceAdjust,
