...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkt1YmVybmV0ZXMlMkZPdmVydmlldw
...
The instance of the `KubernetesApi` class can be accessed from the API Client.

```
kubernetesApi := client.KubernetesApi()
```
