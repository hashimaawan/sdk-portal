...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRlJlc2VydmVkSXBEcm9wbGV0
...
| Type | Factory Method |
|  --- | --- |
| [`interface{}`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/object.md) | models.ReservedIpDropletContainer.FromObject(interface{} object) |
| [`models.Droplet`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/droplet.md) | models.ReservedIpDropletContainer.FromDroplet(models.Droplet droplet) |
...
```go
value := models.ReservedIpDropletContainer.FromObject(interface{}("[key1, val1][key2, val2]"))
```
...
```go
value := models.ReservedIpDropletContainer.FromDroplet(models.Droplet{
    BackupIds:             []int{
        53893572,
    },
