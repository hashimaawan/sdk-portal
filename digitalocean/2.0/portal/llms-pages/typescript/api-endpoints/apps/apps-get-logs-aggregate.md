...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2dldF9sb2dzX2FnZ3JlZ2F0ZQ
...
try {
  const response = await appsApi.appsGetLogsAggregate(
    appId,
    deploymentId,
    type,
    follow,
