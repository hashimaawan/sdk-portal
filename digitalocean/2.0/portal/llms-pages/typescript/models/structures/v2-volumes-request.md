...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRlYyJTI1MjBWb2x1bWVzJTI1MjBSZXF1ZXN0
...
| `filesystemLabel` | `string \| undefined` | Optional | **Constraints**: *Maximum Length*: `16` |
...
```ts
import { Region2, V2VolumesRequest } from 'digitalocean-apilib';

const v2VolumesRequest: V2VolumesRequest = {
  name: 'example',
  sizeGigabytes: 10,
  region: Region2.Nyc3,
