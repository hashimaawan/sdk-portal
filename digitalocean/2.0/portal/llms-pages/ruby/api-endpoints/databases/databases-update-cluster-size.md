...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfY2x1c3RlclNpemU
...
```ruby
def databases_update_cluster_size(database_cluster_uuid,
                                  body)
```
...
| `body` | [`V2DatabasesResizeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-databases-resize-request.md) | Body, Required | - |
...
body = V2DatabasesResizeRequest.new(
  num_nodes: 3,
  size: 'db-s-4vcpu-8gb'
)

result = databases_api.databases_update_cluster_size(
