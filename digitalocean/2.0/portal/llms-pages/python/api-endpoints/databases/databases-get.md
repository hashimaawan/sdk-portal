...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXQ
...
| `database_name` | `str` | Template, Required | The name of the database. |
...
result = databases_api.databases_get(
    database_cluster_uuid,
    database_name
)
