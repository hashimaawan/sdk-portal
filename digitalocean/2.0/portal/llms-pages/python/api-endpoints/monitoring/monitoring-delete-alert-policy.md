...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2RlbGV0ZV9hbGVydFBvbGljeQ

To delete an alert policy, send a DELETE request to `/v2/monitoring/alerts/{alert_uuid}`

```python
def monitoring_delete_alert_policy(self,
                                  alert_uuid)
```
