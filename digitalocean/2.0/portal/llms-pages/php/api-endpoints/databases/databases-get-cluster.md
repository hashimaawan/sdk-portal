...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfY2x1c3Rlcg
...
```php
function databasesGetCluster(string $databaseClusterUuid): ApiResponse
```
...
$apiResponse = $databasesApi->databasesGetCluster($databaseClusterUuid);
