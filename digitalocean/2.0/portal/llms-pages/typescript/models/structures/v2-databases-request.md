...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRlYyJTI1MjBEYXRhYmFzZXMlMjUyMFJlcXVlc3Q
...
| `backupRestore` | [`BackupRestore \| undefined`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/backup-restore.md) | Optional | - |
...
```ts
import { Engine1, Status4, V2DatabasesRequest } from 'digitalocean-apilib';

const v2DatabasesRequest: V2DatabasesRequest = {
  engine: Engine1.Pg,
  name: 'backend',
  numNodes: 2,
  region: 'nyc3',
