...
| `type` | [`?string(Type24Enum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/type-24.md) | Optional | Destination Image type to convert to | getType(): ?string | setType(?string type): void |
