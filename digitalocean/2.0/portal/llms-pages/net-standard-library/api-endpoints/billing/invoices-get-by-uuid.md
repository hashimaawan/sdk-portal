...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkJpbGxpbmclMkZpbnZvaWNlc19nZXRfYnlVVUlE

To retrieve the invoice items for an invoice, send a GET request to `/v2/customers/my/invoices/$INVOICE_UUID`.

```csharp
InvoicesGetByUuidAsync(
    string invoiceUuid)
```
...
try
{
    ApiResponse<V2CustomersMyInvoicesResponse1> result = await billingApi.InvoicesGetByUuidAsync(invoiceUuid);
}
