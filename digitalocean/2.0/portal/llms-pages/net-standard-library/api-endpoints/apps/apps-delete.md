...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2RlbGV0ZQ
...
try
{
    ApiResponse<V2AppsResponse2> result = await appsApi.AppsDeleteAsync(id);
}
