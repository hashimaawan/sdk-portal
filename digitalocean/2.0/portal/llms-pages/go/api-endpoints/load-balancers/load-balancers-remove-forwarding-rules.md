...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfcmVtb3ZlX2ZvcndhcmRpbmdSdWxlcw
...
LoadBalancersRemoveForwardingRules(
    ctx context.Context,
    lbId string,
    body models.V2LoadBalancersForwardingRulesRequest) (
    http.Response,
    error)
```
...
| `body` | [`models.V2LoadBalancersForwardingRulesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-load-balancers-forwarding-rules-request.md) | Body, Required | - |
...
resp, err := loadBalancersApi.LoadBalancersRemoveForwardingRules(ctx, lbId, body)
if err != nil {
