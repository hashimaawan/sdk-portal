...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfbGlzdF9uZWlnaGJvcnM
...
DropletsListNeighbors(
    ctx context.Context,
    dropletId int) (
    models.ApiResponse[models.V2DropletsNeighborsResponse],
    error)
```
...
apiResponse, err := dropletsApi.DropletsListNeighbors(ctx, dropletId)
if err != nil {
