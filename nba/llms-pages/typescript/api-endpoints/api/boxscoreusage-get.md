...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/#/typescript/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JldXNhZ2VfR0VU
...
```ts
try {
  const response = await apiController.boxscoreusageGET();
