...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRkFsZXJ0czE
...
|  --- | --- | --- | --- |
| `Id` | `Guid?` | Optional, Read-only | A unique ID that can be used to identify and reference the alert. |
