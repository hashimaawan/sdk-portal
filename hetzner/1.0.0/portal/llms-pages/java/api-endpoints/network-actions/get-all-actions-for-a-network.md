...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0ZSUyRk5ldHdvcmslMjUyMEFjdGlvbnMlMkZHZXQlMjUyMGFsbCUyNTIwQWN0aW9ucyUyNTIwZm9yJTI1MjBhJTI1MjBOZXR3b3Jr
...
```java
CompletableFuture<ApiResponse<ActionsResponse>> getAllActionsForANetworkAsync(
    final int id,
...
networkActionsApi.getAllActionsForANetworkAsync(id, null, null).thenAccept(result -> {
