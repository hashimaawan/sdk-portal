...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfbGlzdA
...
DropletsList(
    ...
    tagName *string,
    name *string) (
    models.ApiResponse[models.V2DropletsResponse],
    error)
```
...
apiResponse, err := dropletsApi.DropletsList(ctx, &perPage, &page, &tagName, &name)
if err != nil {
