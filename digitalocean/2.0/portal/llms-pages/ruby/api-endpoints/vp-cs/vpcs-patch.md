...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRlZQQ3MlMkZ2cGNzX3BhdGNo

To update a subset of information about a VPC, send a PATCH request to
`/v2/vpcs/$VPC_ID`.

```ruby
def vpcs_patch(vpc_id,
               body)
```
...
| `body` | [`V2VpcsRequest1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-vpcs-request-1.md) | Body, Required | - |
...
body = V2VpcsRequest1.new(
  description: 'VPC for production environment',
  name: 'env.prod-vpc',
  default: true
)

result = vp_cs_api.vpcs_patch(
  vpc_id,
  body
)
