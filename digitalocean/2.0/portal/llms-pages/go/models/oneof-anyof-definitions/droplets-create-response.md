...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRkRyb3BsZXRzQ3JlYXRlUmVzcG9uc2U
...
| Type | Factory Method |
|  --- | --- |
| [`models.SingleDropletResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/single-droplet-response.md) | models.DropletsCreateResponseContainer.FromSingleDropletResponse(models.SingleDropletResponse singleDropletResponse) |
| [`models.MultipleDropletResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/multiple-droplet-response.md) | models.DropletsCreateResponseContainer.FromMultipleDropletResponse(models.MultipleDropletResponse multipleDropletResponse) |


# models.SingleDropletResponse
...
```go
value := models.DropletsCreateResponseContainer.FromSingleDropletResponse(models.SingleDropletResponse{
...
# models.MultipleDropletResponse
...
```go
value := models.DropletsCreateResponseContainer.FromMultipleDropletResponse(models.MultipleDropletResponse{
