...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/typescript/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VyJTI1MjBBY3Rpb25zJTJGQWRkJTI1MjBTZXJ2aWNl
...
| `body` | [`LoadBalancerService \| undefined`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/typescript/models/structures/load-balancer-service.md) | Body, Optional | - |
...
try {
  const response = await loadBalancerActionsController.addService(
    id,
    body
  );
