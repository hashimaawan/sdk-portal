...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/typescript/x-redirect/JTI0bSUyRlF1ZXVlT2JqZWN0Q3VycmVudGx5UGxheWluZw
...
```ts
const value: QueueObjectCurrentlyPlaying = {
};
```
