...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRk5vZGVQb29s
...
|  --- | --- | --- | --- | --- | --- |
| `size` | `string` | Required | The slug identifier for the type of Droplet used as workers in the node pool. | getSize(): string | setSize(string size): void |
...
| `count` | `int` | Required | The number of Droplet instances in the node pool. | getCount(): int | setCount(int count): void |
...
| `name` | `string` | Required | A human-readable name for the node pool. | getName(): string | setName(string name): void |
