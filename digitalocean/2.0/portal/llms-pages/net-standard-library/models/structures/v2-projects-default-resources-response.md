...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRlYyJTI1MjBQcm9qZWN0cyUyNTIwRGVmYXVsdCUyNTIwUmVzb3VyY2VzJTI1MjBSZXNwb25zZQ
...
V2ProjectsDefaultResourcesResponse v2ProjectsDefaultResourcesResponse = new V2ProjectsDefaultResourcesResponse
{
    Meta = new Meta
    {
        Total = 2,
    ...
    Links = new Links
    {
        Pages = LinksPages.FromPages(
            new Pages
            {
                ...
                Next = "next2",
                ["first"] = ApiHelper.JsonDeserialize<object>("\"https://api.digitalocean.com/v2/projects/4e1bfbc3-dc3e-41f2-a18f-1b4d7ba71679/resources?page=1\""),
            }
        ),
        ["exampleAdditionalProperty"] = ApiHelper.JsonDeserialize<object>("{\"key1\":\"val1\",\"key2\":\"val2\"}"),
    },
