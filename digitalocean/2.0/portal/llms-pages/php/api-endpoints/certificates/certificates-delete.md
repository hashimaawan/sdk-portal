...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkNlcnRpZmljYXRlcyUyRmNlcnRpZmljYXRlc19kZWxldGU

To delete a specific certificate, send a DELETE request to
`/v2/certificates/$CERTIFICATE_ID`.

```php
function certificatesDelete(string $certificateId): ApiResponse
```
...
$apiResponse = $certificatesApi->certificatesDelete($certificateId);
