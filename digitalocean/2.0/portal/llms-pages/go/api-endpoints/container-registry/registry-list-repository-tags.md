...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9saXN0X3JlcG9zaXRvcnlUYWdz
...
RegistryListRepositoryTags(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2RegistryTagsResponse],
    error)
```
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type [models.V2RegistryTagsResponse](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-registry-tags-response.md).
...
apiResponse, err := containerRegistryApi.RegistryListRepositoryTags(ctx, registryName, repositoryName, &perPage, &page)
if err != nil {
