...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/typescript/x-redirect/JTI0ZSUyRk5ldHdvcmslMjUyMEFjdGlvbnMlMkZEZWxldGUlMjUyMGElMjUyMHN1Ym5ldCUyNTIwZnJvbSUyNTIwYSUyNTIwTmV0d29yaw
...
```ts
async deleteASubnetFromANetwork(
  id: number,
...
| `body` | [`DeleteSubnetRequest \| undefined`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/typescript/models/structures/delete-subnet-request.md) | Body, Optional | - |
...
const body: DeleteSubnetRequest = {
  ipRange: '10.0.1.0/24',
};
