...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNoYm9hcmRieXRlYW1wZXJmb3JtYW5jZV9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async teamdashboardbyteamperformanceGET(
  teamID: string,
  measureType: string,
  perMode: string,
  plusMinus: string,
...
try {
  const response = await apiController.teamdashboardbyteamperformanceGET(
    teamID,
    measureType,
    perMode,
    plusMinus,
