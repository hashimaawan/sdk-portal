...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2xpc3RfZGVwbG95bWVudHM
...
AppsListDeployments(
    ...
    page *int,
    perPage *int) (
    models.ApiResponse[models.V2AppsDeploymentsResponse],
    error)
```
...
apiResponse, err := appsApi.AppsListDeployments(ctx, appId, &page, &perPage)
if err != nil {
