...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX3VwZGF0ZV9jbHVzdGVy
...
```java
CompletableFuture<ApiResponse<V2KubernetesClustersResponse1>> kubernetesUpdateClusterAsync(
    final UUID clusterId,
    final V2KubernetesClustersRequest body)
```
...
| `body` | [`V2KubernetesClustersRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/v2-kubernetes-clusters-request.md) | Body, Required | - |
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/sdk-infrastructure/utilities/apiresponse.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`V2KubernetesClustersResponse1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/v2-kubernetes-clusters-response-1.md).
...
V2KubernetesClustersRequest body = new V2KubernetesClustersRequest.Builder(
    "prod-cluster-01"
)
.autoUpgrade(true)
.ha(true)
...
kubernetesApi.kubernetesUpdateClusterAsync(clusterId, body).thenAccept(result -> {
