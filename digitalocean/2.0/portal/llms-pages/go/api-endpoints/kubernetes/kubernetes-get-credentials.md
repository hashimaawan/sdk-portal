...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2dldF9jcmVkZW50aWFscw
...
KubernetesGetCredentials(
    ...
    clusterId uuid.UUID,
    expirySeconds *int) (
    models.ApiResponse[models.V2KubernetesClustersCredentialsResponse],
    error)
```
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type [models.V2KubernetesClustersCredentialsResponse](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-kubernetes-clusters-credentials-response.md).
...
apiResponse, err := kubernetesApi.KubernetesGetCredentials(ctx, clusterId, &expirySeconds)
if err != nil {
