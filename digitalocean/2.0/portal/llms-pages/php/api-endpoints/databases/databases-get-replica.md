...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfcmVwbGljYQ
...
```php
function databasesGetReplica(string $databaseClusterUuid, string $replicaName): ApiResponse
```
...
$apiResponse = $databasesApi->databasesGetReplica(
    $databaseClusterUuid,
    $replicaName
);
