...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wYXRjaF9jb25maWc

To update the configuration for an existing database cluster, send a PATCH request to
`/v2/databases/$DATABASE_ID/config`.

```ruby
def databases_patch_config(database_cluster_uuid,
                           body)
```
...
| `body` | [`V2DatabasesConfigRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-databases-config-request.md) | Body, Required | - |
...
body = V2DatabasesConfigRequest.new(
  config: Config.new(
