...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wYXRjaF9jb25maWc

To update the configuration for an existing database cluster, send a PATCH request to
`/v2/databases/$DATABASE_ID/config`.

```php
function databasesPatchConfig(string $databaseClusterUuid, V2DatabasesConfigRequest $body): ApiResponse
```
...
| `body` | [`V2DatabasesConfigRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-databases-config-request.md) | Body, Required | - |
...
$body = V2DatabasesConfigRequestBuilder::init()
    ->config(
        ConfigBuilder::init()
...
$apiResponse = $databasesApi->databasesPatchConfig(
    $databaseClusterUuid,
    $body
);
