...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/java/x-redirect/JTI0ZSUyRiUyRkJveHNjb3Jlc2NvcmluZ3YyX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```java
CompletableFuture<ApiResponse<Void>> boxscorescoringv2GetAsync(
    final String gameId,
...
api.boxscorescoringv2GetAsync(gameId, startPeriod, endPeriod, startRange, endRange, rangeType).thenAccept(result -> {
