...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRkxvYWRCYWxhbmNlcjE
...
| `tag` | `?string` | Optional | The name of a Droplet tag corresponding to Droplets assigned to the load balancer. | getTag(): ?string | setTag(?string tag): void |
...
$loadBalancer1 = LoadBalancer1Builder::init(
    [
