...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRlYyJTI1MjBLdWJlcm5ldGVzJTI1MjBDbHVzdGVycyUyNTIwTm9kZSUyNTIwUG9vbHMlMjUyMFJlcXVlc3Q
...
| `Count` | `Integer` | Optional | The number of Droplet instances in the node pool. | Integer getCount() | setCount(Integer count) |
...
| `Name` | `String` | Optional | A human-readable name for the node pool. | String getName() | setName(String name) |
...
import com.digitalocean.api.models.V2KubernetesClustersNodePoolsRequest;
import java.io.IOException;
import java.util.Arrays;
import java.util.UUID;

V2KubernetesClustersNodePoolsRequest v2KubernetesClustersNodePoolsRequest = new V2KubernetesClustersNodePoolsRequest.Builder()
    .autoScale(true)
    .count(3)
