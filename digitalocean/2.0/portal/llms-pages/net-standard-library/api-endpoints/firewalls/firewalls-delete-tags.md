...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19kZWxldGVfdGFncw
...
try
{
    await firewallsApi.FirewallsDeleteTagsAsync(
        firewallId,
        body
    );
}
