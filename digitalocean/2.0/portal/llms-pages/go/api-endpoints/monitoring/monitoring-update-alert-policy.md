...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX3VwZGF0ZV9hbGVydFBvbGljeQ
...
MonitoringUpdateAlertPolicy(
    ctx context.Context,
    alertUuid string,
    body models.V2MonitoringAlertsRequest) (
...
apiResponse, err := monitoringApi.MonitoringUpdateAlertPolicy(ctx, alertUuid, body)
if err != nil {
