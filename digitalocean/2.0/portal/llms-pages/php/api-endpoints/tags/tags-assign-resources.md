...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlRhZ3MlMkZ0YWdzX2Fzc2lnbl9yZXNvdXJjZXM
...
```php
function tagsAssignResources(string $tagId, V2TagsResourcesRequest $body): ApiResponse
```
...
$apiResponse = $tagsApi->tagsAssignResources(
    $tagId,
    $body
);
