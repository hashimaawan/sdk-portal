...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/net-standard-library/x-redirect/JTI0ZSUyRkZpcmV3YWxsJTI1MjBBY3Rpb25zJTJGQXBwbHklMjUyMHRvJTI1MjBSZXNvdXJjZXM
...
| `body` | [`ApplyToResourcesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/net-standard-library/models/structures/apply-to-resources-request.md) | Body, Optional | - |
...
try
{
    ActionsResponse result = await firewallActionsController.ApplyToResourcesAsync(
        id,
        body
    );
}
