...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRlRhZ3MlMkZ0YWdzX2dldA

To retrieve an individual tag, you can send a `GET` request to `/v2/tags/$TAG_NAME`.

```java
CompletableFuture<ApiResponse<V2TagsResponse1>> tagsGetAsync(
    final String tagId)
```
...
tagsApi.tagsGetAsync(tagId).thenAccept(result -> {
