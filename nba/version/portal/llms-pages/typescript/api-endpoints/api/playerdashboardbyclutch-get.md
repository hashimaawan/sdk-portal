...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hib2FyZGJ5Y2x1dGNoX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```ts
async playerdashboardbyclutchGET(
  measureType: string,
  perMode: string,
  plusMinus: string,
  paceAdjust: string,
...
try {
  const response = await apiController.playerdashboardbyclutchGET(
    measureType,
    perMode,
    plusMinus,
    paceAdjust,
