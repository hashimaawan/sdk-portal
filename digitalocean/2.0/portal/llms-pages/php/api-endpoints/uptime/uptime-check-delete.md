...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9jaGVja19kZWxldGU
...
```php
function uptimeCheckDelete(string $checkId): ApiResponse
```
...
$apiResponse = $uptimeApi->uptimeCheckDelete($checkId);
