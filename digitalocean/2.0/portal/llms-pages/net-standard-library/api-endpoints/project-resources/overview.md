...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRlByb2plY3QlMjUyMFJlc291cmNlcyUyRk92ZXJ2aWV3
...
An instance of the `ProjectResourcesApi` class can be accessed from the API Client.

```
ProjectResourcesApi projectResourcesApi = client.ProjectResourcesApi;
```
