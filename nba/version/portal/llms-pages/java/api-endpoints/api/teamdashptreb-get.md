...
```java
CompletableFuture<Void> teamdashptrebGETAsync(
...
aPIController.teamdashptrebGETAsync(perMode, season, seasonType, teamID, outcome, location, month, seasonSegment, dateFrom, dateTo, opponentTeamID, vsConference, vsDivision, gameSegment, period, lastNGames).thenAccept(result -> {
