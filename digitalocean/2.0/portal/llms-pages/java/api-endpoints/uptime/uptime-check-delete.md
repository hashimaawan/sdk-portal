...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9jaGVja19kZWxldGU
...
```java
CompletableFuture<ApiResponse<Void>> uptimeCheckDeleteAsync(
    final UUID checkId)
```
...
uptimeApi.uptimeCheckDeleteAsync(checkId).thenAccept(result -> {
