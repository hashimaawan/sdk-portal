...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkNlcnRpZmljYXRlcyUyRmNlcnRpZmljYXRlc19nZXQ

To show information about an existing certificate, send a GET request to `/v2/certificates/$CERTIFICATE_ID`.

```ruby
def certificates_get(certificate_id)
```
...
result = certificates_api.certificates_get(certificate_id)
