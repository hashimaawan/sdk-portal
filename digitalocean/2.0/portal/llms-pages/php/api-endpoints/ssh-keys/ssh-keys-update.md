...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlNTSCUyNTIwS2V5cyUyRnNzaEtleXNfdXBkYXRl
...
```php
function sshKeysUpdate($sshKeyIdentifier, V2AccountKeysRequest $body): ApiResponse
```
...
| `body` | [`V2AccountKeysRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-account-keys-request.md) | Body, Required | Set the `name` attribute to the new name you want to use. |
...
$body = V2AccountKeysRequestBuilder::init()
    ->name('My SSH Public Key')
    ->build();

$sshKeysApi = $client->getSshKeysApi();
$apiResponse = $sshKeysApi->sshKeysUpdate(
    $sshKeyIdentifier,
    $body
);
