...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfc3FsX21vZGU
...
```java
CompletableFuture<ApiResponse<Void>> databasesUpdateSqlModeAsync(
    final UUID databaseClusterUuid,
    final V2DatabasesSqlModeResponse body)
```
...
| `body` | [`V2DatabasesSqlModeResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/v2-databases-sql-mode-response.md) | Body, Required | - |
...
V2DatabasesSqlModeResponse body = new V2DatabasesSqlModeResponse.Builder(
    "ANSI,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION,NO_ZERO_DATE,NO_ZERO_IN_DATE"
)
.build();

databasesApi.databasesUpdateSqlModeAsync(databaseClusterUuid, body).thenAccept(result -> {
