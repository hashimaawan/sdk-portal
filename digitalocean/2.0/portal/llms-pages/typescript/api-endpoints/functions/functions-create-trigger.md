...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkZ1bmN0aW9ucyUyRmZ1bmN0aW9uc19jcmVhdGVfdHJpZ2dlcg
...
| `body` | [`V2FunctionsNamespacesTriggersRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-functions-namespaces-triggers-request.md) | Body, Required | - |
...
const body: V2FunctionsNamespacesTriggersRequest = {
  mFunction: 'hello',
  isEnabled: true,
  name: 'my trigger',
  scheduledDetails: {
...
try {
  const response = await functionsApi.functionsCreateTrigger(
    namespaceId,
    body
  );
