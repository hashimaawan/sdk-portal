...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlByb2plY3QlMjUyMFJlc291cmNlcyUyRnByb2plY3RzX2Fzc2lnbl9yZXNvdXJjZXNfZGVmYXVsdA

To assign resources to your default project, send a POST request to `/v2/projects/default/resources`.

```csharp
ProjectsAssignResourcesDefaultAsync(
...
try
{
    ApiResponse<V2ProjectsDefaultResourcesResponse1> result = await projectResourcesApi.ProjectsAssignResourcesDefaultAsync(body);
}
