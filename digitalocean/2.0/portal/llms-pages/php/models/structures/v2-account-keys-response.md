...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBBY2NvdW50JTI1MjBLZXlzJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- | --- | --- |
| `sshKeys` | [`?(SshKey[])`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/ssh-key.md) | Optional | - | getSshKeys(): ?array | setSshKeys(?array sshKeys): void |
...
```php
use DigitalOceanApiLib\Models\Builders\V2AccountKeysResponseBuilder;
...
$v2AccountKeysResponse = V2AccountKeysResponseBuilder::init(
    MetaBuilder::init(
        1
    )
