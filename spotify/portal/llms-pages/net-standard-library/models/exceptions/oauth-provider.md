...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/net-standard-library/x-redirect/JTI0bSUyRk9BdXRoUHJvdmlkZXI
...
|  --- | --- | --- | --- |
| `Error` | [`OauthProviderError`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/net-standard-library/models/enumerations/oauth-provider-error.md) | Required | Gets or sets error code. |
