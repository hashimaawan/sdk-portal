...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2xpc3RfaW5zdGFuY2VTaXplcw
...
AppsListInstanceSizes(
    ctx context.Context) (
    models.ApiResponse[models.V2AppsTiersInstanceSizesResponse],
    error)
```
...
apiResponse, err := appsApi.AppsListInstanceSizes(ctx)
if err != nil {
