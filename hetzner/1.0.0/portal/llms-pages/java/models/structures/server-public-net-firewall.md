...
| `Status` | [`Status72Enum`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/java/models/enumerations/status-72.md) | Optional | Status of the Firewall on the Server | Status72Enum getStatus() | setStatus(Status72Enum status) |
