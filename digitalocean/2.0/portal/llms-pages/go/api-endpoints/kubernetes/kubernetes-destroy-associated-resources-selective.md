...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2Rlc3Ryb3lfYXNzb2NpYXRlZFJlc291cmNlc1NlbGVjdGl2ZQ
...
KubernetesDestroyAssociatedResourcesSelective(
    ctx context.Context,
    clusterId uuid.UUID,
    body models.V2KubernetesClustersDestroyWithAssociatedResourcesSelectiveRequest) (
    http.Response,
    error)
```
...
| `body` | [`models.V2KubernetesClustersDestroyWithAssociatedResourcesSelectiveRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-kubernetes-clusters-destroy-with-associated-resources-selective-request.md) | Body, Required | - |
...
resp, err := kubernetesApi.KubernetesDestroyAssociatedResourcesSelective(ctx, clusterId, body)
if err != nil {
