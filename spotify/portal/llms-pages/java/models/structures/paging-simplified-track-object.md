...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/java/x-redirect/JTI0bSUyRlBhZ2luZ1NpbXBsaWZpZWRUcmFja09iamVjdA
...
| `Items` | [`List<SimplifiedTrackObject>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/java/models/structures/simplified-track-object.md) | Required | - | List<SimplifiedTrackObject> getItems() | setItems(List<SimplifiedTrackObject> items) |
