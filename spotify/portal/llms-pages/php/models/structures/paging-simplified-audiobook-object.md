...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/php/x-redirect/JTI0bSUyRlBhZ2luZ1NpbXBsaWZpZWRBdWRpb2Jvb2tPYmplY3Q
...
| `items` | [`AudiobookBase[]`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/llms-pages/php/models/structures/audiobook-base.md) | Required | - | getItems(): array | setItems(array items): void |
...
```php
use SpotifyWebApiWithFixesAndImprovementsFromSonalluxLib\Models\Builders\PagingSimplifiedAudiobookObjectBuilder;
...
$pagingSimplifiedAudiobookObject = PagingSimplifiedAudiobookObjectBuilder::init(
