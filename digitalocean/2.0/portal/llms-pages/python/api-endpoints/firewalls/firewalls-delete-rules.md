...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19kZWxldGVfcnVsZXM
...
```python
def firewalls_delete_rules(self,
                          firewall_id,
                          body=None)
```
...
| `body` | [`V2FirewallsRulesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/v2-firewalls-rules-request.md) | Body, Optional | - |
