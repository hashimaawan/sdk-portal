...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfY3JlYXRl
...
```csharp
LoadBalancersCreateAsync(
    LoadBalancersCreateBody body)
```
...
|  --- | --- | --- | --- |
| `body` | [`LoadBalancersCreateBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/oneof-anyof-definitions/load-balancers-create-body.md) | Body, Required | This is a container for one-of cases. |
...
try
{
    ApiResponse<V2LoadBalancersResponse1> result = await loadBalancersApi.LoadBalancersCreateAsync(body);
}
