...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hwdHNob3RzX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```ts
async playerdashptshotsGET(
  perMode: string,
  season: string,
  seasonType: string,
  playerID: string,
...
try {
  const response = await apiController.playerdashptshotsGET(
    perMode,
    season,
    seasonType,
    playerID,
