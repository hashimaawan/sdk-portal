...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/ruby/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VyJTI1MjBBY3Rpb25zJTJGRGlzYWJsZSUyNTIwdGhlJTI1MjBwdWJsaWMlMjUyMGludGVyZmFjZSUyNTIwb2YlMjUyMGElMjUyMExvYWQlMjUyMEJhbGFuY2Vy
...
```ruby
def disable_the_public_interface_of_a_load_balancer(id)
```
...
result = load_balancer_actions_controller.disable_the_public_interface_of_a_load_balancer(id)
puts result
```
