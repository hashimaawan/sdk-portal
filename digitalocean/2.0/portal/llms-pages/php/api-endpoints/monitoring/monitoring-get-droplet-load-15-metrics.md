...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2dldF9kcm9wbGV0TG9hZDE1TWV0cmljcw
...
```php
function monitoringGetDropletLoad15Metrics(string $hostId, string $start, string $end): ApiResponse
```
...
$apiResponse = $monitoringApi->monitoringGetDropletLoad15Metrics(
    $hostId,
    $start,
    $end
);
