...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfYWRkX2ZvcndhcmRpbmdSdWxlcw
...
```csharp
LoadBalancersAddForwardingRulesAsync(
    string lbId,
...
try
{
    await loadBalancersApi.LoadBalancersAddForwardingRulesAsync(
        lbId,
        body
    );
}
