...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkZ1bmN0aW9ucyUyRmZ1bmN0aW9uc191cGRhdGVfdHJpZ2dlcg
...
| `body` | [`V2FunctionsNamespacesTriggersRequest1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-functions-namespaces-triggers-request-1.md) | Body, Required | - |
...
const body: V2FunctionsNamespacesTriggersRequest1 = {
  isEnabled: true,
};

try {
  const response = await functionsApi.functionsUpdateTrigger(
    namespaceId,
    triggerName,
    body
  );
