...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlRhZ3MlMkZ0YWdzX2RlbGV0ZQ
...
```php
function tagsDelete(string $tagId): ApiResponse
```
...
$apiResponse = $tagsApi->tagsDelete($tagId);
