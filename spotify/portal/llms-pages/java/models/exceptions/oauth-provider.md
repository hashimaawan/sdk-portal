...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/java/x-redirect/JTI0bSUyRk9BdXRoUHJvdmlkZXI
...
|  --- | --- | --- | --- | --- | --- |
| `Error` | [`OauthProviderError`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/java/models/enumerations/oauth-provider-error.md) | Required | Gets or sets error code. | OauthProviderError getError() | setError(OauthProviderError error) |
