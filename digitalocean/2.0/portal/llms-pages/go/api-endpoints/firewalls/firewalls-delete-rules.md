...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19kZWxldGVfcnVsZXM
...
FirewallsDeleteRules(
    ...
    body *models.V2FirewallsRulesRequest) (
    http.Response,
    error)
```
...
| `body` | [`*models.V2FirewallsRulesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-firewalls-rules-request.md) | Body, Optional | - |
...
resp, err := firewallsApi.FirewallsDeleteRules(ctx, firewallId, &body)
if err != nil {
