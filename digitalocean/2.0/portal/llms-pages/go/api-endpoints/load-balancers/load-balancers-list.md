...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfbGlzdA
...
LoadBalancersList(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2LoadBalancersResponse],
    error)
```
...
apiResponse, err := loadBalancersApi.LoadBalancersList(ctx, &perPage, &page)
if err != nil {
