...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9saXN0X3JlcG9zaXRvcmllcw
...
RegistryListRepositories(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2RegistryRepositoriesResponse],
    error)
```
...
apiResponse, err := containerRegistryApi.RegistryListRepositories(ctx, registryName, &perPage, &page)
if err != nil {
