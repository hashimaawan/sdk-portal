...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/go/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JldXNhZ2V2Ml9HRVQ
...
resp, err := aPIController.Boxscoreusagev2GET(ctx, gameID, startPeriod, endPeriod, startRange, endRange, rangeType)
if err != nil {
    log.Fatalln(err)
} else {
