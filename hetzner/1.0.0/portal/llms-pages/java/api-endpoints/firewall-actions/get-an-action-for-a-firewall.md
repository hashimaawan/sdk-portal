...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0ZSUyRkZpcmV3YWxsJTI1MjBBY3Rpb25zJTJGR2V0JTI1MjBhbiUyNTIwQWN0aW9uJTI1MjBmb3IlMjUyMGElMjUyMEZpcmV3YWxs
...
```java
CompletableFuture<ApiResponse<ActionResponse>> getAnActionForAFirewallAsync(
    final int id,
    final int actionId)
```
...
firewallActionsApi.getAnActionForAFirewallAsync(id, actionId).thenAccept(result -> {
