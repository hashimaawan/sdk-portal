...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9jaGVja19jcmVhdGU

To create an Uptime check, send a POST request to `/v2/uptime/checks` specifying the attributes
in the table below in the JSON body.

```csharp
UptimeCheckCreateAsync(
...
try
{
    ApiResponse<V2UptimeChecksResponse1> result = await uptimeApi.UptimeCheckCreateAsync(body);
}
