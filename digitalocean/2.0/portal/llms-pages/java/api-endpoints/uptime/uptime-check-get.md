...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9jaGVja19nZXQ

To show information about an existing check, send a GET request to `/v2/uptime/checks/$CHECK_ID`.

```java
CompletableFuture<ApiResponse<V2UptimeChecksResponse1>> uptimeCheckGetAsync(
    final UUID checkId)
```
...
uptimeApi.uptimeCheckGetAsync(checkId).thenAccept(result -> {
