...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlByb2plY3RzJTJGcHJvamVjdHNfZ2V0

To get a project, send a GET request to `/v2/projects/$PROJECT_ID`.

```php
function projectsGet(string $projectId): ApiResponse
```
...
$apiResponse = $projectsApi->projectsGet($projectId);
