...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfc3FsX21vZGU
...
```ts
async databasesUpdateSqlMode(
  databaseClusterUuid: string,
  body: V2DatabasesSqlModeResponse,
...
| `body` | [`V2DatabasesSqlModeResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-databases-sql-mode-response.md) | Body, Required | - |
...
const body: V2DatabasesSqlModeResponse = {
  sqlMode: 'ANSI,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION,NO_ZERO_DATE,NO_ZERO_IN_DATE',
};

try {
  const response = await databasesApi.databasesUpdateSqlMode(
    databaseClusterUuid,
    body
  );
