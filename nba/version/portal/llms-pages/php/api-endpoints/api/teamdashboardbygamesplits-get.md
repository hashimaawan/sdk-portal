...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNoYm9hcmRieWdhbWVzcGxpdHNfR0VU

:information_source: **Note** This endpoint does not require authentication.

```php
function teamdashboardbygamesplitsGet(
    string $teamId,
    string $measureType,
    string $perMode,
    string $plusMinus,
...
$api = $client->getAPI();
$apiResponse = $api->teamdashboardbygamesplitsGet(
    $teamId,
    $measureType,
    $perMode,
    $plusMinus,
