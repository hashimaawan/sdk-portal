...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRlYyJTI1MjBDZXJ0aWZpY2F0ZXMlMjUyMFJlc3BvbnNl
...
|  --- | --- | --- | --- |
| `Certificates` | [`List<Certificate>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/certificate.md) | Optional | - |
...
V2CertificatesResponse v2CertificatesResponse = new V2CertificatesResponse
{
    Meta = new Meta
    {
        Total = 1,
    ...
    Certificates = new List<Certificate>
    {
        new Certificate
        {
            ...
            Id = new Guid("000019c8-0000-0000-0000-000000000000"),
            Name = "name0",
