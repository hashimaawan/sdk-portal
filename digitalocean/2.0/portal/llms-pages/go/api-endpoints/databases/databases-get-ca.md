...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfY2E
...
DatabasesGetCa(
    ...
    models.ApiResponse[models.V2DatabasesCaResponse],
    error)
```
...
apiResponse, err := databasesApi.DatabasesGetCa(ctx, databaseClusterUuid)
if err != nil {
