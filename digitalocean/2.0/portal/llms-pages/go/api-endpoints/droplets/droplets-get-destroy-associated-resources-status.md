...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZ2V0X0Rlc3Ryb3lBc3NvY2lhdGVkUmVzb3VyY2VzU3RhdHVz
...
DropletsGetDestroyAssociatedResourcesStatus(
    ctx context.Context,
    dropletId int) (
    models.ApiResponse[models.V2DropletsDestroyWithAssociatedResourcesStatusResponse],
    error)
```
...
apiResponse, err := dropletsApi.DropletsGetDestroyAssociatedResourcesStatus(ctx, dropletId)
if err != nil {
