...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkltYWdlJTI1MjBBY3Rpb25zJTJGaW1hZ2VBY3Rpb25zX2dldA

To retrieve the status of an image action, send a GET request to `/v2/images/$IMAGE_ID/actions/$IMAGE_ACTION_ID`.

```csharp
ImageActionsGetAsync(
    int imageId,
    int actionId)
```
...
try
{
    ApiResponse<Action> result = await imageActionsApi.ImageActionsGetAsync(
        imageId,
        actionId
    );
}
