...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlByb2plY3RzJTJGcHJvamVjdHNfcGF0Y2g
...
try
{
    ApiResponse<V2ProjectsResponse1> result = await projectsApi.ProjectsPatchAsync(
        projectId,
        body
    );
}
