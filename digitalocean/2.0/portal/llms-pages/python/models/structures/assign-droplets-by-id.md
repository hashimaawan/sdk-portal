...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRkFzc2lnbiUyNTIwRHJvcGxldHMlMjUyMGJ5JTI1MjBJRA
...
|  --- | --- | --- | --- |
| `droplet_ids` | `List[int]` | Required | An array containing the IDs of the Droplets assigned to the load balancer. |
...
from digitaloceanapi.models.assign_droplets_by_id import AssignDropletsById
...
assign_droplets_by_id = AssignDropletsById(
    droplet_ids=[
        3164444,
        3164445
    ],
