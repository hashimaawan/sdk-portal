...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRlYyJTI1MjBVcHRpbWUlMjUyMENoZWNrcyUyNTIwUmVxdWVzdA
...
```ts
import { Region8, Type19, V2UptimeChecksRequest } from 'digitalocean-apilib';

const v2UptimeChecksRequest: V2UptimeChecksRequest = {
  enabled: true,
