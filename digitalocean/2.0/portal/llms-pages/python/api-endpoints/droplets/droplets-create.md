...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfY3JlYXRl
...
|  --- | --- | --- | --- |
| `body` | [Single Droplet Request](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/single-droplet-request.md) \| [Multiple Droplet Request](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/multiple-droplet-request.md) \| None | Body, Optional | This is a container for one-of cases. |
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/sdk-infrastructure/utilities/apiresponse.md) instance. The `body` property of this instance returns the response data which is of type `SingleDropletResponse | MultipleDropletResponse`.


# Example Usage

```python
body = MultipleDropletRequest(
    names=[
        'sub-01.example.com',
        'sub-02.example.com'
    ],
...
result = droplets_api.droplets_create(
    body=body
)
