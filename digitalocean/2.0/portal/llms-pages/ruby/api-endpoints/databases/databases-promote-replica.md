...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wcm9tb3RlX3JlcGxpY2E
...
```ruby
def databases_promote_replica(database_cluster_uuid,
                              replica_name)
```
