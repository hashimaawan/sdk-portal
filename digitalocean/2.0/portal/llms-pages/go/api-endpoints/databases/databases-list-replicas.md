...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19saXN0X3JlcGxpY2Fz
...
DatabasesListReplicas(
    ...
    models.ApiResponse[models.V2DatabasesReplicasResponse],
    error)
```
...
apiResponse, err := databasesApi.DatabasesListReplicas(ctx, databaseClusterUuid)
if err != nil {
