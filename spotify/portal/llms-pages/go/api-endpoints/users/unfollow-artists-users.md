...
Source: https://github.com/hashimaawan/sdk-portal/tree/main/spotify/#/go/x-redirect/JTI0ZSUyRlVzZXJzJTJGdW5mb2xsb3ctYXJ0aXN0cy11c2Vycw
...
|  --- | --- | --- | --- |
| `mType` | [`models.ItemType3`](https://github.com/hashimaawan/sdk-portal/tree/main/spotify/llms-pages/go/models/enumerations/item-type-3.md) | Query, Required | - |
| `ids` | `string` | Query, Required | - |
| `body` | [`*models.MeFollowingRequest1`](https://github.com/hashimaawan/sdk-portal/tree/main/spotify/llms-pages/go/models/structures/me-following-request-1.md) | Body, Optional | - |
