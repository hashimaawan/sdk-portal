...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkZ1bmN0aW9ucyUyRmZ1bmN0aW9uc19saXN0X3RyaWdnZXJz
...
```ts
async functionsListTriggers(
  namespaceId: string,
  requestOptions?: RequestOptions
): Promise<ApiResponse<V2FunctionsNamespacesTriggersResponse>>
```
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/sdk-infrastructure/utilities/apiresponse.md) instance. The `result` property of this instance returns the response data which is of type [`V2FunctionsNamespacesTriggersResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-functions-namespaces-triggers-response.md).
...
try {
  const response = await functionsApi.functionsListTriggers(namespaceId);
