...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkZ1bmN0aW9ucyUyRk92ZXJ2aWV3
...
The instance of the `FunctionsApi` class can be created using the API Client.

```
const functionsApi = new FunctionsApi(client);
```
