...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlBsYXllciUyRnN0YXJ0LWEtdXNlcnMtcGxheWJhY2s
...
| `body` | [`MePlayerPlayRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/llms-pages/net-standard-library/models/structures/me-player-play-request.md) | Body, Optional | - |
...
try
{
    await playerApi.StartAUsersPlaybackAsync(
        deviceId,
        body
    );
}
