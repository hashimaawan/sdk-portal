...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9kZWxldGU

To delete your container registry, destroying all container image data stored in it, send a DELETE request to `/v2/registry`.

```php
function registryDelete(): ApiResponse
```
...
$apiResponse = $containerRegistryApi->registryDelete();
