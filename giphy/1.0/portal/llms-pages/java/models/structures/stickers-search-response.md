...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/1.0/portal/#/java/x-redirect/JTI0bSUyRlN0aWNrZXJzJTI1MjBTZWFyY2glMjUyMFJlc3BvbnNl
...
import com.giphy.api.models.StickersSearchResponse;
import java.io.IOException;
import java.util.Arrays;

StickersSearchResponse stickersSearchResponse = new StickersSearchResponse.Builder()
    .data(Arrays.asList(
        new Gif.Builder()
            .bitlyUrl("bitly_url0")
