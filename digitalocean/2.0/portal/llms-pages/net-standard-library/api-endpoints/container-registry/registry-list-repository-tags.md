...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9saXN0X3JlcG9zaXRvcnlUYWdz
...
```csharp
RegistryListRepositoryTagsAsync(
    string registryName,
...
try
{
    ApiResponse<V2RegistryTagsResponse> result = await containerRegistryApi.RegistryListRepositoryTagsAsync(
        registryName,
        repositoryName,
        perPage,
        page
