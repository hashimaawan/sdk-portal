...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRkxvYWRCYWxhbmNlcjE
...
```ruby
load_balancer1 = LoadBalancer1.new(
  forwarding_rules: [
    ForwardingRule.new(
      entry_port: 443,
