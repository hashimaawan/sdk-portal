...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlRhZ3MlMkZ0YWdzX2dldA
...
try
{
    ApiResponse<V2TagsResponse1> result = await tagsApi.TagsGetAsync(tagId);
}
