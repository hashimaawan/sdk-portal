...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19saXN0X2NsdXN0ZXJz
...
DatabasesListClusters(
    ctx context.Context,
    tagName *string) (
    models.ApiResponse[models.V2DatabasesResponse],
    error)
```
...
apiResponse, err := databasesApi.DatabasesListClusters(ctx, &tagName)
if err != nil {
