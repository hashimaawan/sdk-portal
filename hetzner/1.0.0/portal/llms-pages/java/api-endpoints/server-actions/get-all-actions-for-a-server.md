...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0ZSUyRlNlcnZlciUyNTIwQWN0aW9ucyUyRkdldCUyNTIwYWxsJTI1MjBBY3Rpb25zJTI1MjBmb3IlMjUyMGElMjUyMFNlcnZlcg
...
```java
CompletableFuture<ApiResponse<ActionsResponse>> getAllActionsForAServerAsync(
    final int id,
...
serverActionsApi.getAllActionsForAServerAsync(id, null, null).thenAccept(result -> {
