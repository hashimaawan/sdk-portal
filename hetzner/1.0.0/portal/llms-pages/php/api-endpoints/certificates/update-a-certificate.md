...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0ZSUyRkNlcnRpZmljYXRlcyUyRlVwZGF0ZSUyNTIwYSUyNTIwQ2VydGlmaWNhdGU
...
```php
function updateACertificate(int $id, ?UpdateCertificateRequest $body = null): ApiResponse
```
...
| `body` | [`?UpdateCertificateRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/structures/update-certificate-request.md) | Body, Optional | - |
...
$apiResponse = $certificatesApi->updateACertificate(
    $id,
    $body
);
