...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGU
...
```java
CompletableFuture<ApiResponse<Void>> databasesDeleteAsync(
...
databasesApi.databasesDeleteAsync(databaseClusterUuid, databaseName).thenAccept(result -> {
