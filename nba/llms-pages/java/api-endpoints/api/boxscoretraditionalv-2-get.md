...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/#/java/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JldHJhZGl0aW9uYWx2Ml9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```java
CompletableFuture<Void> boxscoretraditionalv2GETAsync(
    final String gameID,
...
aPIController.boxscoretraditionalv2GETAsync(gameID, startPeriod, endPeriod, startRange, endRange, rangeType).thenAccept(result -> {
