...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkltYWdlcyUyRmltYWdlc19kZWxldGU

To delete a snapshot or custom image, send a `DELETE` request to `/v2/images/$IMAGE_ID`.

```php
function imagesDelete(int $imageId): ApiResponse
```
...
$apiResponse = $imagesApi->imagesDelete($imageId);
