...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBEcm9wbGV0cyUyNTIwUmVzcG9uc2U
...
```php
use DigitalOceanApiLib\Models\Builders\V2DropletsResponseBuilder;
...
$v2DropletsResponse = V2DropletsResponseBuilder::init(
    MetaBuilder::init(
        1
    )
