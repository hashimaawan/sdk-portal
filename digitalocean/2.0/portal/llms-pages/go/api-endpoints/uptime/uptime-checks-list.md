...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9jaGVja3NfbGlzdA
...
UptimeChecksList(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2UptimeChecksResponse],
    error)
```
...
apiResponse, err := uptimeApi.UptimeChecksList(ctx, &perPage, &page)
if err != nil {
