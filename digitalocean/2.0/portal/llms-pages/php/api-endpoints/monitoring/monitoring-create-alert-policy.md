...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2NyZWF0ZV9hbGVydFBvbGljeQ

To create a new alert, send a POST request to `/v2/monitoring/alerts`.

```php
function monitoringCreateAlertPolicy(V2MonitoringAlertsRequest $body): ApiResponse
```
...
$apiResponse = $monitoringApi->monitoringCreateAlertPolicy($body);
