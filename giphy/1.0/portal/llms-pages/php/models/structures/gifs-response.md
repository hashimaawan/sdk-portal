...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/1.0/portal/#/php/x-redirect/JTI0bSUyRkdpZnMlMjUyMFJlc3BvbnNl
...
```php
use GiphyApiLib\Models\Builders\GifsResponseBuilder;
...
$gifsResponse = GifsResponseBuilder::init()
    ->data(
        [
            GifBuilder::init()
                ->bitlyUrl('bitly_url0')
