...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkltYWdlcyUyRmltYWdlc19jcmVhdGVfY3VzdG9t
...
```csharp
ImagesCreateCustomAsync(
    Models.V2ImagesRequest body)
```
...
|  --- | --- | --- | --- |
| `body` | [`V2ImagesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-images-request.md) | Body, Required | - |
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type [Models.V2ImagesResponse1](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-images-response-1.md).


# Example Usage

```csharp
V2ImagesRequest body = new V2ImagesRequest
{
...
try
{
    ApiResponse<V2ImagesResponse1> result = await imagesApi.ImagesCreateCustomAsync(body);
}
