...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2NyZWF0ZV9jbHVzdGVy
...
|  --- | --- | --- | --- |
| `body` | [`models.KubernetesCluster`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/kubernetes-cluster.md) | Body, Required | - |
...
apiResponse, err := kubernetesApi.KubernetesCreateCluster(ctx, body)
if err != nil {
