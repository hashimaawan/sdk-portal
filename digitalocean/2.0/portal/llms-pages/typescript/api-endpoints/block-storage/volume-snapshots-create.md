...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTJGdm9sdW1lU25hcHNob3RzX2NyZWF0ZQ

To create a snapshot from a volume, sent a POST request to `/v2/volumes/$VOLUME_ID/snapshots`.

```ts
async volumeSnapshotsCreate(
  volumeId: string,
...
| `body` | [`V2VolumesSnapshotsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-volumes-snapshots-request.md) | Body, Required | - |
...
const body: V2VolumesSnapshotsRequest = {
  name: 'big-data-snapshot1475261774',
};

try {
  const response = await blockStorageApi.volumeSnapshotsCreate(
    volumeId,
    body
  );
