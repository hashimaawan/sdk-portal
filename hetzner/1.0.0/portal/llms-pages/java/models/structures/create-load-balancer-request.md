...
|  --- | --- | --- | --- | --- | --- |
| `Algorithm` | [`LoadBalancerAlgorithm`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/java/models/structures/load-balancer-algorithm.md) | Required | Algorithm of the Load Balancer | LoadBalancerAlgorithm getAlgorithm() | setAlgorithm(LoadBalancerAlgorithm algorithm) |
