...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfY2x1c3RlclNpemU
...
```ts
async databasesUpdateClusterSize(
  databaseClusterUuid: string,
  body: V2DatabasesResizeRequest,
...
| `body` | [`V2DatabasesResizeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-databases-resize-request.md) | Body, Required | - |
...
const body: V2DatabasesResizeRequest = {
  numNodes: 3,
  size: 'db-s-4vcpu-8gb',
};

try {
  const response = await databasesApi.databasesUpdateClusterSize(
    databaseClusterUuid,
    body
  );
