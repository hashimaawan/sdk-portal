...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hib2FyZGJ5bGFzdG5nYW1lc19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```php
function playerdashboardbylastngamesGet(
    string $measureType,
    string $perMode,
    string $plusMinus,
    string $paceAdjust,
...
$api = $client->getAPI();
$apiResponse = $api->playerdashboardbylastngamesGet(
    $measureType,
    $perMode,
    $plusMinus,
    $paceAdjust,
