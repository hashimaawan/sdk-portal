...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRlYyJTI1MjBWcGNzJTI1MjBSZXF1ZXN0
...
| `region` | `str` | Required | The slug identifier for the region where the VPC will be created. |
...
from digitaloceanapi.models.v_2_vpcs_request import V2VpcsRequest

v_2_vpcs_request = V2VpcsRequest(
    name='env.prod-vpc',
    region='nyc1',
