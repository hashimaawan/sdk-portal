...
```java
CompletableFuture<Void> teamdashboardbyteamperformanceGETAsync(
    final String teamID,
...
aPIController.teamdashboardbyteamperformanceGETAsync(teamID, measureType, perMode, plusMinus, paceAdjust, rank, season, seasonType, outcome, location, month, seasonSegment, dateFrom, dateTo, opponentTeamID, vsConference, vsDivision, gameSegment, period, lastNGames).thenAccept(result -> {
