...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/1password/#/php/x-redirect/JTI0bSUyRkZ1bGxJdGVt
...
| `fields` | [`?(Field[])`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/1password/llms-pages/php/models/structures/field.md) | Optional | - | getFields(): ?array | setFields(?array fields): void |
| `files` | [`?(File[])`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/1password/llms-pages/php/models/structures/file.md) | Optional | - | getFiles(): ?array | setFiles(?array files): void |
| `sections` | [`?(Section2[])`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/1password/llms-pages/php/models/structures/section-2.md) | Optional | - | getSections(): ?array | setSections(?array sections): void |
