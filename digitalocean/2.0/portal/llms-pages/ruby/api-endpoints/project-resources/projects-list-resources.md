...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRlByb2plY3QlMjUyMFJlc291cmNlcyUyRnByb2plY3RzX2xpc3RfcmVzb3VyY2Vz

To list all your resources in a project, send a GET request to `/v2/projects/$PROJECT_ID/resources`.

```ruby
def projects_list_resources(project_id,
                            per_page: 20,
                            page: 1)
```
