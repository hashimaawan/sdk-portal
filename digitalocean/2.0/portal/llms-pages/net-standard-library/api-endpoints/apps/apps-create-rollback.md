...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2NyZWF0ZV9yb2xsYmFjaw
...
try
{
    ApiResponse<V2AppsDeploymentsResponse1> result = await appsApi.AppsCreateRollbackAsync(
        appId,
        body
    );
}
