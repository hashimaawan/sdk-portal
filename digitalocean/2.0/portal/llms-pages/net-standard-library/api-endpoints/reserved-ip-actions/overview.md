...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRlJlc2VydmVkJTI1MjBJUCUyNTIwQWN0aW9ucyUyRk92ZXJ2aWV3
...
An instance of the `ReservedIpActionsApi` class can be accessed from the API Client.

```
ReservedIpActionsApi reservedIpActionsApi = client.ReservedIpActionsApi;
```
