...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9ydW5fZ2FyYmFnZUNvbGxlY3Rpb24
...
```python
def registry_run_garbage_collection(self,
                                   registry_name)
```
