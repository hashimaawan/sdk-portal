...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkFwcHMlMkZPdmVydmlldw
...
The instance of the `AppsApi` class can be accessed from the API Client.

```
appsApi := client.AppsApi()
```
