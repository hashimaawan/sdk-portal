...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkNETiUyNTIwRW5kcG9pbnRzJTJGY2RuX2NyZWF0ZV9lbmRwb2ludA
...
|  --- | --- | --- | --- |
| `body` | [`Endpoint`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/endpoint.md) | Body, Required | - |
...
try
{
    ApiResponse<V2CdnEndpointsResponse1> result = await cdnEndpointsApi.CdnCreateEndpointAsync(body);
}
