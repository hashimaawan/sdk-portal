...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveQ
...
```php
function dropletsDestroy(int $dropletId): ApiResponse
```
...
$apiResponse = $dropletsApi->dropletsDestroy($dropletId);
