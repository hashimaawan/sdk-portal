...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfb25saW5lTWlncmF0aW9u
...
```csharp
DatabasesUpdateOnlineMigrationAsync(
    Guid databaseClusterUuid,
    Models.V2DatabasesOnlineMigrationRequest body)
```
...
| `body` | [`V2DatabasesOnlineMigrationRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-databases-online-migration-request.md) | Body, Required | - |
...
V2DatabasesOnlineMigrationRequest body = new V2DatabasesOnlineMigrationRequest
{
    DisableSsl = false,
    Source = new Source
    {
        ["dbname"] = ApiHelper.JsonDeserialize<object>("\"defaultdb\""),
        ["username"] = ApiHelper.JsonDeserialize<object>("\"doadmin\""),
    },
};

try
{
    ApiResponse<V2DatabasesOnlineMigrationResponse> result = await databasesApi.DatabasesUpdateOnlineMigrationAsync(
        databaseClusterUuid,
        body
    );
}
