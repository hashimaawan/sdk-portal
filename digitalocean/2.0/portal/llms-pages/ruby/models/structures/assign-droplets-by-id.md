...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRkFzc2lnbiUyNTIwRHJvcGxldHMlMjUyMGJ5JTI1MjBJRA
...
|  --- | --- | --- | --- |
| `droplet_ids` | `Array[Integer]` | Required | An array containing the IDs of the Droplets assigned to the load balancer. |
...
```ruby
assign_droplets_by_id = AssignDropletsById.new(
  droplet_ids: [
    3164444,
    3164445
  ],
