...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTI1MjBBY3Rpb25zJTJGdm9sdW1lQWN0aW9uc19wb3N0X2J5SWQ
...
VolumeActionsPostById(
    ctx context.Context,
    volumeId uuid.UUID,
    body models.VolumeActionsPostByIdBody,
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2VolumesActionsResponse],
    error)
```
...
| `body` | [`models.VolumeActionsPostByIdBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/oneof-anyof-definitions/volume-actions-post-by-id-body.md) | Body, Required | This is a container for any-of cases. |
...
body := models.VolumeActionsPostByIdBodyContainer.FromV2VolumesActionsRequest(models.V2VolumesActionsRequest{
    Region:                models.ToPointer(models.Region2_Nyc1),
...
apiResponse, err := blockStorageActionsApi.VolumeActionsPostById(ctx, volumeId, body, nil, nil)
if err != nil {
