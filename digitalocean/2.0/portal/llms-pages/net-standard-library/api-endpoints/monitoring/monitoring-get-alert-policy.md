...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2dldF9hbGVydFBvbGljeQ

To retrieve a given alert policy, send a GET request to `/v2/monitoring/alerts/{alert_uuid}`

```csharp
MonitoringGetAlertPolicyAsync(
    string alertUuid)
```
...
try
{
    ApiResponse<V2MonitoringAlertsResponse1> result = await monitoringApi.MonitoringGetAlertPolicyAsync(alertUuid);
}
