...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZXN0cm95X3JlcGxpY2E
...
```php
function databasesDestroyReplica(string $databaseClusterUuid, string $replicaName): ApiResponse
```
...
$apiResponse = $databasesApi->databasesDestroyReplica(
    $databaseClusterUuid,
    $replicaName
);
