...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRlRhZw
...
|  --- | --- | --- | --- |
| `Key` | `string` | Optional | **Constraints**: *Minimum Length*: `1`, *Maximum Length*: `128` |
| `MValue` | `string` | Optional | **Constraints**: *Minimum Length*: `0`, *Maximum Length*: `256` |
