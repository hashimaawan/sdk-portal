...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRvbWFpbiUyNTIwUmVjb3JkcyUyRmRvbWFpbnNfcGF0Y2hfcmVjb3Jk
...
try
{
    ApiResponse<V2DomainsRecordsResponse1> result = await domainRecordsApi.DomainsPatchRecordAsync(
        domainName,
        domainRecordId,
        body
    );
