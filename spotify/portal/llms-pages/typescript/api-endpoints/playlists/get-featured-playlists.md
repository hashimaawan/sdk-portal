...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/typescript/x-redirect/JTI0ZSUyRlBsYXlsaXN0cyUyRmdldC1mZWF0dXJlZC1wbGF5bGlzdHM
...
try {
  const response = await playlistsApi.getFeaturedPlaylists(
    locale,
    limit,
    offset
  );
