...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRlYyJTI1MjBBcHBzJTI1MjBQcm9wb3NlJTI1MjBSZXF1ZXN0
...
|  --- | --- | --- | --- | --- | --- |
| `AppId` | `String` | Optional | An optional ID of an existing app. If set, the spec will be treated as a proposed update to the specified app. The existing app is not modified using this method. | String getAppId() | setAppId(String appId) |
...
import com.digitalocean.api.models.V2AppsProposeRequest;
import com.digitalocean.api.models.Window;
import java.io.IOException;
import java.util.Arrays;

V2AppsProposeRequest v2AppsProposeRequest = new V2AppsProposeRequest.Builder(
    new AppSpec.Builder(
        "web-app-01"
    )
