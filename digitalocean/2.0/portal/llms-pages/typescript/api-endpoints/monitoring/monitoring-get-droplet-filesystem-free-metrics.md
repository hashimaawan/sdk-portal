...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2dldF9kcm9wbGV0RmlsZXN5c3RlbUZyZWVNZXRyaWNz
...
```ts
async monitoringGetDropletFilesystemFreeMetrics(
  hostId: string,
  start: string,
  end: string,
...
try {
  const response = await monitoringApi.monitoringGetDropletFilesystemFreeMetrics(
    hostId,
    start,
    end
  );
