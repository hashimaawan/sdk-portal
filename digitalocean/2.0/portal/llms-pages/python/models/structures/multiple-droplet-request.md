...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRk11bHRpcGxlJTI1MjBEcm9wbGV0JTI1MjBSZXF1ZXN0
...
|  --- | --- | --- | --- |
| `names` | `List[str]` | Required | An array of human human-readable strings you wish to use when displaying the Droplet name. Each name, if set to a domain name managed in the DigitalOcean DNS management system, will configure a PTR record for the Droplet. Each name set during creation will also determine the hostname for the Droplet in its internal configuration. |
...
from digitaloceanapi.models.multiple_droplet_request import MultipleDropletRequest

multiple_droplet_request = MultipleDropletRequest(
    names=[
        'sub-01.example.com',
        'sub-02.example.com'
    ],
