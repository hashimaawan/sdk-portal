...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2dldF9pbnN0YW5jZVNpemU

Retrieve information about a specific instance size for `service`, `worker`, and `job` components.

```csharp
AppsGetInstanceSizeAsync(
    string slug)
```
...
try
{
    ApiResponse<V2AppsTiersInstanceSizesResponse1> result = await appsApi.AppsGetInstanceSizeAsync(slug);
}
