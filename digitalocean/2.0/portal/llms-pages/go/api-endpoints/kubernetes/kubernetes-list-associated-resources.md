...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2xpc3RfYXNzb2NpYXRlZFJlc291cmNlcw
...
KubernetesListAssociatedResources(
    ctx context.Context,
    clusterId uuid.UUID) (
    models.ApiResponse[models.V2KubernetesClustersDestroyWithAssociatedResourcesResponse],
    error)
```
...
apiResponse, err := kubernetesApi.KubernetesListAssociatedResources(ctx, clusterId)
if err != nil {
