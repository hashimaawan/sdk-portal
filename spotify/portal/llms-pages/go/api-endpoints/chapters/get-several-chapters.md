...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRkNoYXB0ZXJzJTJGZ2V0LXNldmVyYWwtY2hhcHRlcnM
...
GetSeveralChapters(
    ...
    ids string,
    market *string) (
    models.ApiResponse[models.ManyChapters],
    error)
```
...
apiResponse, err := chaptersApi.GetSeveralChapters(ctx, ids, &market)
if err != nil {
