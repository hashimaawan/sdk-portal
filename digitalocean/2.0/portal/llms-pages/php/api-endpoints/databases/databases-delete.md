...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGU
...
```php
function databasesDelete(string $databaseClusterUuid, string $databaseName): ApiResponse
```
...
$apiResponse = $databasesApi->databasesDelete(
    $databaseClusterUuid,
    $databaseName
);
