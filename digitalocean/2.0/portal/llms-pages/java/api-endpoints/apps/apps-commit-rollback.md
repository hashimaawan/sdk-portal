...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2NvbW1pdF9yb2xsYmFjaw

Commit an app rollback. This action permanently applies the rollback and unpins the app to resume new deployments.

```java
CompletableFuture<ApiResponse<Void>> appsCommitRollbackAsync(
    final String appId)
```
...
appsApi.appsCommitRollbackAsync(appId).thenAccept(result -> {
