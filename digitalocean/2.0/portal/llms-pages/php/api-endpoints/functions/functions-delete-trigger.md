...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkZ1bmN0aW9ucyUyRmZ1bmN0aW9uc19kZWxldGVfdHJpZ2dlcg
...
```php
function functionsDeleteTrigger(string $namespaceId, string $triggerName): ApiResponse
```
...
$apiResponse = $functionsApi->functionsDeleteTrigger(
    $namespaceId,
    $triggerName
);
