...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXllcnZzcGxheWVyX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```ts
async playervsplayerGET(
  playerID: string,
  vsPlayerID: string,
  seasonType: string,
  measureType: string,
...
try {
  const response = await apiController.playervsplayerGET(
    playerID,
    vsPlayerID,
    seasonType,
    measureType,
