...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXllcnByb2ZpbGV2Ml9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async playerprofilev2GET(
  perMode: string,
  playerID: string,
...
try {
  const response = await apiController.playerprofilev2GET(
    perMode,
    playerID
  );
