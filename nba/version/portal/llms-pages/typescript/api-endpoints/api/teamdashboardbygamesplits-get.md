...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNoYm9hcmRieWdhbWVzcGxpdHNfR0VU

:information_source: **Note** This endpoint does not require authentication.

```ts
async teamdashboardbygamesplitsGET(
  teamID: string,
  measureType: string,
  perMode: string,
  plusMinus: string,
...
try {
  const response = await apiController.teamdashboardbygamesplitsGET(
    teamID,
    measureType,
    perMode,
    plusMinus,
