...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRvbWFpbnMlMkZkb21haW5zX2dldA
...
try
{
    ApiResponse<V2DomainsResponse1> result = await domainsApi.DomainsGetAsync(domainName);
}
