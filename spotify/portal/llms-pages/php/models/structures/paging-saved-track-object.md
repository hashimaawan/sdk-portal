...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/php/x-redirect/JTI0bSUyRlBhZ2luZ1NhdmVkVHJhY2tPYmplY3Q
...
| `items` | [`SavedTrackObject[]`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/llms-pages/php/models/structures/saved-track-object.md) | Required | - | getItems(): array | setItems(array items): void |
...
```php
use SpotifyWebApiWithFixesAndImprovementsFromSonalluxLib\Models\Builders\PagingSavedTrackObjectBuilder;
...
$pagingSavedTrackObject = PagingSavedTrackObjectBuilder::init(
