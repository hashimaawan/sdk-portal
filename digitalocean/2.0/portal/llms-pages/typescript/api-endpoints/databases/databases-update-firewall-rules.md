...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfZmlyZXdhbGxfcnVsZXM
...
```ts
async databasesUpdateFirewallRules(
...
| `body` | [`V2DatabasesFirewallRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-databases-firewall-request.md) | Body, Required | - |
...
const body: V2DatabasesFirewallRequest = {
  rules: [
    {
      type: Type7.IpAddr,
      value: '192.168.1.1',
...
try {
  const response = await databasesApi.databasesUpdateFirewallRules(
    databaseClusterUuid,
    body
  );
