...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hib2FyZGJ5Z2VuZXJhbHNwbGl0c19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```php
function playerdashboardbygeneralsplitsGet(
    string $measureType,
    string $perMode,
    string $plusMinus,
    string $paceAdjust,
...
$api = $client->getAPI();
$apiResponse = $api->playerdashboardbygeneralsplitsGet(
    $measureType,
    $perMode,
    $plusMinus,
    $paceAdjust,
