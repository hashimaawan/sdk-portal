...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9ydW5fZ2FyYmFnZUNvbGxlY3Rpb24
...
```csharp
RegistryRunGarbageCollectionAsync(
    string registryName)
```
...
try
{
    ApiResponse<V2RegistryGarbageCollectionResponse> result = await containerRegistryApi.RegistryRunGarbageCollectionAsync(registryName);
}
