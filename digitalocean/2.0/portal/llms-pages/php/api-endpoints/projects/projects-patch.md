...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlByb2plY3RzJTJGcHJvamVjdHNfcGF0Y2g
...
```php
function projectsPatch(string $projectId, Project $body): ApiResponse
```
...
$apiResponse = $projectsApi->projectsPatch(
    $projectId,
    $body
);
