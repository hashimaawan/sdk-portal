...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfdXNlcg
...
try
{
    ApiResponse<V2DatabasesUsersResponse1> result = await databasesApi.DatabasesGetUserAsync(
        databaseClusterUuid,
        username
    );
}
