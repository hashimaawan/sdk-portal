...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0ZSUyRkZsb2F0aW5nJTI1MjBJUCUyNTIwQWN0aW9ucyUyRkdldCUyNTIwYW4lMjUyMEFjdGlvbiUyNTIwZm9yJTI1MjBhJTI1MjBGbG9hdGluZyUyNTIwSVA
...
```php
function getAnActionForAFloatingIP(int $id, int $actionId): ActionResponse
```
...
try {
    $result = $floatingIPActionsController->getAnActionForAFloatingIP(
        $id,
        $actionId
    );
    echo 'ActionResponse:';
