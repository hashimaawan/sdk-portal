...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkNETiUyNTIwRW5kcG9pbnRzJTJGY2RuX3B1cmdlX2NhY2hl
...
CdnPurgeCacheAsync(
    Guid cdnId,
    Models.V2CdnEndpointsCacheRequest body)
```
...
| `body` | [`V2CdnEndpointsCacheRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-cdn-endpoints-cache-request.md) | Body, Required | - |
...
V2CdnEndpointsCacheRequest body = new V2CdnEndpointsCacheRequest
{
...
try
{
    await cdnEndpointsApi.CdnPurgeCacheAsync(
        cdnId,
        body
    );
}
