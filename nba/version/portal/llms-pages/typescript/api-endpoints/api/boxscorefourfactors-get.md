...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JlZm91cmZhY3RvcnNfR0VU
...
```ts
try {
  const response = await api.boxscorefourfactorsGet();
