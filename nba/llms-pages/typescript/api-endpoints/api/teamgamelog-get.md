...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/#/typescript/x-redirect/JTI0ZSUyRiUyRlRlYW1nYW1lbG9nX0dFVA
...
try {
  const response = await apiController.teamgamelogGET(
    teamID,
    season,
    seasonType
  );
