...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGVfb25saW5lTWlncmF0aW9u
...
```java
CompletableFuture<ApiResponse<Void>> databasesDeleteOnlineMigrationAsync(
...
databasesApi.databasesDeleteOnlineMigrationAsync(databaseClusterUuid, migrationId).thenAccept(result -> {
