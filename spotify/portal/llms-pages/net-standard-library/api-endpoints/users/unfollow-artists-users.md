...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlVzZXJzJTJGdW5mb2xsb3ctYXJ0aXN0cy11c2Vycw
...
| `body` | [`MeFollowingRequest1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/llms-pages/net-standard-library/models/structures/me-following-request-1.md) | Body, Optional | - |
...
try
{
    await usersApi.UnfollowArtistsUsersAsync(
        type,
        ids
    );
}
