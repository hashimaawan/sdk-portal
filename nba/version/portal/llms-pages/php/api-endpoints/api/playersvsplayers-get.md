...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlBsYXllcnN2c3BsYXllcnNfR0VU

:information_source: **Note** This endpoint does not require authentication.

```php
function playersvsplayersGet(
    string $playerTeamId,
    string $playerId1,
    string $playerId2,
    string $playerId3,
...
$api = $client->getAPI();
$apiResponse = $api->playersvsplayersGet(
    $playerTeamId,
    $playerId1,
    $playerId2,
    $playerId3,
