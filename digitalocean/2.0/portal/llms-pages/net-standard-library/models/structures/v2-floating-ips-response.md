...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRlYyJTI1MjBGbG9hdGluZyUyNTIwSXBzJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- |
| `FloatingIps` | [`List<FloatingIp1>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/floating-ip-1.md) | Optional | - |
...
V2FloatingIpsResponse v2FloatingIpsResponse = new V2FloatingIpsResponse
{
    Meta = new Meta
    {
        Total = 1,
    ...
    FloatingIps = new List<FloatingIp1>
    {
        new FloatingIp1
        {
            Droplet = null,
