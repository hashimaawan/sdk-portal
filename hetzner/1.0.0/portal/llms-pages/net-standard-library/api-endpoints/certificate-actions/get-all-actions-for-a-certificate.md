...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkNlcnRpZmljYXRlJTI1MjBBY3Rpb25zJTJGR2V0JTI1MjBhbGwlMjUyMEFjdGlvbnMlMjUyMGZvciUyNTIwYSUyNTIwQ2VydGlmaWNhdGU
...
```csharp
GetAllActionsForACertificateAsync(
    int id,
...
try
{
    ApiResponse<ActionsResponse> result = await certificateActionsApi.GetAllActionsForACertificateAsync(id);
}
