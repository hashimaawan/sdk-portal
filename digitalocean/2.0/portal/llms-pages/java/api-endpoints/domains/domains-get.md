...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRvbWFpbnMlMkZkb21haW5zX2dldA

To get details about a specific domain, send a GET request to `/v2/domains/$DOMAIN_NAME`.

```java
CompletableFuture<ApiResponse<V2DomainsResponse1>> domainsGetAsync(
...
domainsApi.domainsGetAsync(domainName).thenAccept(result -> {
