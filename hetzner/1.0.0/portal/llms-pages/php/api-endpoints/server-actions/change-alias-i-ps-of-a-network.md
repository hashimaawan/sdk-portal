...
```php
function changeAliasIPsOfANetwork(int $id, ?ServersActionsChangeAliasIpsRequest $body = null): ApiResponse
```
...
$apiResponse = $serverActionsApi->changeAliasIPsOfANetwork(
    $id,
    $body
);
