...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkRhdGFiYXNlcyUyRk92ZXJ2aWV3
...
The instance of the `DatabasesApi` class can be accessed from the API Client.

```
databasesApi := client.DatabasesApi()
```
