...
```java
CompletableFuture<Void> teamdashptshotsGETAsync(
...
aPIController.teamdashptshotsGETAsync(perMode, season, seasonType, teamID, outcome, location, month, seasonSegment, dateFrom, dateTo, opponentTeamID, vsConference, vsDivision, gameSegment, period, lastNGames).thenAccept(result -> {
