...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkNETiUyNTIwRW5kcG9pbnRzJTJGY2RuX2dldF9lbmRwb2ludA

To show information about an existing CDN endpoint, send a GET request to `/v2/cdn/endpoints/$ENDPOINT_ID`.

```python
def cdn_get_endpoint(self,
                    cdn_id)
```
...
result = cdn_endpoints_api.cdn_get_endpoint(cdn_id)
