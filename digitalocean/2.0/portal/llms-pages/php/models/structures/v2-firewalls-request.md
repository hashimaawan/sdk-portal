...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBGaXJld2FsbHMlMjUyMFJlcXVlc3Q
...
| `name` | `string` | Required | A human-readable name for a firewall. The name must begin with an alphanumeric character. Subsequent characters must either be alphanumeric characters, a period (.), or a dash (-).<br><br>**Constraints**: *Pattern*: `^[a-zA-Z0-9][a-zA-Z0-9\.-]+$` | getName(): string | setName(string name): void |
...
```php
use DigitalOceanApiLib\Models\Builders\V2FirewallsRequestBuilder;
...
$v2FirewallsRequest = V2FirewallsRequestBuilder::init(
    'firewall'
)
