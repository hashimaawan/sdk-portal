...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/php/x-redirect/JTI0bSUyRkltYWdl
...
| `createdFrom` | [`?CreatedFrom`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/php/models/structures/created-from.md) | Required | Information about the Server the Image was created from | getCreatedFrom(): ?CreatedFrom | setCreatedFrom(?CreatedFrom createdFrom): void |
...
| `osFlavor` | [`string(OsFlavorEnum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/php/models/enumerations/os-flavor.md) | Required | Flavor of operating system contained in the Image | getOsFlavor(): string | setOsFlavor(string osFlavor): void |
...
| `status` | [`string(Status24Enum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/php/models/enumerations/status-24.md) | Required | Whether the Image can be used or if it's still being created or unavailable | getStatus(): string | setStatus(string status): void |
| `type` | [`string(Type22Enum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/php/models/enumerations/type-22.md) | Required | Type of the Image | getType(): string | setType(string type): void |
