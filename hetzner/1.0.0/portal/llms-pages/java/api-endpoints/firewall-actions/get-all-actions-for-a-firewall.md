...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0ZSUyRkZpcmV3YWxsJTI1MjBBY3Rpb25zJTJGR2V0JTI1MjBhbGwlMjUyMEFjdGlvbnMlMjUyMGZvciUyNTIwYSUyNTIwRmlyZXdhbGw
...
```java
CompletableFuture<ApiResponse<ActionsResponse>> getAllActionsForAFirewallAsync(
    final int id,
...
firewallActionsApi.getAllActionsForAFirewallAsync(id, null, null).thenAccept(result -> {
