...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/1.0/portal/#/typescript/x-redirect/JTI0bSUyRkdpZnMlMjUyMFRyYW5zbGF0ZSUyNTIwUmVzcG9uc2U
...
```ts
import { GifsTranslateResponse } from 'giphy-apilib';

const gifsTranslateResponse: GifsTranslateResponse = {
  data: {
    bitlyUrl: 'bitly_url0',
