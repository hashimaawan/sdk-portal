...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRkFzc2lnbiUyNTIwRHJvcGxldHMlMjUyMGJ5JTI1MjBUYWc
...
|  --- | --- | --- | --- |
| `tag` | `str` | Required | The name of a Droplet tag corresponding to Droplets assigned to the load balancer. |
...
from digitaloceanapi.models.assign_droplets_by_tag import AssignDropletsByTag
...
assign_droplets_by_tag = AssignDropletsByTag(
    tag='prod:web',
    region=Region2.NYC3,
    forwarding_rules=[
        ForwardingRule(
