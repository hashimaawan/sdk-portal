...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hwdHNob3RkZWZlbmRfR0VU

:information_source: **Note** This endpoint does not require authentication.

```php
function playerdashptshotdefendGet(
    string $perMode,
    string $season,
    string $seasonType,
    string $playerId,
...
$api = $client->getAPI();
$apiResponse = $api->playerdashptshotdefendGet(
    $perMode,
    $season,
    $seasonType,
    $playerId,
