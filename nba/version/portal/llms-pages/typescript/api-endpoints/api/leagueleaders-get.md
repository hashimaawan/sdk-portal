...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkxlYWd1ZWxlYWRlcnNfR0VU

:information_source: **Note** This endpoint does not require authentication.

```ts
async leagueleadersGET(
  leagueID: string,
  perMode: string,
  season: string,
  seasonType: string,
...
| `statCategory` | `string \| undefined` | Query, Optional | - |
...
try {
  const response = await apiController.leagueleadersGET(
    leagueID,
    perMode,
    season,
    seasonType,
