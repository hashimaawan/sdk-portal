...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRlJlc2VydmVkJTI1MjBJUHMlMkZyZXNlcnZlZElQc19nZXQ
...
ReservedIPsGet(
    ctx context.Context,
    reservedIp string) (
    models.ApiResponse[models.V2ReservedIpsResponse2],
    error)
```
...
apiResponse, err := reservedIPsApi.ReservedIPsGet(ctx, reservedIp)
if err != nil {
