...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkRyYWZ0Y29tYmluZXBsYXllcmFudGhyb19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async draftcombineplayeranthroGET(
  leagueID: string,
  seasonYear: string,
...
try {
  const response = await apiController.draftcombineplayeranthroGET(
    leagueID,
    seasonYear
  );
