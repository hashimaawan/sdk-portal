...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveV9yZXRyeVdpdGhBc3NvY2lhdGVkUmVzb3VyY2Vz
...
```ts
async dropletsDestroyRetryWithAssociatedResources(
  dropletId: number,
...
try {
  const response = await dropletsApi.dropletsDestroyRetryWithAssociatedResources(dropletId);
