...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/typescript/x-redirect/JTI0ZSUyRkFsYnVtcyUyRmNoZWNrLXVzZXJzLXNhdmVkLWFsYnVtcw
...
try {
  const response = await albumsApi.checkUsersSavedAlbums(ids);
