...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkZ1bmN0aW9ucyUyRmZ1bmN0aW9uc19jcmVhdGVfbmFtZXNwYWNl
...
```python
def functions_create_namespace(self,
                              body)
```
...
|  --- | --- | --- | --- |
| `body` | [`V2FunctionsNamespacesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/v2-functions-namespaces-request.md) | Body, Required | - |
