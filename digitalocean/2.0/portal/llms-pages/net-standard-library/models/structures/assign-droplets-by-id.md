...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRkFzc2lnbiUyNTIwRHJvcGxldHMlMjUyMGJ5JTI1MjBJRA
...
|  --- | --- | --- | --- |
| `DropletIds` | `List<int>` | Required | An array containing the IDs of the Droplets assigned to the load balancer. |
...
AssignDropletsById assignDropletsById = new AssignDropletsById
{
