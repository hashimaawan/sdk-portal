...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkNvbnRhaW5lciUyNTIwUmVnaXN0cnklMkZyZWdpc3RyeV9nZXRfZG9ja2VyQ3JlZGVudGlhbHM
...
```csharp
RegistryGetDockerCredentialsAsync(
    int? expirySeconds = 0,
...
try
{
    ApiResponse<V2RegistryDockerCredentialsResponse> result = await containerRegistryApi.RegistryGetDockerCredentialsAsync(
        expirySeconds,
        readWrite
    );
}
