...
Source: https://github.com/hashimaawan/sdk-portal/tree/main/spotify/#/php/x-redirect/JTI0bSUyRkFydGlzdERpc2NvZ3JhcGh5QWxidW1PYmplY3Q
...
| `albumGroup` | [`string(AlbumGroup)`](https://github.com/hashimaawan/sdk-portal/tree/main/spotify/llms-pages/php/models/enumerations/album-group.md) | Required | This field describes the relationship between the artist and the album. | getAlbumGroup(): string | setAlbumGroup(string albumGroup): void |
