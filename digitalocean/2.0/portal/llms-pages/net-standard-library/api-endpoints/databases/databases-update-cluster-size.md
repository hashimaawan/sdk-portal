...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfY2x1c3RlclNpemU
...
```csharp
DatabasesUpdateClusterSizeAsync(
    Guid databaseClusterUuid,
    Models.V2DatabasesResizeRequest body)
```
...
| `body` | [`V2DatabasesResizeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-databases-resize-request.md) | Body, Required | - |
...
V2DatabasesResizeRequest body = new V2DatabasesResizeRequest
{
    NumNodes = 3,
    Size = "db-s-4vcpu-8gb",
};
...
try
{
    await databasesApi.DatabasesUpdateClusterSizeAsync(
        databaseClusterUuid,
        body
    );
}
