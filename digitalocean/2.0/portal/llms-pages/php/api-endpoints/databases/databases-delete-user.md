...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGVfdXNlcg
...
```php
function databasesDeleteUser(string $databaseClusterUuid, string $username): ApiResponse
```
...
$apiResponse = $databasesApi->databasesDeleteUser(
    $databaseClusterUuid,
    $username
);
