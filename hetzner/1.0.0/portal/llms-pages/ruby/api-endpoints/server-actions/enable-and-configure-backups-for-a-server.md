...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/ruby/x-redirect/JTI0ZSUyRlNlcnZlciUyNTIwQWN0aW9ucyUyRkVuYWJsZSUyNTIwYW5kJTI1MjBDb25maWd1cmUlMjUyMEJhY2t1cHMlMjUyMGZvciUyNTIwYSUyNTIwU2VydmVy
...
```ruby
def enable_and_configure_backups_for_a_server(id)
```
...
result = server_actions_controller.enable_and_configure_backups_for_a_server(id)
puts result
```
