...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2NyZWF0ZV9kZXBsb3ltZW50

Creating an app deployment will pull the latest changes from your repository and schedule a new deployment for your app.

```ts
async appsCreateDeployment(
  appId: string,
...
| `body` | [`V2AppsDeploymentsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-apps-deployments-request.md) | Body, Required | - |
...
const body: V2AppsDeploymentsRequest = {
  forceBuild: true,
};

try {
  const response = await appsApi.appsCreateDeployment(
    appId,
    body
  );
