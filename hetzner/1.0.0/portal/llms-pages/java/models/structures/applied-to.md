...
| `Type` | [`Type6Enum`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/java/models/enumerations/type-6.md) | Required | Type of resource referenced | Type6Enum getType() | setType(Type6Enum type) |
