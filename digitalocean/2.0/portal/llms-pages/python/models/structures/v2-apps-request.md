...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRlYyJTI1MjBBcHBzJTI1MjBSZXF1ZXN0
...
|  --- | --- | --- | --- |
| `project_id` | `str` | Optional | The ID of the project the app should be assigned to. If omitted, it will be assigned to your default project. |
...
from digitaloceanapi.models.v_2_apps_request import V2AppsRequest
from digitaloceanapi.models.window import Window

v_2_apps_request = V2AppsRequest(
    spec=AppSpec(
        name='web-app-01',
        databases=[
            Database(
