...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hwdHJlYl9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async playerdashptrebGET(
  perMode: string,
  season: string,
  seasonType: string,
  playerID: string,
...
try {
  const response = await apiController.playerdashptrebGET(
    perMode,
    season,
    seasonType,
    playerID,
