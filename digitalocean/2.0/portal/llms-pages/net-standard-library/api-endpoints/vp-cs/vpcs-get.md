...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlZQQ3MlMkZ2cGNzX2dldA
...
try
{
    ApiResponse<V2VpcsResponse1> result = await vpCsApi.VpcsGetAsync(vpcId);
}
