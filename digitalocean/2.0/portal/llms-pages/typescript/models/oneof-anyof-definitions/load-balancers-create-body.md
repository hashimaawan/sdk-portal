...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRkxvYWRCYWxhbmNlcnNDcmVhdGVCb2R5
...
```ts
const value: LoadBalancersCreateBody = {
  dropletIds: [
    3164444,
    3164445
  ],
