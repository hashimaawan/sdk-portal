...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfbWFqb3JfdmVyc2lvbg
...
```csharp
DatabasesUpdateMajorVersionAsync(
    Guid databaseClusterUuid,
    Models.V2DatabasesUpgradeRequest body)
```
...
| `body` | [`V2DatabasesUpgradeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-databases-upgrade-request.md) | Body, Required | - |
...
V2DatabasesUpgradeRequest body = new V2DatabasesUpgradeRequest
{
    Version = "14",
};
...
try
{
    await databasesApi.DatabasesUpdateMajorVersionAsync(
        databaseClusterUuid,
        body
    );
}
