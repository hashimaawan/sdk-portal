...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRk1hcmtldHMlMkZnZXQtYXZhaWxhYmxlLW1hcmtldHM
...
GetAvailableMarkets(
    ctx context.Context) (
    models.ApiResponse[models.Markets],
    error)
```
...
apiResponse, err := marketsApi.GetAvailableMarkets(ctx)
if err != nil {
