...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfY3JlYXRl
...
LoadBalancersCreate(
    ctx context.Context,
    body models.LoadBalancersCreateBody) (
...
|  --- | --- | --- | --- |
| `body` | [`models.LoadBalancersCreateBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/oneof-anyof-definitions/load-balancers-create-body.md) | Body, Required | This is a container for one-of cases. |
...
body := models.LoadBalancersCreateBodyContainer.FromAssignDropletsById(models.AssignDropletsById{
    DropletIds:                   []int{
        3164444,
        3164445,
    },
...
apiResponse, err := loadBalancersApi.LoadBalancersCreate(ctx, body)
if err != nil {
