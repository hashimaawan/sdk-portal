...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRlYyJTI1MjBWb2x1bWVzJTI1MjBSZXF1ZXN0
...
| `FilesystemLabel` | `String` | Optional | **Constraints**: *Maximum Length*: `16` | String getFilesystemLabel() | setFilesystemLabel(String filesystemLabel) |
...
import com.digitalocean.api.models.V2VolumesRequest;
import java.io.IOException;
import java.util.Arrays;

V2VolumesRequest v2VolumesRequest = new V2VolumesRequest.Builder(
    "example",
    10,
    Region2.NYC3
)
