...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkxlYWd1ZWRhc2hwbGF5ZXJwdHNob3RfR0VU

:information_source: **Note** This endpoint does not require authentication.

```ts
async leaguedashplayerptshotGET(
  leagueID: string,
  perMode: string,
  season: string,
  seasonType: string,
...
try {
  const response = await apiController.leaguedashplayerptshotGET(
    leagueID,
    perMode,
    season,
    seasonType
