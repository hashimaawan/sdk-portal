...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRkFzc2lnbiUyNTIwRHJvcGxldHMlMjUyMGJ5JTI1MjBUYWc
...
|  --- | --- | --- | --- | --- | --- |
| `tag` | `string` | Required | The name of a Droplet tag corresponding to Droplets assigned to the load balancer. | getTag(): string | setTag(string tag): void |
...
```php
use DigitalOceanApiLib\Models\Builders\AssignDropletsByTagBuilder;
...
$assignDropletsByTag = AssignDropletsByTagBuilder::init(
    'prod:web',
    Region2::NYC3,
    [
