...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlRhZ3MlMkZ0YWdzX2dldA

To retrieve an individual tag, you can send a `GET` request to `/v2/tags/$TAG_NAME`.

```php
function tagsGet(string $tagId): ApiResponse
```
...
$apiResponse = $tagsApi->tagsGet($tagId);
