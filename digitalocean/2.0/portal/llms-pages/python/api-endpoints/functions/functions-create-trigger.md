...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkZ1bmN0aW9ucyUyRmZ1bmN0aW9uc19jcmVhdGVfdHJpZ2dlcg
...
```python
def functions_create_trigger(self,
                            namespace_id,
                            body)
```
...
| `body` | [`V2FunctionsNamespacesTriggersRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/v2-functions-namespaces-triggers-request.md) | Body, Required | - |
...
body = V2FunctionsNamespacesTriggersRequest(
    function='hello',
    is_enabled=True,
    name='my trigger',
...
| 422 | Limit Reached | [`V21Clicks401ErrorException`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/exceptions/v2-1-clicks-401-error.md) |
