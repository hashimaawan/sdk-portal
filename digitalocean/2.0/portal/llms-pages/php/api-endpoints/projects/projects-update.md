...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlByb2plY3RzJTJGcHJvamVjdHNfdXBkYXRl

To update a project, send a PUT request to `/v2/projects/$PROJECT_ID`. All of the following attributes must be sent.

```php
function projectsUpdate(string $projectId, Project $body): ApiResponse
```
...
$apiResponse = $projectsApi->projectsUpdate(
    $projectId,
    $body
);
