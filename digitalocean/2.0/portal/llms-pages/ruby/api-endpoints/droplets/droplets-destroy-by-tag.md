...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveV9ieVRhZw
...
```ruby
def droplets_destroy_by_tag(tag_name)
```
...
|  --- | --- | --- | --- |
| `tag_name` | `String` | Query, Required | Specifies Droplets to be deleted by tag. |
...
result = droplets_api.droplets_destroy_by_tag(tag_name)
