...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRklzb3MlMjUyMFJlc3BvbnNl
...
|  --- | --- | --- | --- | --- | --- |
| `Isos` | [`List<Iso>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/iso.md) | Required | - | List<Iso> getIsos() | setIsos(List<Iso> isos) |
