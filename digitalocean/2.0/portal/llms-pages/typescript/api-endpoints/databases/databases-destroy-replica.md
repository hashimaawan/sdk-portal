...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZXN0cm95X3JlcGxpY2E
...
try {
  const response = await databasesApi.databasesDestroyReplica(
    databaseClusterUuid,
    replicaName
  );
