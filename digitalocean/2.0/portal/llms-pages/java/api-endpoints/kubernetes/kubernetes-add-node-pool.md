...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2FkZF9ub2RlUG9vbA
...
```java
CompletableFuture<ApiResponse<V2KubernetesClustersNodePoolsResponse1>> kubernetesAddNodePoolAsync(
...
| `body` | [`NodePool`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/node-pool.md) | Body, Required | - |
...
NodePool body = new NodePool.Builder(
    "s-1vcpu-2gb",
    3,
    "new-pool"
)
...
kubernetesApi.kubernetesAddNodePoolAsync(clusterId, body).thenAccept(result -> {
