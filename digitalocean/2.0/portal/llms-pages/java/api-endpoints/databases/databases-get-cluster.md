...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfY2x1c3Rlcg
...
```java
CompletableFuture<ApiResponse<V2DatabasesResponse1>> databasesGetClusterAsync(
...
databasesApi.databasesGetClusterAsync(databaseClusterUuid).thenAccept(result -> {
