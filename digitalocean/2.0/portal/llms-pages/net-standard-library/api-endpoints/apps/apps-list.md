...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2xpc3Q
...
try
{
    ApiResponse<V2AppsResponse> result = await appsApi.AppsListAsync(
        page,
        perPage,
        withProjects
    );
