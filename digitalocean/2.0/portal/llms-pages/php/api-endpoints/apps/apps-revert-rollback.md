...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX3JldmVydF9yb2xsYmFjaw
...
```php
function appsRevertRollback(string $appId): ApiResponse
```
...
$apiResponse = $appsApi->appsRevertRollback($appId);
