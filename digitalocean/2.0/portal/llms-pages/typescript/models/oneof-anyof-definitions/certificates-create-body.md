...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRkNlcnRpZmljYXRlc0NyZWF0ZUJvZHk
...
| Type |
|  --- |
| [`LetSEncryptCertificateRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/let-s-encrypt-certificate-request.md) |
| [`CustomCertificateRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/custom-certificate-request.md) |
...
```ts
const value: CertificatesCreateBody = {
  name: 'web-cert-01',
  dnsNames: [
    'www.example.com',
    'example.com'
