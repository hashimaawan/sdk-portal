...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRlYyJTI1MjBEYXRhYmFzZXMlMjUyMFJlcXVlc3Q
...
| `BackupRestore` | [`BackupRestore`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/backup-restore.md) | Optional | - |
...
V2DatabasesRequest v2DatabasesRequest = new V2DatabasesRequest
{
    Engine = Engine1.Pg,
    Name = "backend",
    NumNodes = 2,
