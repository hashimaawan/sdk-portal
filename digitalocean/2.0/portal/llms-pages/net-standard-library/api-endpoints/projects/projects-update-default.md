...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlByb2plY3RzJTJGcHJvamVjdHNfdXBkYXRlX2RlZmF1bHQ

To update you default project, send a PUT request to `/v2/projects/default`. All of the following attributes must be sent.

```csharp
ProjectsUpdateDefaultAsync(
    Models.Project body)
```
...
|  --- | --- | --- | --- |
| `body` | [`Project`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/project.md) | Body, Required | - |
...
try
{
    ApiResponse<V2ProjectsResponse1> result = await projectsApi.ProjectsUpdateDefaultAsync(body);
}
