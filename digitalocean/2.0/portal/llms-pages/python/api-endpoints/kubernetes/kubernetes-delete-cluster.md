...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2RlbGV0ZV9jbHVzdGVy
...
```python
def kubernetes_delete_cluster(self,
                             cluster_id)
```
...
result = kubernetes_api.kubernetes_delete_cluster(cluster_id)
