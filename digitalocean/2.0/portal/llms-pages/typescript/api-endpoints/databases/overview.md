...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkRhdGFiYXNlcyUyRk92ZXJ2aWV3
...
The instance of the `DatabasesApi` class can be created using the API Client.

```
const databasesApi = new DatabasesApi(client);
```
