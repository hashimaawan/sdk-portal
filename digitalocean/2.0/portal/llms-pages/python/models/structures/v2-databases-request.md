...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRlYyJTI1MjBEYXRhYmFzZXMlMjUyMFJlcXVlc3Q
...
| `backup_restore` | [`BackupRestore`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/backup-restore.md) | Optional | - |
...
from digitaloceanapi.models.v_2_databases_request import V2DatabasesRequest

v_2_databases_request = V2DatabasesRequest(
    engine=Engine1.PG,
    name='backend',
    num_nodes=2,
    region='nyc3',
