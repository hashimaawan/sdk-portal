...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfY29ubmVjdGlvblBvb2w
...
```ts
async databasesUpdateConnectionPool(
  databaseClusterUuid: string,
  poolName: string,
  body: V2DatabasesPoolsRequest,
...
| `body` | [`V2DatabasesPoolsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-databases-pools-request.md) | Body, Required | - |
...
const body: V2DatabasesPoolsRequest = {
  db: 'defaultdb',
  mode: 'transaction',
  size: 10,
  user: 'doadmin',
...
try {
  const response = await databasesApi.databasesUpdateConnectionPool(
    databaseClusterUuid,
    poolName,
    body
  );
