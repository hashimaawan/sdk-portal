...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfbWlncmF0aW9uU3RhdHVz
...
```ts
async databasesGetMigrationStatus(
...
try {
  const response = await databasesApi.databasesGetMigrationStatus(databaseClusterUuid);
