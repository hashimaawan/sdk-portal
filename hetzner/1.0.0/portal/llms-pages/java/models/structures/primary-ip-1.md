...
| `Type` | [`Type50Enum`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/java/models/enumerations/type-50.md) | Required | Type of the Primary IP | Type50Enum getType() | setType(Type50Enum type) |
