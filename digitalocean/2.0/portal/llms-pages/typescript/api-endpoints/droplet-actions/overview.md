...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkRyb3BsZXQlMjUyMEFjdGlvbnMlMkZPdmVydmlldw
...
The instance of the `DropletActionsApi` class can be created using the API Client.

```
const dropletActionsApi = new DropletActionsApi(client);
```
