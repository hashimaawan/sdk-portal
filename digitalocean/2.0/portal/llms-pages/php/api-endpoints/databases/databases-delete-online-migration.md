...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGVfb25saW5lTWlncmF0aW9u
...
```php
function databasesDeleteOnlineMigration(string $databaseClusterUuid, string $migrationId): ApiResponse
```
...
$apiResponse = $databasesApi->databasesDeleteOnlineMigration(
    $databaseClusterUuid,
    $migrationId
);
