...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTI1MjBBY3Rpb25zJTJGdm9sdW1lQWN0aW9uc19wb3N0X2J5SWQ
...
```php
function volumeActionsPostById(string $volumeId, $body, ?int $perPage = 20, ?int $page = 1): ApiResponse
```
...
$apiResponse = $blockStorageActionsApi->volumeActionsPostById(
    $volumeId,
    $body
);
