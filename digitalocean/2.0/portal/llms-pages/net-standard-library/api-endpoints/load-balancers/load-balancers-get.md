...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRmxvYWRCYWxhbmNlcnNfZ2V0

To show information about a load balancer instance, send a GET request to
`/v2/load_balancers/$LOAD_BALANCER_ID`.

```csharp
LoadBalancersGetAsync(
    string lbId)
```
...
try
{
    ApiResponse<V2LoadBalancersResponse1> result = await loadBalancersApi.LoadBalancersGetAsync(lbId);
}
