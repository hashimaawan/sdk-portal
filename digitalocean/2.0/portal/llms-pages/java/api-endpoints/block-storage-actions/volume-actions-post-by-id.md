...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTI1MjBBY3Rpb25zJTJGdm9sdW1lQWN0aW9uc19wb3N0X2J5SWQ
...
```java
CompletableFuture<ApiResponse<V2VolumesActionsResponse>> volumeActionsPostByIdAsync(
    final UUID volumeId,
    final VolumeActionsPostByIdBody body,
...
| `body` | [`VolumeActionsPostByIdBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/oneof-anyof-definitions/volume-actions-post-by-id-body.md) | Body, Required | This is a container for any-of cases. |
...
blockStorageActionsApi.volumeActionsPostByIdAsync(volumeId, body, null, null).thenAccept(result -> {
