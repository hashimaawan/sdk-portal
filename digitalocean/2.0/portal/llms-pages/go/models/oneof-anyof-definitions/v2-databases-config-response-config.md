...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRlYyRGF0YWJhc2VzQ29uZmlnUmVzcG9uc2VDb25maWc
...
| Type | Factory Method |
|  --- | --- |
| [`models.Config`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/config.md) | models.V2DatabasesConfigResponseConfigContainer.FromConfig(models.Config config) |
| [`models.Config1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/config-1.md) | models.V2DatabasesConfigResponseConfigContainer.FromConfig1(models.Config1 config1) |
| [`models.Config2`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/config-2.md) | models.V2DatabasesConfigResponseConfigContainer.FromConfig2(models.Config2 config2) |
...
```go
value := models.V2DatabasesConfigResponseConfigContainer.FromConfig(models.Config{
...
```go
value := models.V2DatabasesConfigResponseConfigContainer.FromConfig1(models.Config1{
...
```go
value := models.V2DatabasesConfigResponseConfigContainer.FromConfig2(models.Config2{
