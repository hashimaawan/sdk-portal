...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlNjb3JlYm9hcmRWMl9HRVQ
...
try {
  const response = await api.scoreboardV2Get(
    gameDate,
    leagueId,
    dayOffset
  );
