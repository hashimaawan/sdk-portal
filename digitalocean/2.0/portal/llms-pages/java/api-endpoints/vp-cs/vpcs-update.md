...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRlZQQ3MlMkZ2cGNzX3VwZGF0ZQ

To update information about a VPC, send a PUT request to `/v2/vpcs/$VPC_ID`.

```java
CompletableFuture<ApiResponse<V2VpcsResponse1>> vpcsUpdateAsync(
    final UUID vpcId,
    final V2VpcsRequest2 body)
```
...
| `body` | [`V2VpcsRequest2`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/v2-vpcs-request-2.md) | Body, Required | - |
...
V2VpcsRequest2 body = new V2VpcsRequest2.Builder(
    "env.prod-vpc"
)
...
vpCsApi.vpcsUpdateAsync(vpcId, body).thenAccept(result -> {
