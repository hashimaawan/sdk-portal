...
| `issuance` | [`?string(IssuanceEnum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/issuance.md) | Optional | Status of the issuance process of the Certificate | getIssuance(): ?string | setIssuance(?string issuance): void |
| `renewal` | [`?string(RenewalEnum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/renewal.md) | Optional | Status of the renewal process of the Certificate. | getRenewal(): ?string | setRenewal(?string renewal): void |
