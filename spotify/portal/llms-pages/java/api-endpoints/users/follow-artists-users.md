...
Source: https://github.com/hashimaawan/sdk-portal/tree/main/spotify/#/java/x-redirect/JTI0ZSUyRlVzZXJzJTJGZm9sbG93LWFydGlzdHMtdXNlcnM
...
|  --- | --- | --- | --- |
| `type` | [`ItemType2`](https://github.com/hashimaawan/sdk-portal/tree/main/spotify/llms-pages/java/models/enumerations/item-type-2.md) | Query, Required | - |
| `ids` | `String` | Query, Required | - |
| `body` | [`MeFollowingRequest`](https://github.com/hashimaawan/sdk-portal/tree/main/spotify/llms-pages/java/models/structures/me-following-request.md) | Body, Optional | - |
