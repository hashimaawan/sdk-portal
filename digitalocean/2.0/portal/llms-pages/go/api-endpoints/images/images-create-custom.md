...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkltYWdlcyUyRmltYWdlc19jcmVhdGVfY3VzdG9t
...
ImagesCreateCustom(
    ctx context.Context,
    body models.V2ImagesRequest) (
    models.ApiResponse[models.V2ImagesResponse1],
    error)
```
...
|  --- | --- | --- | --- |
| `body` | [`models.V2ImagesRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-images-request.md) | Body, Required | - |
...
apiResponse, err := imagesApi.ImagesCreateCustom(ctx, body)
if err != nil {
