...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/python/x-redirect/JTI0ZSUyRk5ldHdvcmslMjUyMEFjdGlvbnMlMkZDaGFuZ2UlMjUyMElQJTI1MjByYW5nZSUyNTIwb2YlMjUyMGElMjUyME5ldHdvcms
...
```python
def change_ip_range_of_a_network(self,
                                id,
                                body=None)
```
...
| `body` | [`ChangeIPRangeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/python/models/structures/change-ip-range-request.md) | Body, Optional | - |
