...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkltYWdlJTI1MjBBY3Rpb25zJTJGaW1hZ2VBY3Rpb25zX2xpc3Q
...
ImageActionsList(
    ctx context.Context,
    imageId int) (
    models.ApiResponse[models.V2ImagesActionsResponse],
    error)
```
...
apiResponse, err := imageActionsApi.ImageActionsList(ctx, imageId)
if err != nil {
