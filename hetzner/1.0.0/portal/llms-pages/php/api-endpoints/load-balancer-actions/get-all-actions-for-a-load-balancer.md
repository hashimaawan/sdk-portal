...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VyJTI1MjBBY3Rpb25zJTJGR2V0JTI1MjBhbGwlMjUyMEFjdGlvbnMlMjUyMGZvciUyNTIwYSUyNTIwTG9hZCUyNTIwQmFsYW5jZXI
...
```php
function getAllActionsForALoadBalancer(int $id, ?string $sort = null, ?string $status = null): ApiResponse
```
...
$apiResponse = $loadBalancerActionsApi->getAllActionsForALoadBalancer($id);
