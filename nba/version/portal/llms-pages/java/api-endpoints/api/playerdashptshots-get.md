...
```java
CompletableFuture<Void> playerdashptshotsGETAsync(
...
aPIController.playerdashptshotsGETAsync(perMode, season, seasonType, playerID, teamID, outcome, location, month, seasonSegment, dateFrom, dateTo, opponentTeamID, vsConference, vsDivision, gameSegment, period, lastNGames).thenAccept(result -> {
