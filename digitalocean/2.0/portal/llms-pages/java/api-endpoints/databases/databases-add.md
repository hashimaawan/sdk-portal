...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19hZGQ
...
```java
CompletableFuture<ApiResponse<V2DatabasesDbsResponse1>> databasesAddAsync(
...
| `body` | [`Db`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/db.md) | Body, Required | - |
...
Db body = new Db.Builder(
    "alpha"
)
.build();

databasesApi.databasesAddAsync(databaseClusterUuid, body).thenAccept(result -> {
