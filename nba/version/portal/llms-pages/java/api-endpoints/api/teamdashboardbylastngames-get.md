...
```java
CompletableFuture<Void> teamdashboardbylastngamesGETAsync(
    final String teamID,
...
aPIController.teamdashboardbylastngamesGETAsync(teamID, measureType, perMode, plusMinus, paceAdjust, rank, season, seasonType, outcome, location, month, seasonSegment, dateFrom, dateTo, opponentTeamID, vsConference, vsDivision, gameSegment, period, lastNGames).thenAccept(result -> {
