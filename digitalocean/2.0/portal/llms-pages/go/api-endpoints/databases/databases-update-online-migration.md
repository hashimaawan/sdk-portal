...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfb25saW5lTWlncmF0aW9u
...
DatabasesUpdateOnlineMigration(
    ...
    body models.V2DatabasesOnlineMigrationRequest) (
...
| `body` | [`models.V2DatabasesOnlineMigrationRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-databases-online-migration-request.md) | Body, Required | - |
...
body := models.V2DatabasesOnlineMigrationRequest{
    ...
    Source:                models.ToPointer(models.Source{
        AdditionalProperties:  map[string]interface{}{
            "dbname": interface{}("defaultdb"),
            "username": interface{}("doadmin"),
        },
    }),
}

apiResponse, err := databasesApi.DatabasesUpdateOnlineMigration(ctx, databaseClusterUuid, body)
if err != nil {
