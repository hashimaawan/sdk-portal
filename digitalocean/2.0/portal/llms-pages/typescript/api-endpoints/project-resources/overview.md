...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRlByb2plY3QlMjUyMFJlc291cmNlcyUyRk92ZXJ2aWV3
...
The instance of the `ProjectResourcesApi` class can be created using the API Client.

```
const projectResourcesApi = new ProjectResourcesApi(client);
```
