...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/java/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JldXNhZ2V2Ml9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```java
CompletableFuture<ApiResponse<Void>> boxscoreusagev2GetAsync(
    final String gameId,
...
api.boxscoreusagev2GetAsync(gameId, startPeriod, endPeriod, startRange, endRange, rangeType).thenAccept(result -> {
