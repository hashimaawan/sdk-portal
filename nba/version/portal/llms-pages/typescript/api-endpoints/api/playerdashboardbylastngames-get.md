...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hib2FyZGJ5bGFzdG5nYW1lc19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async playerdashboardbylastngamesGET(
  measureType: string,
  perMode: string,
  plusMinus: string,
  paceAdjust: string,
...
try {
  const response = await apiController.playerdashboardbylastngamesGET(
    measureType,
    perMode,
    plusMinus,
    paceAdjust,
