...
Source: https://github.com/hashimaawan/sdk-portal/tree/main/spotify/#/java/x-redirect/JTI0bSUyRlBhZ2luZ1BsYXlsaXN0T2JqZWN0
...
| `Items` | [`List<SimplifiedPlaylistObject>`](https://github.com/hashimaawan/sdk-portal/tree/main/spotify/llms-pages/java/models/structures/simplified-playlist-object.md) | Required | - | List<SimplifiedPlaylistObject> getItems() | setItems(List<SimplifiedPlaylistObject> items) |
