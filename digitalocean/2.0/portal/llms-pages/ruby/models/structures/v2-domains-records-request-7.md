...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRlYyJTI1MjBEb21haW5zJTI1MjBSZWNvcmRzJTI1MjBSZXF1ZXN0Nw
...
| `port` | `Integer` | Required | The port for SRV records. |
| `priority` | `Integer` | Required | The priority for SRV and MX records. |
...
```ruby
v2_domains_records_request7 = V2DomainsRecordsRequest7.new(
