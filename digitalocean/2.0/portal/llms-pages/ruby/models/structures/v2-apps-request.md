...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRlYyJTI1MjBBcHBzJTI1MjBSZXF1ZXN0
...
|  --- | --- | --- | --- |
| `project_id` | `String` | Optional | The ID of the project the app should be assigned to. If omitted, it will be assigned to your default project. |
...
```ruby
v2_apps_request = V2AppsRequest.new(
  spec: AppSpec.new(
    name: 'web-app-01',
    databases: [
      Database.new(
