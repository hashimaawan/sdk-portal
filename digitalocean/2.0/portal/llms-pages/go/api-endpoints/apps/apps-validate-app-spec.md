...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX3ZhbGlkYXRlX2FwcFNwZWM
...
AppsValidateAppSpec(
    ctx context.Context,
    body models.V2AppsProposeRequest) (
    models.ApiResponse[models.V2AppsProposeResponse],
    error)
```
...
|  --- | --- | --- | --- |
| `body` | [`models.V2AppsProposeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-apps-propose-request.md) | Body, Required | - |
...
body := models.V2AppsProposeRequest{
    AppId:                 models.ToPointer("b6bdf840-2854-4f87-a36c-5f231c617c84"),
    Spec:                  models.AppSpec{
        Name:                  "web-app",
...
apiResponse, err := appsApi.AppsValidateAppSpec(ctx, body)
if err != nil {
