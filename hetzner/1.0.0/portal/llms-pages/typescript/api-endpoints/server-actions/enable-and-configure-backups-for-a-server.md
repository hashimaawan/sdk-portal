...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/typescript/x-redirect/JTI0ZSUyRlNlcnZlciUyNTIwQWN0aW9ucyUyRkVuYWJsZSUyNTIwYW5kJTI1MjBDb25maWd1cmUlMjUyMEJhY2t1cHMlMjUyMGZvciUyNTIwYSUyNTIwU2VydmVy
...
```ts
async enableAndConfigureBackupsForAServer(
  id: number,
...
try {
  const response = await serverActionsApi.enableAndConfigureBackupsForAServer(id);
