...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX3JlY3ljbGVfbm9kZV9wb29s
...
```ruby
def kubernetes_recycle_node_pool(cluster_id,
                                 node_pool_id,
                                 body)
```
...
| `body` | [`V2KubernetesClustersNodePoolsRecycleRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-kubernetes-clusters-node-pools-recycle-request.md) | Body, Required | - |
...
body = V2KubernetesClustersNodePoolsRecycleRequest.new(
  nodes: [
