...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0bSUyRlYyJTI1MjBEb21haW5zJTI1MjBSZWNvcmRzJTI1MjBSZXF1ZXN0Ng
...
func main() {
    v2DomainsRecordsRequest6 := models.V2DomainsRecordsRequest6{
        Data:                  models.ToPointer("ns1.digitalocean.com"),
        Flags:                 models.NewOptional(models.ToPointer(120)),
        Id:                    models.ToPointer(28448429),
        Name:                  models.ToPointer("@"),
        Port:                  models.NewOptional(models.ToPointer(252)),
        Ttl:                   1800,
        Type:                  "NS",
