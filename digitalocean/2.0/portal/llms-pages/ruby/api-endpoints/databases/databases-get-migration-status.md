...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfbWlncmF0aW9uU3RhdHVz
...
```ruby
def databases_get_migration_status(database_cluster_uuid)
```
...
result = databases_api.databases_get_migration_status(database_cluster_uuid)
