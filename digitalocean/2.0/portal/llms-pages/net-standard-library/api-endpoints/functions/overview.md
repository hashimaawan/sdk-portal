...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkZ1bmN0aW9ucyUyRk92ZXJ2aWV3
...
An instance of the `FunctionsApi` class can be accessed from the API Client.

```
FunctionsApi functionsApi = client.FunctionsApi;
```
