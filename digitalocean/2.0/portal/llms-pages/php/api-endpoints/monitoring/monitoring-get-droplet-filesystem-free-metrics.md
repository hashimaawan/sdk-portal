...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2dldF9kcm9wbGV0RmlsZXN5c3RlbUZyZWVNZXRyaWNz
...
```php
function monitoringGetDropletFilesystemFreeMetrics(string $hostId, string $start, string $end): ApiResponse
```
...
$apiResponse = $monitoringApi->monitoringGetDropletFilesystemFreeMetrics(
    $hostId,
    $start,
    $end
);
