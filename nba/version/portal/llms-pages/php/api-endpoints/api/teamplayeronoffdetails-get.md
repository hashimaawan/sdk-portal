...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlRlYW1wbGF5ZXJvbm9mZmRldGFpbHNfR0VU

:information_source: **Note** This endpoint does not require authentication.

```php
function teamplayeronoffdetailsGet(
    string $teamId,
    string $measureType,
    string $perMode,
    string $plusMinus,
...
$api = $client->getAPI();
$apiResponse = $api->teamplayeronoffdetailsGet(
    $teamId,
    $measureType,
    $perMode,
    $plusMinus,
