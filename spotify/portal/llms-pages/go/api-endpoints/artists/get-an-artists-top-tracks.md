...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRkFydGlzdHMlMkZnZXQtYW4tYXJ0aXN0cy10b3AtdHJhY2tz
...
GetAnArtistsTopTracks(
    ...
    id string,
    market *string) (
    models.ApiResponse[models.ManyTracks],
    error)
```
...
apiResponse, err := artistsApi.GetAnArtistsTopTracks(ctx, id, &market)
if err != nil {
