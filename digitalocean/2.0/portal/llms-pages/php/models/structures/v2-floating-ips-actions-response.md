...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBGbG9hdGluZyUyNTIwSXBzJTI1MjBBY3Rpb25zJTI1MjBSZXNwb25zZQ
...
```php
use DigitalOceanApiLib\Models\Builders\V2FloatingIpsActionsResponseBuilder;
...
$v2FloatingIpsActionsResponse = V2FloatingIpsActionsResponseBuilder::init(
    MetaBuilder::init(
        1
    )
    ...
    ->actions(
        [
            ActionBuilder::init()
                ->completedAt(DateTimeHelper::fromRfc3339DateTime('2015-11-21T21:51:09Z'))
                ->id(72531856)
                ->region(
                    RegionBuilder::init(
                        true,
                ...
                ->startedAt(DateTimeHelper::fromRfc3339DateTime('2015-11-21T21:51:09Z'))
