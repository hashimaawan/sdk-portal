...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/php/x-redirect/JTI0ZSUyRkNlcnRpZmljYXRlJTI1MjBBY3Rpb25zJTJGR2V0JTI1MjBhbiUyNTIwQWN0aW9uJTI1MjBmb3IlMjUyMGElMjUyMENlcnRpZmljYXRl
...
```php
function getAnActionForACertificate(int $id, int $actionId): ActionResponse
```
...
try {
    $result = $certificateActionsController->getAnActionForACertificate(
        $id,
        $actionId
    );
    echo 'ActionResponse:';
