...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRkRyYWZ0Y29tYmluZXN0YXRzX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```php
function draftcombinestatsGet(string $leagueId, string $seasonYear): ApiResponse
```
...
$api = $client->getAPI();
$apiResponse = $api->draftcombinestatsGet(
    $leagueId,
    $seasonYear
);
