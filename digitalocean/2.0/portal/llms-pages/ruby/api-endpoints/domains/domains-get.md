...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRvbWFpbnMlMkZkb21haW5zX2dldA

To get details about a specific domain, send a GET request to `/v2/domains/$DOMAIN_NAME`.

```ruby
def domains_get(domain_name)
```
...
result = domains_api.domains_get(domain_name)
