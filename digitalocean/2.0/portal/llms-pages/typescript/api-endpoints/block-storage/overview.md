...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTJGT3ZlcnZpZXc
...
The instance of the `BlockStorageApi` class can be created using the API Client.

```
const blockStorageApi = new BlockStorageApi(client);
```
