...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2RlbGV0ZV9ub2RlUG9vbA
...
```ruby
def kubernetes_delete_node_pool(cluster_id,
                                node_pool_id)
```
...
result = kubernetes_api.kubernetes_delete_node_pool(
  cluster_id,
  node_pool_id
)
