...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRlJlbW92ZUZyb21SZXNvdXJjZXNSZXF1ZXN0
...
|  --- | --- | --- | --- | --- | --- |
| `RemoveFrom` | [`List<FirewallRemoveFromResources>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/firewall-remove-from-resources.md) | Required | Resources the Firewall should be removed from | List<FirewallRemoveFromResources> getRemoveFrom() | setRemoveFrom(List<FirewallRemoveFromResources> removeFrom) |
