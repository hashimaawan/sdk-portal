...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNoYm9hcmRieWNsdXRjaF9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```php
function teamdashboardbyclutchGet(
    string $teamId,
    string $measureType,
    string $perMode,
    string $plusMinus,
...
$api = $client->getAPI();
$apiResponse = $api->teamdashboardbyclutchGet(
    $teamId,
    $measureType,
    $perMode,
    $plusMinus,
