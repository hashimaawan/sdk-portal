...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNoYm9hcmRieWdlbmVyYWxzcGxpdHNfR0VU

:information_source: **Note** This endpoint does not require authentication.

```php
function teamdashboardbygeneralsplitsGet(
    string $seasonType,
    string $teamId,
    string $measureType,
    string $perMode,
...
$api = $client->getAPI();
$apiResponse = $api->teamdashboardbygeneralsplitsGet(
    $seasonType,
    $teamId,
    $measureType,
    $perMode,
