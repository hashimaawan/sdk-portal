...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlRlYW12c3BsYXllcl9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```php
function teamvsplayerGet(
    string $teamId,
    string $vsPlayerId,
    string $seasonType,
    string $measureType,
...
$api = $client->getAPI();
$apiResponse = $api->teamvsplayerGet(
    $teamId,
    $vsPlayerId,
    $seasonType,
    $measureType,
