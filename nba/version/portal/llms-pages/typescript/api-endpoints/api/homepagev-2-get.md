...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkhvbWVwYWdldjJfR0VU
...
try {
  const response = await api.homepagev2Get(
    statType,
    leagueId,
    season,
    seasonType,
