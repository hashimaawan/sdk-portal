...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfY2x1c3RlclNpemU
...
DatabasesUpdateClusterSize(
    ...
    body models.V2DatabasesResizeRequest) (
    http.Response,
    error)
```
...
| `body` | [`models.V2DatabasesResizeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-databases-resize-request.md) | Body, Required | - |
...
resp, err := databasesApi.DatabasesUpdateClusterSize(ctx, databaseClusterUuid, body)
if err != nil {
