...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/1.0/portal/#/go/x-redirect/JTI0ZSUyRmdpZnMlMkZyYW5kb21HaWY
...
RandomGif(
    ...
    tag *string,
    rating *string) (
    models.ApiResponse[models.GifsRandomResponse],
    error)
```
