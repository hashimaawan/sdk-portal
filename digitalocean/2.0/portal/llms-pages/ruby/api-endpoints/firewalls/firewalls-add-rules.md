...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19hZGRfcnVsZXM
...
```ruby
def firewalls_add_rules(firewall_id,
                        body: nil)
```
...
result = firewalls_api.firewalls_add_rules(
  firewall_id,
  body: body
)
