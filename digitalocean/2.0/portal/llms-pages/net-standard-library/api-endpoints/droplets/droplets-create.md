...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfY3JlYXRl
...
|  --- | --- | --- | --- |
| `body` | [`DropletsCreateBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/oneof-anyof-definitions/droplets-create-body.md) | Body, Optional | This is a container for one-of cases. |
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/sdk-infrastructure/utilities/apiresponse.md) instance. The `Data` property of this instance returns the response data which is of type DropletsCreateResponse.
...
try
{
    ApiResponse<DropletsCreateResponse> result = await dropletsApi.DropletsCreateAsync(body);
    result.Data.Match<VoidType>(
        singleDropletResponse: singleDropletResponse =>
        {
            // TODO: handle singleDropletResponse here
            Console.WriteLine(singleDropletResponse);
            return null;
        },
        multipleDropletResponse: multipleDropletResponse =>
        {
            // TODO: handle multipleDropletResponse here
            Console.WriteLine(multipleDropletResponse);
            return null;
        });
}
