...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/go/x-redirect/JTI0ZSUyRiUyRkZyYW5jaGlzZWhpc3RvcnlfR0VU
...
resp, err := api.FranchisehistoryGet(ctx, leagueId)
if err != nil {
    log.Fatalln(err)
} else {
