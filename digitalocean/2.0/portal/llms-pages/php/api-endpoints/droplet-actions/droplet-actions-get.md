...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRyb3BsZXQlMjUyMEFjdGlvbnMlMkZkcm9wbGV0QWN0aW9uc19nZXQ
...
```php
function dropletActionsGet(int $dropletId, int $actionId): ApiResponse
```
...
$apiResponse = $dropletActionsApi->dropletActionsGet(
    $dropletId,
    $actionId
);
