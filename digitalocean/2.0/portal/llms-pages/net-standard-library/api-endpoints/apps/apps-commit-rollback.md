...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkFwcHMlMkZhcHBzX2NvbW1pdF9yb2xsYmFjaw

Commit an app rollback. This action permanently applies the rollback and unpins the app to resume new deployments.

```csharp
AppsCommitRollbackAsync(
    string appId)
```
...
try
{
    await appsApi.AppsCommitRollbackAsync(appId);
}
