...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRlByb2plY3QlMjUyMFJlc291cmNlcyUyRnByb2plY3RzX2xpc3RfcmVzb3VyY2Vz
...
ProjectsListResources(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2ProjectsDefaultResourcesResponse],
    error)
```
...
apiResponse, err := projectResourcesApi.ProjectsListResources(ctx, projectId, &perPage, &page)
if err != nil {
