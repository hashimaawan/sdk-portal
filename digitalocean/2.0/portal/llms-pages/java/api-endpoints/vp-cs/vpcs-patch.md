...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRlZQQ3MlMkZ2cGNzX3BhdGNo

To update a subset of information about a VPC, send a PATCH request to
`/v2/vpcs/$VPC_ID`.

```java
CompletableFuture<ApiResponse<V2VpcsResponse1>> vpcsPatchAsync(
    final UUID vpcId,
    final V2VpcsRequest1 body)
```
...
| `body` | [`V2VpcsRequest1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/v2-vpcs-request-1.md) | Body, Required | - |
...
V2VpcsRequest1 body = new V2VpcsRequest1.Builder()
    .description("VPC for production environment")
    .name("env.prod-vpc")
    .mDefault(true)
    .build();

vpCsApi.vpcsPatchAsync(vpcId, body).thenAccept(result -> {
