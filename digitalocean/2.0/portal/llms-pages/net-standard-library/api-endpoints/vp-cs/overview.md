...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRlZQQ3MlMkZPdmVydmlldw
...
An instance of the `VpCsApi` class can be accessed from the API Client.

```
VpCsApi vpCsApi = client.VpCsApi;
```
