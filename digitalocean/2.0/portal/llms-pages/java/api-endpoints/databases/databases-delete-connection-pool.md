...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGVfY29ubmVjdGlvblBvb2w
...
```java
CompletableFuture<ApiResponse<Void>> databasesDeleteConnectionPoolAsync(
...
databasesApi.databasesDeleteConnectionPoolAsync(databaseClusterUuid, poolName).thenAccept(result -> {
