...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRlZQQ3MlMkZ2cGNzX3BhdGNo

To update a subset of information about a VPC, send a PATCH request to
`/v2/vpcs/$VPC_ID`.

```php
function vpcsPatch(string $vpcId, V2VpcsRequest1 $body): ApiResponse
```
...
| `body` | [`V2VpcsRequest1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/v2-vpcs-request-1.md) | Body, Required | - |
...
$body = V2VpcsRequest1Builder::init()
