...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19hc3NpZ25fZHJvcGxldHM
...
FirewallsAssignDroplets(
    ...
    body *models.V2FirewallsDropletsRequest1) (
    http.Response,
    error)
```
...
| `body` | [`*models.V2FirewallsDropletsRequest1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-firewalls-droplets-request-1.md) | Body, Optional | - |
...
resp, err := firewallsApi.FirewallsAssignDroplets(ctx, firewallId, &body)
if err != nil {
