...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2Rlc3Ryb3lfYXNzb2NpYXRlZFJlc291cmNlc0Rhbmdlcm91cw
...
```ts
async kubernetesDestroyAssociatedResourcesDangerous(
  clusterId: string,
...
try {
  const response = await kubernetesApi.kubernetesDestroyAssociatedResourcesDangerous(clusterId);
