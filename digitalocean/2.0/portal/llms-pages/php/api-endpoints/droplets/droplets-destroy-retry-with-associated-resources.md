...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0ZSUyRkRyb3BsZXRzJTJGZHJvcGxldHNfZGVzdHJveV9yZXRyeVdpdGhBc3NvY2lhdGVkUmVzb3VyY2Vz
...
```php
function dropletsDestroyRetryWithAssociatedResources(int $dropletId): ApiResponse
```
...
$apiResponse = $dropletsApi->dropletsDestroyRetryWithAssociatedResources($dropletId);
...
| 409 | Conflict | [`V21Clicks401ErrorException`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/exceptions/v2-1-clicks-401-error.md) |
