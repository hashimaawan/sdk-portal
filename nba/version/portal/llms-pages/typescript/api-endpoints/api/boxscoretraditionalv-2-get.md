...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JldHJhZGl0aW9uYWx2Ml9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async boxscoretraditionalv2GET(
  gameID: string,
  startPeriod: string,
  endPeriod: string,
  startRange: string,
...
try {
  const response = await apiController.boxscoretraditionalv2GET(
    gameID,
    startPeriod,
    endPeriod,
    startRange,
