...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNocHRzaG90c19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```php
function teamdashptshotsGet(
    string $perMode,
    string $season,
    string $seasonType,
    string $teamId,
...
$api = $client->getAPI();
$apiResponse = $api->teamdashptshotsGet(
    $perMode,
    $season,
    $seasonType,
    $teamId,
