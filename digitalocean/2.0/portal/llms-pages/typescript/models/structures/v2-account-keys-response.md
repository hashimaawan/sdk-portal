...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRlYyJTI1MjBBY2NvdW50JTI1MjBLZXlzJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- |
| `sshKeys` | [`SshKey[] \| undefined`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/ssh-key.md) | Optional | - |
...
```ts
import { V2AccountKeysResponse } from 'digitalocean-apilib';

const v2AccountKeysResponse: V2AccountKeysResponse = {
  meta: {
    total: 1,
