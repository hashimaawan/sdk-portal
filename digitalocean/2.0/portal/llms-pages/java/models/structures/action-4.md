...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRkFjdGlvbjQ
...
| `Type` | `String` | Optional | This is the type of action that the object represents. For example, this could be "attach_volume" to represent the state of a volume attach action. | String getType() | setType(String type) |
...
Action4 action4 = new Action4.Builder()
    .resourceId(160)
    .type("attach_volume")
