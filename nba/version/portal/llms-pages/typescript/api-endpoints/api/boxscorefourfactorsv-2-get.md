...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JlZm91cmZhY3RvcnN2Ml9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async boxscorefourfactorsv2GET(
  gameID: string,
  startPeriod: string,
  endPeriod: string,
  startRange: string,
...
try {
  const response = await apiController.boxscorefourfactorsv2GET(
    gameID,
    startPeriod,
    endPeriod,
    startRange,
