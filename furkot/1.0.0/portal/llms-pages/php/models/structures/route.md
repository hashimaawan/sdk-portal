...
| `mode` | [`?string(ModeEnum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/furkot/1.0.0/portal/llms-pages/php/models/enumerations/mode.md) | Optional | travel mode | getMode(): ?string | setMode(?string mode): void |
