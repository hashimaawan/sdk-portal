...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfZXZpY3Rpb25Qb2xpY3k
...
```ts
async databasesUpdateEvictionPolicy(
  databaseClusterUuid: string,
  body: V2DatabasesEvictionPolicyRequest,
...
| `body` | [`V2DatabasesEvictionPolicyRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/v2-databases-eviction-policy-request.md) | Body, Required | - |
...
const body: V2DatabasesEvictionPolicyRequest = {
  evictionPolicy: RedisMaxmemoryPolicy.AllkeysLru,
};

try {
  const response = await databasesApi.databasesUpdateEvictionPolicy(
    databaseClusterUuid,
    body
  );
