...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRkNlcnRpZmljYXRl
...
| `Status` | [`Status2`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/status-2.md) | Optional | Current status of a type `managed` Certificate, always *null* for type `uploaded` Certificates | Status2 getStatus() | setStatus(Status2 status) |
| `Type` | [`TypeEnum`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/enumerations/type.md) | Optional | Type of the Certificate | TypeEnum getType() | setType(TypeEnum type) |
| `UsedBy` | [`List<UsedBy>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/used-by.md) | Required | Resources currently using the Certificate | List<UsedBy> getUsedBy() | setUsedBy(List<UsedBy> usedBy) |
