...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkxlYWd1ZWRhc2hwbGF5ZXJjbHV0Y2hfR0VU

:information_source: **Note** This endpoint does not require authentication.

```ts
async leaguedashplayerclutchGET(
  clutchTime: string,
  aheadBehind: string,
  pointDiff: string,
  gameScope: string,
...
```ts
const clutchTime = 'ClutchTime4';

const aheadBehind = 'AheadBehind8';

const pointDiff = 'PointDiff6';
...
try {
  const response = await apiController.leaguedashplayerclutchGET(
    clutchTime,
    aheadBehind,
    pointDiff,
    gameScope,
