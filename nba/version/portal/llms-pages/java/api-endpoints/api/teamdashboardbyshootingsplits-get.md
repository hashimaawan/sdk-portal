...
```java
CompletableFuture<Void> teamdashboardbyshootingsplitsGETAsync(
    final String teamID,
...
aPIController.teamdashboardbyshootingsplitsGETAsync(teamID, measureType, perMode, plusMinus, paceAdjust, rank, season, seasonType, outcome, location, month, seasonSegment, dateFrom, dateTo, opponentTeamID, vsConference, vsDivision, gameSegment, period, lastNGames).thenAccept(result -> {
