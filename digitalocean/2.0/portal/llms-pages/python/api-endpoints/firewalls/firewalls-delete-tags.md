...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19kZWxldGVfdGFncw
...
```python
def firewalls_delete_tags(self,
                         firewall_id,
                         body=None)
```
...
| `body` | [`V2FirewallsTagsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/v2-firewalls-tags-request.md) | Body, Optional | - |
...
result = firewalls_api.firewalls_delete_tags(
    firewall_id,
    body=body
)
