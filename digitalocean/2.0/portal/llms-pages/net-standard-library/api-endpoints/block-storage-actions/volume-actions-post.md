...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTI1MjBBY3Rpb25zJTJGdm9sdW1lQWN0aW9uc19wb3N0
...
```csharp
VolumeActionsPostAsync(
    VolumeActionsPostBody body,
    int? perPage = 20,
    int? page = 1)
```
...
|  --- | --- | --- | --- |
| `body` | [`VolumeActionsPostBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/oneof-anyof-definitions/volume-actions-post-body.md) | Body, Required | This is a container for any-of cases. |
...
VolumeActionsPostBody body = VolumeActionsPostBody.FromV2VolumesActionsRequest(
    new V2VolumesActionsRequest
    {
        ...
        ["volume_name"] = ApiHelper.JsonDeserialize<object>("\"example\""),
    }
);

try
{
    ApiResponse<V2VolumesActionsResponse> result = await blockStorageActionsApi.VolumeActionsPostAsync(body);
}
