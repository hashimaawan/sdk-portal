...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfY29ubmVjdGlvblBvb2w
...
DatabasesUpdateConnectionPool(
    ...
    poolName string,
    body models.V2DatabasesPoolsRequest) (
    http.Response,
    error)
```
...
| `body` | [`models.V2DatabasesPoolsRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-databases-pools-request.md) | Body, Required | - |
...
resp, err := databasesApi.DatabasesUpdateConnectionPool(ctx, databaseClusterUuid, poolName, body)
if err != nil {
