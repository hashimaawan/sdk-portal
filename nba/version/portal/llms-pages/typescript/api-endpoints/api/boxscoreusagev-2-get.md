...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRkJveHNjb3JldXNhZ2V2Ml9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async boxscoreusagev2GET(
  gameID: string,
  startPeriod: string,
  endPeriod: string,
  startRange: string,
...
try {
  const response = await apiController.boxscoreusagev2GET(
    gameID,
    startPeriod,
    endPeriod,
    startRange,
