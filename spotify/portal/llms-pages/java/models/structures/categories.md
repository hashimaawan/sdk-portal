...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/java/x-redirect/JTI0bSUyRkNhdGVnb3JpZXM
...
| `Items` | [`List<CategoryObject>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/java/models/structures/category-object.md) | Required | - | List<CategoryObject> getItems() | setItems(List<CategoryObject> items) |
