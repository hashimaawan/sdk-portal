...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkltYWdlcyUyRk92ZXJ2aWV3
...
```
ImagesController imagesController = client.getImagesController();
```
