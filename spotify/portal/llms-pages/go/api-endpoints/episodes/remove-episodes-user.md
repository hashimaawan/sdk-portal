...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRkVwaXNvZGVzJTJGcmVtb3ZlLWVwaXNvZGVzLXVzZXI
...
RemoveEpisodesUser(
    ctx context.Context,
    ids string,
    body *models.MeEpisodesRequest1) (
    http.Response,
    error)
```
...
| `body` | [`*models.MeEpisodesRequest1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/llms-pages/go/models/structures/me-episodes-request-1.md) | Body, Optional | - |
...
resp, err := episodesApi.RemoveEpisodesUser(ctx, ids, nil)
if err != nil {
