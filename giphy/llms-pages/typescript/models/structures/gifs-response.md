...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/#/typescript/x-redirect/JTI0bSUyRkdpZnMlMjUyMFJlc3BvbnNl
...
```ts
import { GifsResponse } from 'giphy-apilib';

const gifsResponse: GifsResponse = {
  data: [
    {
      bitlyUrl: 'bitly_url0',
