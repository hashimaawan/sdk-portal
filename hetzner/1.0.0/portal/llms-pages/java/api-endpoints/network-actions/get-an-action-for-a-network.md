...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0ZSUyRk5ldHdvcmslMjUyMEFjdGlvbnMlMkZHZXQlMjUyMGFuJTI1MjBBY3Rpb24lMjUyMGZvciUyNTIwYSUyNTIwTmV0d29yaw
...
```java
CompletableFuture<ApiResponse<ActionResponse>> getAnActionForANetworkAsync(
    final int id,
    final int actionId)
```
...
networkActionsApi.getAnActionForANetworkAsync(id, actionId).thenAccept(result -> {
