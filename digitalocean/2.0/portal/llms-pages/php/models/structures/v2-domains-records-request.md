...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBEb21haW5zJTI1MjBSZWNvcmRzJTI1MjBSZXF1ZXN0
...
```php
use DigitalOceanApiLib\Models\Builders\V2DomainsRecordsRequestBuilder;
use DigitalOceanApiLib\ApiHelper;

$v2DomainsRecordsRequest = V2DomainsRecordsRequestBuilder::init(
