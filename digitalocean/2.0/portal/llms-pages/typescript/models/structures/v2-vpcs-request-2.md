...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0bSUyRlYyJTI1MjBWcGNzJTI1MjBSZXF1ZXN0Mg
...
```ts
import { V2VpcsRequest2 } from 'digitalocean-apilib';

const v2VpcsRequest2: V2VpcsRequest2 = {
  name: 'env.prod-vpc',
