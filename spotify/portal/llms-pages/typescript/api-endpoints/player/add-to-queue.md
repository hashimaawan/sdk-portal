...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/typescript/x-redirect/JTI0ZSUyRlBsYXllciUyRmFkZC10by1xdWV1ZQ
...
try {
  const response = await playerApi.addToQueue(
    uri,
    deviceId
  );
