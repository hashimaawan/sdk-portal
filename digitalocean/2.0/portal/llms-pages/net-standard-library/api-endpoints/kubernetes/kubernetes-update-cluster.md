...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX3VwZGF0ZV9jbHVzdGVy
...
```csharp
KubernetesUpdateClusterAsync(
    Guid clusterId,
    Models.V2KubernetesClustersRequest body)
```
...
| `body` | [`V2KubernetesClustersRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/v2-kubernetes-clusters-request.md) | Body, Required | - |
...
V2KubernetesClustersRequest body = new V2KubernetesClustersRequest
{
...
try
{
    ApiResponse<V2KubernetesClustersResponse1> result = await kubernetesApi.KubernetesUpdateClusterAsync(
        clusterId,
        body
    );
}
