...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hib2FyZGJ5eWVhcm92ZXJ5ZWFyX0dFVA

:information_source: **Note** This endpoint does not require authentication.

```ts
async playerdashboardbyyearoveryearGET(
  measureType: string,
  perMode: string,
  plusMinus: string,
  paceAdjust: string,
...
try {
  const response = await apiController.playerdashboardbyyearoveryearGET(
    measureType,
    perMode,
    plusMinus,
    paceAdjust,
