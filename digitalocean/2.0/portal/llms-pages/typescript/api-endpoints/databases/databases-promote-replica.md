...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19wcm9tb3RlX3JlcGxpY2E
...
const replicaName = 'read-nyc3-01';

try {
  const response = await databasesApi.databasesPromoteReplica(
    databaseClusterUuid,
    replicaName
  );
