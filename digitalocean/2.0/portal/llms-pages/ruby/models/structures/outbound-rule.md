...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRk91dGJvdW5kUnVsZQ
...
| `destinations` | [`Destinations`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/destinations.md) | Required | - |
...
```ruby
outbound_rule = OutboundRule.new(
  ports: '8000',
