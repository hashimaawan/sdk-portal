...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hib2FyZGJ5Z2FtZXNwbGl0c19HRVQ

:information_source: **Note** This endpoint does not require authentication.

```ts
async playerdashboardbygamesplitsGET(
  measureType: string,
  perMode: string,
  plusMinus: string,
  paceAdjust: string,
...
try {
  const response = await apiController.playerdashboardbygamesplitsGET(
    measureType,
    perMode,
    plusMinus,
    paceAdjust,
