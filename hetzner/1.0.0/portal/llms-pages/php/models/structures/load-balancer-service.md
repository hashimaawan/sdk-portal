...
| `protocol` | [`string(Protocol7Enum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/protocol-7.md) | Required | Protocol of the Load Balancer | getProtocol(): string | setProtocol(string protocol): void |
