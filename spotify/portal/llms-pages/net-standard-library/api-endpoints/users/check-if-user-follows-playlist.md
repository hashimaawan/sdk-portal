...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlVzZXJzJTJGY2hlY2staWYtdXNlci1mb2xsb3dzLXBsYXlsaXN0
...
try
{
    ApiResponse<List<bool>> result = await usersApi.CheckIfUserFollowsPlaylistAsync(
        playlistId,
        ids
    );
}
