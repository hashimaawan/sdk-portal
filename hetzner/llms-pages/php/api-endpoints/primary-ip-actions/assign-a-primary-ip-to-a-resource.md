...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/php/x-redirect/JTI0ZSUyRlByaW1hcnklMjUyMElQJTI1MjBBY3Rpb25zJTJGQXNzaWduJTI1MjBhJTI1MjBQcmltYXJ5JTI1MjBJUCUyNTIwdG8lMjUyMGElMjUyMHJlc291cmNl
...
```php
function assignAPrimaryIPToAResource(int $id, ?AssignPrimaryIPRequest $body = null): ActionResponse
```
...
| `body` | [`?AssignPrimaryIPRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/php/models/structures/assign-primary-ip-request.md) | Body, Optional | - |
...
try {
    $result = $primaryIPActionsController->assignAPrimaryIPToAResource(
        $id,
        $body
    );
    echo 'ActionResponse:';
