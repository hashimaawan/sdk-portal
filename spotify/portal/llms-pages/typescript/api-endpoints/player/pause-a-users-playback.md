...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/typescript/x-redirect/JTI0ZSUyRlBsYXllciUyRnBhdXNlLWEtdXNlcnMtcGxheWJhY2s
...
try {
  const response = await playerApi.pauseAUsersPlayback(deviceId);
