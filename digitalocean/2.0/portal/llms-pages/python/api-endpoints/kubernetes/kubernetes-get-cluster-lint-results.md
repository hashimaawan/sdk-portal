...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0ZSUyRkt1YmVybmV0ZXMlMkZrdWJlcm5ldGVzX2dldF9jbHVzdGVyTGludFJlc3VsdHM
...
```python
def kubernetes_get_cluster_lint_results(self,
                                       cluster_id,
                                       run_id=None)
```
...
| `run_id` | `uuid\|str` | Query, Optional | Specifies the clusterlint run whose results will be retrieved. |
...
This method returns an [`ApiResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/sdk-infrastructure/utilities/apiresponse.md) instance. The `body` property of this instance returns the response data which is of type [`V2KubernetesClustersClusterlintResponse`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/python/models/structures/v2-kubernetes-clusters-clusterlint-response.md).
...
result = kubernetes_api.kubernetes_get_cluster_lint_results(
    cluster_id,
    run_id=run_id
)
