...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRvbWFpbiUyNTIwUmVjb3JkcyUyRmRvbWFpbnNfdXBkYXRlX3JlY29yZA
...
```csharp
DomainsUpdateRecordAsync(
    string domainName,
    int domainRecordId,
    Models.DomainRecord body = null)
```
...
| `body` | [`DomainRecord`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/domain-record.md) | Body, Optional | - |
...
DomainRecord body = new DomainRecord
{
    Type = "CNAME",
    Name = "blog",
};
...
try
{
    ApiResponse<V2DomainsRecordsResponse1> result = await domainRecordsApi.DomainsUpdateRecordAsync(
        domainName,
        domainRecordId,
        body
    );
