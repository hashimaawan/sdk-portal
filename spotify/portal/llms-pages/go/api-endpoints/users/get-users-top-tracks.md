...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRlVzZXJzJTJGZ2V0LXVzZXJzLXRvcC10cmFja3M
...
GetUsersTopTracks(
    ...
    limit *int,
    offset *int) (
    models.ApiResponse[models.PagingTrackObject],
    error)
```
...
apiResponse, err := usersApi.GetUsersTopTracks(ctx, &timeRange, &limit, &offset)
if err != nil {
