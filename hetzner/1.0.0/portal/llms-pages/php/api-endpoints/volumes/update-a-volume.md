...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0ZSUyRlZvbHVtZXMlMkZVcGRhdGUlMjUyMGElMjUyMFZvbHVtZQ
...
```php
function updateAVolume(string $id, ?UpdateVolumeRequest $body = null): ApiResponse
```
...
| `body` | [`?UpdateVolumeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/structures/update-volume-request.md) | Body, Optional | - |
...
$apiResponse = $volumesApi->updateAVolume(
    $id,
    $body
);
