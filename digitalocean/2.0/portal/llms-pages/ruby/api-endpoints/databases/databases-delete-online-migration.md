...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19kZWxldGVfb25saW5lTWlncmF0aW9u
...
```ruby
def databases_delete_online_migration(database_cluster_uuid,
                                      migration_id)
```
...
| `migration_id` | `String` | Template, Required | A unique identifier assigned to the online migration. |
