...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkJsb2NrJTI1MjBTdG9yYWdlJTJGdm9sdW1lc19kZWxldGVfYnlOYW1l
...
```ruby
def volumes_delete_by_name(name: nil,
                           region: nil)
```
