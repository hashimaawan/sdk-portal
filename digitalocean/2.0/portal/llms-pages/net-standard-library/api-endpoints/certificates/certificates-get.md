...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkNlcnRpZmljYXRlcyUyRmNlcnRpZmljYXRlc19nZXQ

To show information about an existing certificate, send a GET request to `/v2/certificates/$CERTIFICATE_ID`.

```csharp
CertificatesGetAsync(
    Guid certificateId)
```
...
|  --- | --- | --- | --- |
| `certificateId` | `Guid` | Template, Required | A unique identifier for a certificate. |
...
```csharp
Guid certificateId = new Guid("4de7ac8b-495b-4884-9a69-1050c6793cd6");
try
{
    ApiResponse<V2CertificatesResponse1> result = await certificatesApi.CertificatesGetAsync(certificateId);
}
