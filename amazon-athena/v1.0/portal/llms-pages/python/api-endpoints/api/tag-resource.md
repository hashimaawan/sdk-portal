...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/#/python/x-redirect/JTI0ZSUyRiUyRlRhZ1Jlc291cmNl
...
|  --- | --- | --- | --- |
| `x_amz_target` | [`XAmzTarget51Enum`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/llms-pages/python/models/enumerations/x-amz-target-51.md) | Header, Required | - |
| `body` | [`TagResourceInput`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/llms-pages/python/models/structures/tag-resource-input.md) | Body, Required | - |
...
```python
x_amz_target = XAmzTarget51Enum.ENUM_AMAZONATHENATAGRESOURCE
...
result = client_controller.tag_resource(
    x_amz_target,
    body
)
print(result)
