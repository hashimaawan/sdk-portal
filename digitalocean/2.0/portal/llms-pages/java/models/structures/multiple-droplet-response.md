...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0bSUyRk11bHRpcGxlJTI1MjBEcm9wbGV0JTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- | --- | --- |
| `Droplets` | [`List<Droplet>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/java/models/structures/droplet.md) | Required | - | List<Droplet> getDroplets() | setDroplets(List<Droplet> droplets) |
...
MultipleDropletResponse multipleDropletResponse = new MultipleDropletResponse.Builder(
    Arrays.asList(
        new Droplet.Builder(
            Arrays.asList(
                53893572
