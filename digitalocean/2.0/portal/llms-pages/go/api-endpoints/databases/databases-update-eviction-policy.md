...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc191cGRhdGVfZXZpY3Rpb25Qb2xpY3k
...
DatabasesUpdateEvictionPolicy(
    ...
    body models.V2DatabasesEvictionPolicyRequest) (
    http.Response,
    error)
```
...
| `body` | [`models.V2DatabasesEvictionPolicyRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/go/models/structures/v2-databases-eviction-policy-request.md) | Body, Required | - |
...
resp, err := databasesApi.DatabasesUpdateEvictionPolicy(ctx, databaseClusterUuid, body)
if err != nil {
