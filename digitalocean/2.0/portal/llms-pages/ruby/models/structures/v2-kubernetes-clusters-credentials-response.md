...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0bSUyRlYyJTI1MjBLdWJlcm5ldGVzJTI1MjBDbHVzdGVycyUyNTIwQ3JlZGVudGlhbHMlMjUyMFJlc3BvbnNl
...
|  --- | --- | --- | --- |
| `certificate_authority_data` | `String` | Optional | A base64 encoding of bytes representing the certificate authority data for accessing the cluster. |
...
```ruby
v2_kubernetes_clusters_credentials_response = V2KubernetesClustersCredentialsResponse.new(
  ...
  client_certificate_data: 'client_certificate_data2',
  client_key_data: 'client_key_data2',
  expires_at: DateTimeHelper.from_rfc3339('2019-11-09T11:50:28.889080521Z'),
