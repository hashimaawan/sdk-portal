...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/typescript/x-redirect/JTI0ZSUyRlBsYXllciUyRnRvZ2dsZS1zaHVmZmxlLWZvci11c2Vycy1wbGF5YmFjaw
...
try {
  const response = await playerApi.toggleShuffleForUsersPlayback(
    state,
    deviceId
  );
