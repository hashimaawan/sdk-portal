...
|  --- | --- | --- | --- |
| `x_amz_target` | [`XAmzTarget5Enum`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/llms-pages/python/models/enumerations/x-amz-target-5.md) | Header, Required | - |
...
[`CreateNotebookOutput`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/llms-pages/python/models/structures/create-notebook-output.md)


# Example Usage

```python
x_amz_target = XAmzTarget5Enum.ENUM_AMAZONATHENACREATENOTEBOOK
...
result = client_controller.create_notebook(
    x_amz_target,
    body
)
print(result)
