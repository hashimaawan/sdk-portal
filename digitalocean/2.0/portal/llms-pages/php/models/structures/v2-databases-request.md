...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBEYXRhYmFzZXMlMjUyMFJlcXVlc3Q
...
| `backupRestore` | [`?BackupRestore`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/backup-restore.md) | Optional | - | getBackupRestore(): ?BackupRestore | setBackupRestore(?BackupRestore backupRestore): void |
...
```php
use DigitalOceanApiLib\Models\Builders\V2DatabasesRequestBuilder;
...
$v2DatabasesRequest = V2DatabasesRequestBuilder::init(
    Engine1::PG,
    'backend',
    2,
    'nyc3',
