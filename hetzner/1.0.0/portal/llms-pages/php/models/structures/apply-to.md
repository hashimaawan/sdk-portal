...
| `type` | [`string(Type7Enum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/type-7.md) | Required | Type of the resource | getType(): string | setType(string type): void |
