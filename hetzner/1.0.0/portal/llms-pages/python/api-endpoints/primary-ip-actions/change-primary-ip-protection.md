...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/python/x-redirect/JTI0ZSUyRlByaW1hcnklMjUyMElQJTI1MjBBY3Rpb25zJTJGQ2hhbmdlJTI1MjBQcmltYXJ5JTI1MjBJUCUyNTIwUHJvdGVjdGlvbg
...
| `body` | [`ChangeProtectionRequest2`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/python/models/structures/change-protection-request-2.md) | Body, Optional | - |
...
result = primary_ip_actions_api.change_primary_ip_protection(
    id,
    body=body
)
