...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRkNETiUyNTIwRW5kcG9pbnRzJTJGT3ZlcnZpZXc
...
The instance of the `CdnEndpointsApi` class can be accessed from the API Client.

```
cdnEndpointsApi := client.CdnEndpointsApi()
```
