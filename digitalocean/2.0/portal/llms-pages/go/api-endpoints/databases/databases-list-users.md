...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19saXN0X3VzZXJz
...
DatabasesListUsers(
    ...
    models.ApiResponse[models.V2DatabasesUsersResponse],
    error)
```
...
apiResponse, err := databasesApi.DatabasesListUsers(ctx, databaseClusterUuid)
if err != nil {
