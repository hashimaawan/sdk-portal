...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRlNuYXBzaG90cyUyRk92ZXJ2aWV3
...
```
SnapshotsApi snapshotsApi = client.getSnapshotsApi();
```
