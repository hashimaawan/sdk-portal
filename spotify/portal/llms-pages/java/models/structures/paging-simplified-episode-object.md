...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/java/x-redirect/JTI0bSUyRlBhZ2luZ1NpbXBsaWZpZWRFcGlzb2RlT2JqZWN0
...
| `Items` | [`List<EpisodeBase>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/java/models/structures/episode-base.md) | Required | - | List<EpisodeBase> getItems() | setItems(List<EpisodeBase> items) |
