...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfdXNlcg
...
try {
  const response = await databasesApi.databasesGetUser(
    databaseClusterUuid,
    username
  );
