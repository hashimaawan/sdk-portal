...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlNpbmdsZSUyNTIwRHJvcGxldCUyNTIwUmVzcG9uc2U
...
|  --- | --- | --- | --- | --- | --- |
| `droplet` | [`Droplet`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/droplet.md) | Required | - | getDroplet(): Droplet | setDroplet(Droplet droplet): void |
...
```php
use DigitalOceanApiLib\Models\Builders\SingleDropletResponseBuilder;
...
$singleDropletResponse = SingleDropletResponseBuilder::init(
    DropletBuilder::init(
        [
            53893572
        ],
