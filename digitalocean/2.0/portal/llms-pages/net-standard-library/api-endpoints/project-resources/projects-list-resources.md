...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlByb2plY3QlMjUyMFJlc291cmNlcyUyRnByb2plY3RzX2xpc3RfcmVzb3VyY2Vz

To list all your resources in a project, send a GET request to `/v2/projects/$PROJECT_ID/resources`.

```csharp
ProjectsListResourcesAsync(
    Guid projectId,
    int? perPage = 20,
    int? page = 1)
```
...
try
{
    ApiResponse<V2ProjectsDefaultResourcesResponse> result = await projectResourcesApi.ProjectsListResourcesAsync(
        projectId,
        perPage,
        page
    );
