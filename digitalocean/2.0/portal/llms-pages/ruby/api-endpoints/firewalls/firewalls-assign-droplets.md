...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/ruby/x-redirect/JTI0ZSUyRkZpcmV3YWxscyUyRmZpcmV3YWxsc19hc3NpZ25fZHJvcGxldHM
...
```ruby
def firewalls_assign_droplets(firewall_id,
                              body: nil)
```
...
| `body` | [`V2FirewallsDropletsRequest1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/ruby/models/structures/v2-firewalls-droplets-request-1.md) | Body, Optional | - |
...
body = V2FirewallsDropletsRequest1.new(
  droplet_ids: [
    49696269
  ]
)
