...
|  --- | --- | --- | --- | --- | --- |
| `type` | [`string(Type39Enum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/php/models/enumerations/type-39.md) | Required | Algorithm of the Load Balancer | getType(): string | setType(string type): void |
