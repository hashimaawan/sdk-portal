...
|  --- | --- | --- | --- |
| `xAmzTarget` | [`XAmzTarget7`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/amazon-athena/v1.0/portal/llms-pages/net-standard-library/models/enumerations/x-amz-target-7.md) | Header, Required | - |
...
try
{
    ApiResponse<CreatePresignedNotebookUrlResponse> result = await api.CreatePresignedNotebookUrlAsync(
        xAmzTarget,
        body
    );
}
