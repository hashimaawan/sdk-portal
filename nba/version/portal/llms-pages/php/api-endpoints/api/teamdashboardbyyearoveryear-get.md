...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNoYm9hcmRieXllYXJvdmVyeWVhcl9HRVQ

:information_source: **Note** This endpoint does not require authentication.

```php
function teamdashboardbyyearoveryearGet(
    string $teamId,
    string $measureType,
    string $perMode,
    string $plusMinus,
...
$api = $client->getAPI();
$apiResponse = $api->teamdashboardbyyearoveryearGet(
    $teamId,
    $measureType,
    $perMode,
    $plusMinus,
