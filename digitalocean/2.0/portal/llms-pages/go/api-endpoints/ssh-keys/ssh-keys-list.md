...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/go/x-redirect/JTI0ZSUyRlNTSCUyNTIwS2V5cyUyRnNzaEtleXNfbGlzdA
...
SshKeysList(
    ...
    perPage *int,
    page *int) (
    models.ApiResponse[models.V2AccountKeysResponse],
    error)
```
...
apiResponse, err := sshKeysApi.SshKeysList(ctx, &perPage, &page)
if err != nil {
