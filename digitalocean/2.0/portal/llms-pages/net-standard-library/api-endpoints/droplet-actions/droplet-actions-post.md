...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRyb3BsZXQlMjUyMEFjdGlvbnMlMkZkcm9wbGV0QWN0aW9uc19wb3N0
...
```csharp
DropletActionsPostAsync(
    int dropletId,
    DropletActionsPostBody body = null)
```
...
| `body` | [`DropletActionsPostBody`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/oneof-anyof-definitions/droplet-actions-post-body.md) | Body, Optional | This is a container for any-of cases. |
...
try
{
    ApiResponse<V2DropletsActionsResponse2> result = await dropletActionsApi.DropletActionsPostAsync(
        dropletId,
        body
    );
}
