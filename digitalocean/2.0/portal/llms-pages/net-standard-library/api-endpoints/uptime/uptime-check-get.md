...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRlVwdGltZSUyRnVwdGltZV9jaGVja19nZXQ
...
try
{
    ApiResponse<V2UptimeChecksResponse1> result = await uptimeApi.UptimeCheckGetAsync(checkId);
}
