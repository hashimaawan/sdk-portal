...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19jcmVhdGVfcmVwbGljYQ
...
```csharp
DatabasesCreateReplicaAsync(
    Guid databaseClusterUuid,
    Models.Replica body = null)
```
...
| `body` | [`Replica`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/net-standard-library/models/structures/replica.md) | Body, Optional | - |
...
try
{
    ApiResponse<V2DatabasesReplicasResponse1> result = await databasesApi.DatabasesCreateReplicaAsync(
        databaseClusterUuid,
        body
    );
}
