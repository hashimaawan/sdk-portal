...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRk1vbml0b3JpbmclMkZtb25pdG9yaW5nX2dldF9kcm9wbGV0RmlsZXN5c3RlbUZyZWVNZXRyaWNz
...
```csharp
MonitoringGetDropletFilesystemFreeMetricsAsync(
    string hostId,
    string start,
    string end)
```
...
try
{
    ApiResponse<V2MonitoringMetricsDropletBandwidthResponse> result = await monitoringApi.MonitoringGetDropletFilesystemFreeMetricsAsync(
        hostId,
        start,
        end
    );
