...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/typescript/x-redirect/JTI0ZSUyRlBsYXllciUyRnNlZWstdG8tcG9zaXRpb24taW4tY3VycmVudGx5LXBsYXlpbmctdHJhY2s
...
try {
  const response = await playerApi.seekToPositionInCurrentlyPlayingTrack(
    positionMs,
    deviceId
  );
