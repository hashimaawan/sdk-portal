...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0bSUyRlYyJTI1MjBLdWJlcm5ldGVzJTI1MjBDbHVzdGVycyUyNTIwQ3JlZGVudGlhbHMlMjUyMFJlc3BvbnNl
...
| `ExpiresAt` | `DateTime?` | Optional | A time value given in ISO8601 combined date and time format that represents when the access token expires. |
...
V2KubernetesClustersCredentialsResponse v2KubernetesClustersCredentialsResponse = new V2KubernetesClustersCredentialsResponse
{
    ...
    ExpiresAt = DateTime.ParseExact("2019-11-09T11:50:28.889080521Z", "yyyy'-'MM'-'dd'T'HH':'mm':'ss.FFFFFFFK",
