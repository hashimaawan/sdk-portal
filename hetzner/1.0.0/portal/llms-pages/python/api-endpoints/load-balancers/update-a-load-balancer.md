...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/python/x-redirect/JTI0ZSUyRkxvYWQlMjUyMEJhbGFuY2VycyUyRlVwZGF0ZSUyNTIwYSUyNTIwTG9hZCUyNTIwQmFsYW5jZXI
...
```python
def update_a_load_balancer(self,
                          id,
                          body=None)
```
...
| `body` | [`LoadBalancersRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/python/models/structures/load-balancers-request.md) | Body, Optional | - |
