...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRkFsYnVtcyUyRmdldC1uZXctcmVsZWFzZXM
...
GetNewReleases(
    ...
    limit *int,
    offset *int) (
    models.ApiResponse[models.PagedAlbums],
    error)
```
...
apiResponse, err := albumsApi.GetNewReleases(ctx, &limit, &offset)
if err != nil {
