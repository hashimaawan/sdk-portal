...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/#/typescript/x-redirect/JTI0bSUyRkdpZnMlMjUyMFNlYXJjaCUyNTIwUmVzcG9uc2U
...
```ts
import { GifsSearchResponse } from 'giphy-apilib';

const gifsSearchResponse: GifsSearchResponse = {
  data: [
    {
      bitlyUrl: 'bitly_url0',
