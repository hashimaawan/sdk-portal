...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/net-standard-library/x-redirect/JTI0ZSUyRkJpbGxpbmclMkZpbnZvaWNlc19nZXRfc3VtbWFyeUJ5VVVJRA

To retrieve a summary for an invoice, send a GET request to `/v2/customers/my/invoices/$INVOICE_UUID/summary`.

```csharp
InvoicesGetSummaryByUuidAsync(
    string invoiceUuid)
```
...
try
{
    ApiResponse<V2CustomersMyInvoicesSummaryResponse> result = await billingApi.InvoicesGetSummaryByUuidAsync(invoiceUuid);
}
