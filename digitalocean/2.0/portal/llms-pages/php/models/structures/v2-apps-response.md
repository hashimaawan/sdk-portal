...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBBcHBzJTI1MjBSZXNwb25zZQ
...
|  --- | --- | --- | --- | --- | --- |
| `apps` | [`?(AListOfApp[])`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/php/models/structures/a-list-of-app.md) | Optional | - | getApps(): ?array | setApps(?array apps): void |
...
```php
use DigitalOceanApiLib\Models\Builders\V2AppsResponseBuilder;
...
$v2AppsResponse = V2AppsResponseBuilder::init(
    MetaBuilder::init(
        1
    )
