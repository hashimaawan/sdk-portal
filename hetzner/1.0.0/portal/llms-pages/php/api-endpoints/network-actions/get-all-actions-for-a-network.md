...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/php/x-redirect/JTI0ZSUyRk5ldHdvcmslMjUyMEFjdGlvbnMlMkZHZXQlMjUyMGFsbCUyNTIwQWN0aW9ucyUyNTIwZm9yJTI1MjBhJTI1MjBOZXR3b3Jr
...
```php
function getAllActionsForANetwork(int $id, ?string $sort = null, ?string $status = null): ApiResponse
```
...
$apiResponse = $networkActionsApi->getAllActionsForANetwork($id);
