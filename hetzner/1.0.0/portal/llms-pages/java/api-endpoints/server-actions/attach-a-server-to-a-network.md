...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0ZSUyRlNlcnZlciUyNTIwQWN0aW9ucyUyRkF0dGFjaCUyNTIwYSUyNTIwU2VydmVyJTI1MjB0byUyNTIwYSUyNTIwTmV0d29yaw
...
```java
CompletableFuture<ApiResponse<ActionResponse>> attachAServerToANetworkAsync(
    final int id,
    final AttachToNetworkRequest body)
```
...
| `body` | [`AttachToNetworkRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/java/models/structures/attach-to-network-request.md) | Body, Optional | - |
...
```java
int id = 112;
AttachToNetworkRequest body = new AttachToNetworkRequest.Builder(
    4711
)
...
serverActionsApi.attachAServerToANetworkAsync(id, body).thenAccept(result -> {
