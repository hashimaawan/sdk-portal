...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkZ1bmN0aW9ucyUyRmZ1bmN0aW9uc19kZWxldGVfbmFtZXNwYWNl
...
```java
CompletableFuture<ApiResponse<Void>> functionsDeleteNamespaceAsync(
...
functionsApi.functionsDeleteNamespaceAsync(namespaceId).thenAccept(result -> {
