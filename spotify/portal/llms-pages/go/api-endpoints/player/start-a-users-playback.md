...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRlBsYXllciUyRnN0YXJ0LWEtdXNlcnMtcGxheWJhY2s
...
StartAUsersPlayback(
    ctx context.Context,
    deviceId *string,
    body *models.MePlayerPlayRequest) (
    http.Response,
    error)
```
...
| `body` | [`*models.MePlayerPlayRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/llms-pages/go/models/structures/me-player-play-request.md) | Body, Optional | - |
...
resp, err := playerApi.StartAUsersPlayback(ctx, &deviceId, &body)
if err != nil {
