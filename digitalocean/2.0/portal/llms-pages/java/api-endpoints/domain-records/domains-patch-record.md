...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkRvbWFpbiUyNTIwUmVjb3JkcyUyRmRvbWFpbnNfcGF0Y2hfcmVjb3Jk
...
```java
CompletableFuture<ApiResponse<V2DomainsRecordsResponse1>> domainsPatchRecordAsync(
...
domainRecordsApi.domainsPatchRecordAsync(domainName, domainRecordId, body).thenAccept(result -> {
