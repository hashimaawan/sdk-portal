...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/#/typescript/x-redirect/JTI0ZSUyRlRyYWNrcyUyRnNhdmUtdHJhY2tzLXVzZXI
...
| `body` | [`MeTracksRequest \| undefined`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/spotify/llms-pages/typescript/models/structures/me-tracks-request.md) | Body, Optional | - |
...
try {
  const response = await tracksApi.saveTracksUser(ids);
