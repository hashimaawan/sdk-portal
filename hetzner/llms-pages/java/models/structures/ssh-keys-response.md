...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0bSUyRlNzaCUyNTIwS2V5cyUyNTIwUmVzcG9uc2U
...
| `SshKeys` | [`List<SshKey>`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/ssh-key.md) | Required | - | List<SshKey> getSshKeys() | setSshKeys(List<SshKey> sshKeys) |
