...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0ZSUyRkFjdGlvbnMlMkZhY3Rpb25zX2dldA

To retrieve a specific action object, send a GET request to `/v2/actions/$ACTION_ID`.

```java
CompletableFuture<ApiResponse<V2ActionsResponse1>> actionsGetAsync(
    final int actionId)
```
...
actionsApi.actionsGetAsync(actionId).thenAccept(result -> {
