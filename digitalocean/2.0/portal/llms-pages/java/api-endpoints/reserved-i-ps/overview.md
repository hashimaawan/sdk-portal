...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/java/x-redirect/JTI0aCUyRl9fYXBpX3JlZmVyZW5jZSUyRlJlc2VydmVkJTI1MjBJUHMlMkZPdmVydmlldw
...
```
ReservedIPsApi reservedIPsApi = client.getReservedIPsApi();
```
