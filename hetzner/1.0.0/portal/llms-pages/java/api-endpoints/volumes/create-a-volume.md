...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/#/java/x-redirect/JTI0ZSUyRlZvbHVtZXMlMkZDcmVhdGUlMjUyMGElMjUyMFZvbHVtZQ
...
|  --- | --- | --- | --- |
| `body` | [`CreateVolumeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/1.0.0/portal/llms-pages/java/models/structures/create-volume-request.md) | Body, Optional | - |
