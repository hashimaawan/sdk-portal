...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/giphy/#/typescript/x-redirect/JTI0bSUyRlN0aWNrZXJzJTI1MjBTZWFyY2glMjUyMFJlc3BvbnNl
...
```ts
import { StickersSearchResponse } from 'giphy-apilib';

const stickersSearchResponse: StickersSearchResponse = {
  data: [
    {
      bitlyUrl: 'bitly_url0',
