...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/java/x-redirect/JTI0ZSUyRlZvbHVtZXMlMkZDcmVhdGUlMjUyMGElMjUyMFZvbHVtZQ
...
|  --- | --- | --- | --- |
| `body` | [`CreateVolumeRequest`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/create-volume-request.md) | Body, Optional | - |
...
[`VolumesResponse1`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/java/models/structures/volumes-response-1.md)


# Example Usage

```java
CreateVolumeRequest body = new CreateVolumeRequest.Builder(
    "test-database",
    42
)
.automount(false)
