...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/1password/#/ruby/x-redirect/JTI0ZSUyRkZpbGVzJTJGR2V0SXRlbUZpbGVz

```ruby
def get_item_files(vault_uuid,
                   item_uuid,
                   inline_files: nil)
```
...
|  --- | --- | --- | --- |
| `vault_uuid` | `UUID \| String` | Template, Required | The UUID of the Vault to fetch Items from |
| `item_uuid` | `UUID \| String` | Template, Required | The UUID of the Item to fetch files from |
