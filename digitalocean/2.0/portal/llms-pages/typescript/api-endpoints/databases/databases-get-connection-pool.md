...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRkRhdGFiYXNlcyUyRmRhdGFiYXNlc19nZXRfY29ubmVjdGlvblBvb2w
...
```ts
async databasesGetConnectionPool(
...
try {
  const response = await databasesApi.databasesGetConnectionPool(
    databaseClusterUuid,
    poolName
  );
