...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/spotify/portal/#/go/x-redirect/JTI0ZSUyRkF1ZGlvYm9va3MlMkZnZXQtdXNlcnMtc2F2ZWQtYXVkaW9ib29rcw
...
GetUsersSavedAudiobooks(
    ...
    limit *int,
    offset *int) (
    models.ApiResponse[models.PagingSavedAudiobookObject],
    error)
```
...
apiResponse, err := audiobooksApi.GetUsersSavedAudiobooks(ctx, &limit, &offset)
if err != nil {
