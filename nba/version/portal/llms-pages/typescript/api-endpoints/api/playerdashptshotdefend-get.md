...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/typescript/x-redirect/JTI0ZSUyRiUyRlBsYXllcmRhc2hwdHNob3RkZWZlbmRfR0VU

:information_source: **Note** This endpoint does not require authentication.

```ts
async playerdashptshotdefendGET(
  perMode: string,
  season: string,
  seasonType: string,
  playerID: string,
...
try {
  const response = await apiController.playerdashptshotdefendGET(
    perMode,
    season,
    seasonType,
    playerID,
