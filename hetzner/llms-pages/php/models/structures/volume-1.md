...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/#/php/x-redirect/JTI0bSUyRlZvbHVtZTE
...
| `location` | [`Location16`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/php/models/structures/location-16.md) | Required | Location of the Volume. Volume can only be attached to Servers in the same Location. | getLocation(): Location16 | setLocation(Location16 location): void |
...
| `status` | [`string(Status113Enum)`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/hetzner/llms-pages/php/models/enumerations/status-113.md) | Required | Current status of the Volume | getStatus(): string | setStatus(string status): void |
