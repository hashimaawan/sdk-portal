...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRkN1c3RvbSUyNTIwQ2VydGlmaWNhdGUlMjUyMFJlcXVlc3Q
...
| `certificate_chain` | `str` | Optional | The full PEM-formatted trust chain between the certificate authority's certificate and your domain's SSL certificate. |
| `leaf_certificate` | `str` | Required | The contents of a PEM-formatted public SSL certificate. |
| `private_key` | `str` | Required | The contents of a PEM-formatted private-key corresponding to the SSL certificate. |
...
from digitaloceanapi.models.custom_certificate_request import CustomCertificateRequest
from digitaloceanapi.models.type_4 import Type4

custom_certificate_request = CustomCertificateRequest(
    name='web-cert-01',
