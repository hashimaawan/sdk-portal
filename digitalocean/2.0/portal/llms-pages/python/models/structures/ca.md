...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/python/x-redirect/JTI0bSUyRkNh
...
|  --- | --- | --- | --- |
| `certificate` | `str` | Required, Read-only | base64 encoding of the certificate used to secure database connections |
