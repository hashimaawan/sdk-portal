...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/typescript/x-redirect/JTI0ZSUyRlNTSCUyNTIwS2V5cyUyRnNzaEtleXNfY3JlYXRl
...
|  --- | --- | --- | --- |
| `body` | [`SshKey`](https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/llms-pages/typescript/models/structures/ssh-key.md) | Body, Required | - |
...
try {
  const response = await sshKeysApi.sshKeysCreate(body);
