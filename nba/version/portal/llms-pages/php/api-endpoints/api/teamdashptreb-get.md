...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/nba/version/portal/#/php/x-redirect/JTI0ZSUyRiUyRlRlYW1kYXNocHRyZWJfR0VU

:information_source: **Note** This endpoint does not require authentication.

```php
function teamdashptrebGet(
    string $perMode,
    string $season,
    string $seasonType,
    string $teamId,
...
$api = $client->getAPI();
$apiResponse = $api->teamdashptrebGet(
    $perMode,
    $season,
    $seasonType,
    $teamId,
