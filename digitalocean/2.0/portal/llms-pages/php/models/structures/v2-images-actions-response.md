...
Source: https://raw.githubusercontent.com/hashimaawan/sdk-portal/main/digitalocean/2.0/portal/#/php/x-redirect/JTI0bSUyRlYyJTI1MjBJbWFnZXMlMjUyMEFjdGlvbnMlMjUyMFJlc3BvbnNl
...
```php
use DigitalOceanApiLib\Models\Builders\V2ImagesActionsResponseBuilder;
...
$v2ImagesActionsResponse = V2ImagesActionsResponseBuilder::init(
    MetaBuilder::init(
        1
    )
